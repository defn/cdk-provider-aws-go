...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "includePublicKey", GoGetter: "IncludePublicKey"},
			_jsii_.MemberProperty{JsiiProperty: "includePublicKeyInput", GoGetter: "IncludePublicKeyInput"},
