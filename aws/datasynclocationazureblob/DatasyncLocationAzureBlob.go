...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/datasync_location_azure_blob aws_datasync_location_azure_blob} Resource.
func NewDatasyncLocationAzureBlob(scope constructs.Construct, id *string, config *DatasyncLocationAzureBlobConfig) DatasyncLocationAzureBlob {
	...
	_jsii_.Create(
		"aws.datasyncLocationAzureBlob.DatasyncLocationAzureBlob",
