...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/lakeformationresourcelftags/internal"
...
func NewLakeformationResourceLfTagsLfTagList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) LakeformationResourceLfTagsLfTagList {
	...
	if err := validateNewLakeformationResourceLfTagsLfTagListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (l *jsiiProxy_LakeformationResourceLfTagsLfTagList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
