...
func NewRedshiftserverlessWorkgroupConfigParameterList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) RedshiftserverlessWorkgroupConfigParameterList {
	...
	if err := validateNewRedshiftserverlessWorkgroupConfigParameterListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (r *jsiiProxy_RedshiftserverlessWorkgroupConfigParameterList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
