...
func init() {
	...
	_jsii_.RegisterStruct(
		"aws.iotTopicRule.IotTopicRuleErrorActionKafkaHeader",
	...
	_jsii_.RegisterClass(
		"aws.iotTopicRule.IotTopicRuleErrorActionKafkaHeaderOutputReference",
	...
	_jsii_.RegisterStruct(
		"aws.iotTopicRule.IotTopicRuleKafkaHeader",
		reflect.TypeOf((*IotTopicRuleKafkaHeader)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"aws.iotTopicRule.IotTopicRuleKafkaHeaderList",
