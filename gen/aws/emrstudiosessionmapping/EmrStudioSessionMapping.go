...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/emrstudiosessionmapping/internal"
...
func (j *jsiiProxy_EmrStudioSessionMapping) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_EmrStudioSessionMapping) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/emr_studio_session_mapping aws_emr_studio_session_mapping} Resource.
func NewEmrStudioSessionMapping(scope constructs.Construct, id *string, config *EmrStudioSessionMappingConfig) EmrStudioSessionMapping {
	...
	if err := validateNewEmrStudioSessionMappingParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func EmrStudioSessionMapping_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateEmrStudioSessionMapping_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (e *jsiiProxy_EmrStudioSessionMapping) AddMoveTarget(moveTarget *string) {
...
func (e *jsiiProxy_EmrStudioSessionMapping) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (e *jsiiProxy_EmrStudioSessionMapping) MoveFromId(id *string) {
...
func (e *jsiiProxy_EmrStudioSessionMapping) MoveToId(id *string) {
...
func (e *jsiiProxy_EmrStudioSessionMapping) ResetId() {
	_jsii_.InvokeVoid(
		e,
		"resetId",
		nil, // no parameters
