...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/dataawsorganizationsdelegatedadministrators/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/data-sources/organizations_delegated_administrators aws_organizations_delegated_administrators} Data Source.
...
func DataAwsOrganizationsDelegatedAdministrators_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsOrganizationsDelegatedAdministrators_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
