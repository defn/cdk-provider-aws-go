...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/elasticacheusergroup/internal"
...
func NewElasticacheUserGroup(scope constructs.Construct, id *string, config *ElasticacheUserGroupConfig) ElasticacheUserGroup {
	...
	if err := validateNewElasticacheUserGroupParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func ElasticacheUserGroup_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateElasticacheUserGroup_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (e *jsiiProxy_ElasticacheUserGroup) AddMoveTarget(moveTarget *string) {
...
func (e *jsiiProxy_ElasticacheUserGroup) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (e *jsiiProxy_ElasticacheUserGroup) MoveFromId(id *string) {
...
func (e *jsiiProxy_ElasticacheUserGroup) MoveToId(id *string) {
