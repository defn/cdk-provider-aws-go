...
func init() {
	_jsii_.RegisterClass(
		"aws.quicksightIngestion.QuicksightIngestion",
		reflect.TypeOf((*QuicksightIngestion)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "ingestionId", GoGetter: "IngestionId"},
			_jsii_.MemberProperty{JsiiProperty: "ingestionIdInput", GoGetter: "IngestionIdInput"},
			_jsii_.MemberProperty{JsiiProperty: "ingestionStatus", GoGetter: "IngestionStatus"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*QuicksightIngestionConfig)(nil)).Elem(),
	)
}
