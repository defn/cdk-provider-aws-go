...
func NewCodedeployDeploymentGroupLoadBalancerInfoElbInfoList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CodedeployDeploymentGroupLoadBalancerInfoElbInfoList {
	...
	if err := validateNewCodedeployDeploymentGroupLoadBalancerInfoElbInfoListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_CodedeployDeploymentGroupLoadBalancerInfoElbInfoList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
