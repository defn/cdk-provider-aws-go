...
func (l *jsiiProxy_Lexv2ModelsBotLocaleVoiceSettingsOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (l *jsiiProxy_Lexv2ModelsBotLocaleVoiceSettingsOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
