...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/lambdacodesigningconfig/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/lambda_code_signing_config aws_lambda_code_signing_config} Resource.
func NewLambdaCodeSigningConfig(scope constructs.Construct, id *string, config *LambdaCodeSigningConfigConfig) LambdaCodeSigningConfig {
	...
	if err := validateNewLambdaCodeSigningConfigParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func LambdaCodeSigningConfig_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateLambdaCodeSigningConfig_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (l *jsiiProxy_LambdaCodeSigningConfig) AddMoveTarget(moveTarget *string) {
...
func (l *jsiiProxy_LambdaCodeSigningConfig) PutAllowedPublishers(value *LambdaCodeSigningConfigAllowedPublishers) {
	if err := l.validatePutAllowedPublishersParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		l,
...
func (l *jsiiProxy_LambdaCodeSigningConfig) PutPolicies(value *LambdaCodeSigningConfigPolicies) {
	if err := l.validatePutPoliciesParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		l,
