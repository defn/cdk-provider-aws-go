...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/dataawseksnodegroups/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/data-sources/eks_node_groups aws_eks_node_groups}.
...
func (j *jsiiProxy_DataAwsEksNodeGroups) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsEksNodeGroups) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/data-sources/eks_node_groups aws_eks_node_groups} Data Source.
func NewDataAwsEksNodeGroups(scope constructs.Construct, id *string, config *DataAwsEksNodeGroupsConfig) DataAwsEksNodeGroups {
	_init_.Initialize()

	if err := validateNewDataAwsEksNodeGroupsParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_DataAwsEksNodeGroups)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsEksNodeGroups)SetId(val *string) {
...
func DataAwsEksNodeGroups_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsEksNodeGroups_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func DataAwsEksNodeGroups_IsConstruct(x interface{}) *bool {
	...
	if err := validateDataAwsEksNodeGroups_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAwsEksNodeGroups_IsTerraformDataSource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsEksNodeGroups_IsTerraformDataSourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAwsEksNodeGroups_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsEksNodeGroups_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataAwsEksNodeGroups) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsEksNodeGroups) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataAwsEksNodeGroups) ToHclTerraform() interface{} {
	var returns interface{}
