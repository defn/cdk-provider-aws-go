...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/codeartifactdomain/internal"
...
func (j *jsiiProxy_CodeartifactDomain) AssetSizeBytes() *string {
	var returns *string
	_jsii_.Get(
		j,
		"assetSizeBytes",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/codeartifact_domain aws_codeartifact_domain} Resource.
...
func CodeartifactDomain_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateCodeartifactDomain_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_CodeartifactDomain) AddMoveTarget(moveTarget *string) {
