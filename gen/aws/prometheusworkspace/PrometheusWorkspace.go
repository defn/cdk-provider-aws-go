...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/prometheusworkspace/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/prometheus_workspace aws_prometheus_workspace}.
...
func (j *jsiiProxy_PrometheusWorkspace) KmsKeyArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"kmsKeyArn",
...
func (j *jsiiProxy_PrometheusWorkspace) KmsKeyArnInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"kmsKeyArnInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/prometheus_workspace aws_prometheus_workspace} Resource.
...
func (j *jsiiProxy_PrometheusWorkspace)SetKmsKeyArn(val *string) {
...
func PrometheusWorkspace_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validatePrometheusWorkspace_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (p *jsiiProxy_PrometheusWorkspace) AddMoveTarget(moveTarget *string) {
...
func (p *jsiiProxy_PrometheusWorkspace) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (p *jsiiProxy_PrometheusWorkspace) MoveFromId(id *string) {
...
func (p *jsiiProxy_PrometheusWorkspace) MoveToId(id *string) {
...
func (p *jsiiProxy_PrometheusWorkspace) ResetKmsKeyArn() {
	_jsii_.InvokeVoid(
		p,
		"resetKmsKeyArn",
		nil, // no parameters
