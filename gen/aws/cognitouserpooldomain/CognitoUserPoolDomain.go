...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/cognitouserpooldomain/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/cognito_user_pool_domain aws_cognito_user_pool_domain}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/cognito_user_pool_domain aws_cognito_user_pool_domain} Resource.
...
func CognitoUserPoolDomain_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateCognitoUserPoolDomain_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_CognitoUserPoolDomain) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_CognitoUserPoolDomain) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (c *jsiiProxy_CognitoUserPoolDomain) MoveFromId(id *string) {
...
func (c *jsiiProxy_CognitoUserPoolDomain) MoveToId(id *string) {
