...
func NewDataAwsMqBrokerInstancesList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsMqBrokerInstancesList {
	...
	if err := validateNewDataAwsMqBrokerInstancesListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsMqBrokerInstancesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
