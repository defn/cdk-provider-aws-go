...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/redshift_scheduled_action aws_redshift_scheduled_action} Resource.
func NewRedshiftScheduledAction(scope constructs.Construct, id *string, config *RedshiftScheduledActionConfig) RedshiftScheduledAction {
	...
	if err := validateNewRedshiftScheduledActionParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func RedshiftScheduledAction_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateRedshiftScheduledAction_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (r *jsiiProxy_RedshiftScheduledAction) AddMoveTarget(moveTarget *string) {
...
func (r *jsiiProxy_RedshiftScheduledAction) PutTargetAction(value *RedshiftScheduledActionTargetAction) {
	if err := r.validatePutTargetActionParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		r,
