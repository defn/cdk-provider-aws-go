...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/lightsaildomain/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/lightsail_domain aws_lightsail_domain}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/lightsail_domain aws_lightsail_domain} Resource.
...
func LightsailDomain_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateLightsailDomain_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (l *jsiiProxy_LightsailDomain) AddMoveTarget(moveTarget *string) {
...
func (l *jsiiProxy_LightsailDomain) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (l *jsiiProxy_LightsailDomain) MoveFromId(id *string) {
...
func (l *jsiiProxy_LightsailDomain) MoveToId(id *string) {
