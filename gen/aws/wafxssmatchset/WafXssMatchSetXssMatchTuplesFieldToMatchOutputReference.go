...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/wafxssmatchset/internal"
...
func (j *jsiiProxy_WafXssMatchSetXssMatchTuplesFieldToMatchOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_WafXssMatchSetXssMatchTuplesFieldToMatchOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_WafXssMatchSetXssMatchTuplesFieldToMatchOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_WafXssMatchSetXssMatchTuplesFieldToMatchOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func NewWafXssMatchSetXssMatchTuplesFieldToMatchOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) WafXssMatchSetXssMatchTuplesFieldToMatchOutputReference {
	_init_.Initialize()

	if err := validateNewWafXssMatchSetXssMatchTuplesFieldToMatchOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewWafXssMatchSetXssMatchTuplesFieldToMatchOutputReference_Override(w WafXssMatchSetXssMatchTuplesFieldToMatchOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_WafXssMatchSetXssMatchTuplesFieldToMatchOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_WafXssMatchSetXssMatchTuplesFieldToMatchOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (w *jsiiProxy_WafXssMatchSetXssMatchTuplesFieldToMatchOutputReference) ComputeFqn() *string {
	var returns *string
...
func (w *jsiiProxy_WafXssMatchSetXssMatchTuplesFieldToMatchOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (w *jsiiProxy_WafXssMatchSetXssMatchTuplesFieldToMatchOutputReference) ToString() *string {
	var returns *string
