...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/dataawsorganizationsorganization/internal"
...
func NewDataAwsOrganizationsOrganizationRootsPolicyTypesOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DataAwsOrganizationsOrganizationRootsPolicyTypesOutputReference {
	...
	if err := validateNewDataAwsOrganizationsOrganizationRootsPolicyTypesOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
