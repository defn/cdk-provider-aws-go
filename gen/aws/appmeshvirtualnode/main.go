...
func init() {
	...
	_jsii_.RegisterStruct(
		"aws.appmeshVirtualNode.AppmeshVirtualNodeSpecLoggingAccessLogFileFormatJson",
		reflect.TypeOf((*AppmeshVirtualNodeSpecLoggingAccessLogFileFormatJson)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"aws.appmeshVirtualNode.AppmeshVirtualNodeSpecLoggingAccessLogFileFormatJsonList",
