...
func (j *jsiiProxy_Lexv2ModelsIntentInitialResponseSettingNextStepDialogActionList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_Lexv2ModelsIntentInitialResponseSettingNextStepDialogActionList) InternalValue() interface{} {
...
func (j *jsiiProxy_Lexv2ModelsIntentInitialResponseSettingNextStepDialogActionList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_Lexv2ModelsIntentInitialResponseSettingNextStepDialogActionList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func NewLexv2ModelsIntentInitialResponseSettingNextStepDialogActionList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) Lexv2ModelsIntentInitialResponseSettingNextStepDialogActionList {
	...
	j := jsiiProxy_Lexv2ModelsIntentInitialResponseSettingNextStepDialogActionList{}

	_jsii_.Create(
		"aws.lexv2ModelsIntent.Lexv2ModelsIntentInitialResponseSettingNextStepDialogActionList",
...
func (j *jsiiProxy_Lexv2ModelsIntentInitialResponseSettingNextStepDialogActionList)SetInternalValue(val interface{}) {
...
func (j *jsiiProxy_Lexv2ModelsIntentInitialResponseSettingNextStepDialogActionList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_Lexv2ModelsIntentInitialResponseSettingNextStepDialogActionList)SetWrapsSet(val *bool) {
...
func (l *jsiiProxy_Lexv2ModelsIntentInitialResponseSettingNextStepDialogActionList) ComputeFqn() *string {
	var returns *string
...
func (l *jsiiProxy_Lexv2ModelsIntentInitialResponseSettingNextStepDialogActionList) Get(index *float64) Lexv2ModelsIntentInitialResponseSettingNextStepDialogActionOutputReference {
	if err := l.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns Lexv2ModelsIntentInitialResponseSettingNextStepDialogActionOutputReference
...
func (l *jsiiProxy_Lexv2ModelsIntentInitialResponseSettingNextStepDialogActionList) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (l *jsiiProxy_Lexv2ModelsIntentInitialResponseSettingNextStepDialogActionList) ToString() *string {
	var returns *string
