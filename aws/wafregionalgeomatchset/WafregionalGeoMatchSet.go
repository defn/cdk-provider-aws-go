...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/wafregionalgeomatchset/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/wafregional_geo_match_set aws_wafregional_geo_match_set} Resource.
...
func WafregionalGeoMatchSet_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateWafregionalGeoMatchSet_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (w *jsiiProxy_WafregionalGeoMatchSet) AddMoveTarget(moveTarget *string) {
...
func (w *jsiiProxy_WafregionalGeoMatchSet) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (w *jsiiProxy_WafregionalGeoMatchSet) MoveFromId(id *string) {
...
func (w *jsiiProxy_WafregionalGeoMatchSet) MoveToId(id *string) {
