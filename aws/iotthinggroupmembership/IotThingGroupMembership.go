...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/iotthinggroupmembership/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/iot_thing_group_membership aws_iot_thing_group_membership} Resource.
...
func IotThingGroupMembership_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateIotThingGroupMembership_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (i *jsiiProxy_IotThingGroupMembership) AddMoveTarget(moveTarget *string) {
...
func (i *jsiiProxy_IotThingGroupMembership) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (i *jsiiProxy_IotThingGroupMembership) MoveFromId(id *string) {
...
func (i *jsiiProxy_IotThingGroupMembership) MoveToId(id *string) {
