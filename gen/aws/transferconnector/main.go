...
func init() {
	_jsii_.RegisterClass(
		"aws.transferConnector.TransferConnector",
	...
	_jsii_.RegisterStruct(
		"aws.transferConnector.TransferConnectorAs2Config",
		reflect.TypeOf((*TransferConnectorAs2Config)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"aws.transferConnector.TransferConnectorAs2ConfigOutputReference",
	...
	_jsii_.RegisterStruct(
		"aws.transferConnector.TransferConnectorConfig",
		reflect.TypeOf((*TransferConnectorConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws.transferConnector.TransferConnectorSftpConfig",
