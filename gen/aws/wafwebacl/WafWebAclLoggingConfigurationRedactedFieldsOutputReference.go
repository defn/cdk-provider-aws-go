...
type WafWebAclLoggingConfigurationRedactedFieldsOutputReference interface {
	...
	FieldToMatch() WafWebAclLoggingConfigurationRedactedFieldsFieldToMatchList
...
func (j *jsiiProxy_WafWebAclLoggingConfigurationRedactedFieldsOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_WafWebAclLoggingConfigurationRedactedFieldsOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_WafWebAclLoggingConfigurationRedactedFieldsOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_WafWebAclLoggingConfigurationRedactedFieldsOutputReference) FieldToMatch() WafWebAclLoggingConfigurationRedactedFieldsFieldToMatchList {
	var returns WafWebAclLoggingConfigurationRedactedFieldsFieldToMatchList
	_jsii_.Get(
		j,
		"fieldToMatch",
		&returns,
...
func (j *jsiiProxy_WafWebAclLoggingConfigurationRedactedFieldsOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func NewWafWebAclLoggingConfigurationRedactedFieldsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) WafWebAclLoggingConfigurationRedactedFieldsOutputReference {
	_init_.Initialize()

	if err := validateNewWafWebAclLoggingConfigurationRedactedFieldsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewWafWebAclLoggingConfigurationRedactedFieldsOutputReference_Override(w WafWebAclLoggingConfigurationRedactedFieldsOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_WafWebAclLoggingConfigurationRedactedFieldsOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_WafWebAclLoggingConfigurationRedactedFieldsOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (w *jsiiProxy_WafWebAclLoggingConfigurationRedactedFieldsOutputReference) ComputeFqn() *string {
	var returns *string
...
func (w *jsiiProxy_WafWebAclLoggingConfigurationRedactedFieldsOutputReference) PutFieldToMatch(value interface{}) {
...
func (w *jsiiProxy_WafWebAclLoggingConfigurationRedactedFieldsOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (w *jsiiProxy_WafWebAclLoggingConfigurationRedactedFieldsOutputReference) ToString() *string {
	var returns *string
