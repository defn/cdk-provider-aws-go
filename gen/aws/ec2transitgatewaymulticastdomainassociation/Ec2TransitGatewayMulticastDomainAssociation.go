...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/ec2transitgatewaymulticastdomainassociation/internal"
...
func NewEc2TransitGatewayMulticastDomainAssociation(scope constructs.Construct, id *string, config *Ec2TransitGatewayMulticastDomainAssociationConfig) Ec2TransitGatewayMulticastDomainAssociation {
	...
	_jsii_.Create(
		"aws.ec2TransitGatewayMulticastDomainAssociation.Ec2TransitGatewayMulticastDomainAssociation",
...
func Ec2TransitGatewayMulticastDomainAssociation_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateEc2TransitGatewayMulticastDomainAssociation_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (e *jsiiProxy_Ec2TransitGatewayMulticastDomainAssociation) AddMoveTarget(moveTarget *string) {
...
func (e *jsiiProxy_Ec2TransitGatewayMulticastDomainAssociation) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (e *jsiiProxy_Ec2TransitGatewayMulticastDomainAssociation) MoveFromId(id *string) {
...
func (e *jsiiProxy_Ec2TransitGatewayMulticastDomainAssociation) MoveToId(id *string) {
