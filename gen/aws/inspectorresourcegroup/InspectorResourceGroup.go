...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/inspectorresourcegroup/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/inspector_resource_group aws_inspector_resource_group} Resource.
...
func InspectorResourceGroup_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateInspectorResourceGroup_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (i *jsiiProxy_InspectorResourceGroup) AddMoveTarget(moveTarget *string) {
...
func (i *jsiiProxy_InspectorResourceGroup) HasResourceMove() interface{} {
	var returns interface{}
...
func (i *jsiiProxy_InspectorResourceGroup) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (i *jsiiProxy_InspectorResourceGroup) MoveFromId(id *string) {
...
func (i *jsiiProxy_InspectorResourceGroup) MoveTo(moveTarget *string, index interface{}) {
...
func (i *jsiiProxy_InspectorResourceGroup) MoveToId(id *string) {
...
func (i *jsiiProxy_InspectorResourceGroup) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (i *jsiiProxy_InspectorResourceGroup) ToHclTerraform() interface{} {
	var returns interface{}
