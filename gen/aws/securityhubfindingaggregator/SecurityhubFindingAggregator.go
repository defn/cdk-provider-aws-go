...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/securityhubfindingaggregator/internal"
...
func SecurityhubFindingAggregator_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateSecurityhubFindingAggregator_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_SecurityhubFindingAggregator) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_SecurityhubFindingAggregator) HasResourceMove() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_SecurityhubFindingAggregator) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (s *jsiiProxy_SecurityhubFindingAggregator) MoveFromId(id *string) {
...
func (s *jsiiProxy_SecurityhubFindingAggregator) MoveTo(moveTarget *string, index interface{}) {
...
func (s *jsiiProxy_SecurityhubFindingAggregator) MoveToId(id *string) {
...
func (s *jsiiProxy_SecurityhubFindingAggregator) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (s *jsiiProxy_SecurityhubFindingAggregator) ToHclTerraform() interface{} {
	var returns interface{}
