...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/opsworksmysqllayer/internal"
...
func (o *jsiiProxy_OpsworksMysqlLayerCloudwatchConfigurationLogStreamsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
