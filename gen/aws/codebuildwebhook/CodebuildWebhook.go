...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/codebuildwebhook/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/codebuild_webhook aws_codebuild_webhook}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/codebuild_webhook aws_codebuild_webhook} Resource.
func NewCodebuildWebhook(scope constructs.Construct, id *string, config *CodebuildWebhookConfig) CodebuildWebhook {
	_init_.Initialize()

	if err := validateNewCodebuildWebhookParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func CodebuildWebhook_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateCodebuildWebhook_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_CodebuildWebhook) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_CodebuildWebhook) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (c *jsiiProxy_CodebuildWebhook) MoveFromId(id *string) {
...
func (c *jsiiProxy_CodebuildWebhook) MoveToId(id *string) {
