...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/dataawsgluescript/internal"
...
func (j *jsiiProxy_DataAwsGlueScript) DagEdge() DataAwsGlueScriptDagEdgeList {
	var returns DataAwsGlueScriptDagEdgeList
	_jsii_.Get(
		j,
		"dagEdge",
		&returns,
...
func (j *jsiiProxy_DataAwsGlueScript) DagNode() DataAwsGlueScriptDagNodeList {
	var returns DataAwsGlueScriptDagNodeList
	_jsii_.Get(
		j,
		"dagNode",
		&returns,
...
func (j *jsiiProxy_DataAwsGlueScript) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsGlueScript) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/data-sources/glue_script aws_glue_script} Data Source.
func NewDataAwsGlueScript(scope constructs.Construct, id *string, config *DataAwsGlueScriptConfig) DataAwsGlueScript {
	_init_.Initialize()

	if err := validateNewDataAwsGlueScriptParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataAwsGlueScript_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsGlueScript_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsGlueScript) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
