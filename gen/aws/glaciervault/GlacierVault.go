...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/glaciervault/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/glacier_vault aws_glacier_vault} Resource.
...
func GlacierVault_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateGlacierVault_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (g *jsiiProxy_GlacierVault) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GlacierVault) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (g *jsiiProxy_GlacierVault) ToHclTerraform() interface{} {
	var returns interface{}
