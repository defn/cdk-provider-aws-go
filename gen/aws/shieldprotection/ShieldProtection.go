...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/shieldprotection/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/shield_protection aws_shield_protection} Resource.
...
func ShieldProtection_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateShieldProtection_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
// Experimental.
func ShieldProtection_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateShieldProtection_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func ShieldProtection_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateShieldProtection_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (s *jsiiProxy_ShieldProtection) AddMoveTarget(moveTarget *string) {
