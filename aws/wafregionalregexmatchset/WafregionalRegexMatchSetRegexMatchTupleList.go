...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/wafregionalregexmatchset/internal"
...
func NewWafregionalRegexMatchSetRegexMatchTupleList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) WafregionalRegexMatchSetRegexMatchTupleList {
	...
	if err := validateNewWafregionalRegexMatchSetRegexMatchTupleListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_WafregionalRegexMatchSetRegexMatchTupleList{}

	_jsii_.Create(
		"aws.wafregionalRegexMatchSet.WafregionalRegexMatchSetRegexMatchTupleList",
...
func (w *jsiiProxy_WafregionalRegexMatchSetRegexMatchTupleList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
