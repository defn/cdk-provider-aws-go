...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/mskconnectworkerconfiguration/internal"
...
func (j *jsiiProxy_MskconnectWorkerConfiguration) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func NewMskconnectWorkerConfiguration(scope constructs.Construct, id *string, config *MskconnectWorkerConfigurationConfig) MskconnectWorkerConfiguration {
	...
	if err := validateNewMskconnectWorkerConfigurationParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_MskconnectWorkerConfiguration)SetCount(val interface{}) {
...
func MskconnectWorkerConfiguration_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateMskconnectWorkerConfiguration_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func MskconnectWorkerConfiguration_IsConstruct(x interface{}) *bool {
	...
	if err := validateMskconnectWorkerConfiguration_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func MskconnectWorkerConfiguration_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateMskconnectWorkerConfiguration_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func MskconnectWorkerConfiguration_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateMskconnectWorkerConfiguration_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (m *jsiiProxy_MskconnectWorkerConfiguration) AddMoveTarget(moveTarget *string) {
