...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/chimevoiceconnectorgroup/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/chime_voice_connector_group aws_chime_voice_connector_group}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/chime_voice_connector_group aws_chime_voice_connector_group} Resource.
func NewChimeVoiceConnectorGroup(scope constructs.Construct, id *string, config *ChimeVoiceConnectorGroupConfig) ChimeVoiceConnectorGroup {
	...
	if err := validateNewChimeVoiceConnectorGroupParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func ChimeVoiceConnectorGroup_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateChimeVoiceConnectorGroup_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func ChimeVoiceConnectorGroup_IsConstruct(x interface{}) *bool {
	...
	if err := validateChimeVoiceConnectorGroup_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func ChimeVoiceConnectorGroup_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateChimeVoiceConnectorGroup_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func ChimeVoiceConnectorGroup_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateChimeVoiceConnectorGroup_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_ChimeVoiceConnectorGroup) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_ChimeVoiceConnectorGroup) HasResourceMove() interface{} {
	var returns interface{}
...
func (c *jsiiProxy_ChimeVoiceConnectorGroup) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (c *jsiiProxy_ChimeVoiceConnectorGroup) MoveFromId(id *string) {
...
func (c *jsiiProxy_ChimeVoiceConnectorGroup) MoveTo(moveTarget *string, index interface{}) {
...
func (c *jsiiProxy_ChimeVoiceConnectorGroup) MoveToId(id *string) {
...
func (c *jsiiProxy_ChimeVoiceConnectorGroup) PutConnector(value interface{}) {
	if err := c.validatePutConnectorParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		c,
...
func (c *jsiiProxy_ChimeVoiceConnectorGroup) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (c *jsiiProxy_ChimeVoiceConnectorGroup) ToHclTerraform() interface{} {
	var returns interface{}
