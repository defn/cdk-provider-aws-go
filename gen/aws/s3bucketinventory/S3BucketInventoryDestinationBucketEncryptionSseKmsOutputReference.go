...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/s3bucketinventory/internal"
...
func (j *jsiiProxy_S3BucketInventoryDestinationBucketEncryptionSseKmsOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_S3BucketInventoryDestinationBucketEncryptionSseKmsOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_S3BucketInventoryDestinationBucketEncryptionSseKmsOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_S3BucketInventoryDestinationBucketEncryptionSseKmsOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func NewS3BucketInventoryDestinationBucketEncryptionSseKmsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) S3BucketInventoryDestinationBucketEncryptionSseKmsOutputReference {
	...
	if err := validateNewS3BucketInventoryDestinationBucketEncryptionSseKmsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_S3BucketInventoryDestinationBucketEncryptionSseKmsOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_S3BucketInventoryDestinationBucketEncryptionSseKmsOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (s *jsiiProxy_S3BucketInventoryDestinationBucketEncryptionSseKmsOutputReference) ComputeFqn() *string {
	var returns *string
...
func (s *jsiiProxy_S3BucketInventoryDestinationBucketEncryptionSseKmsOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (s *jsiiProxy_S3BucketInventoryDestinationBucketEncryptionSseKmsOutputReference) ToString() *string {
	var returns *string
