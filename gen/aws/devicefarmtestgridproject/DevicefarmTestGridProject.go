...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/devicefarmtestgridproject/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/devicefarm_test_grid_project aws_devicefarm_test_grid_project} Resource.
...
func DevicefarmTestGridProject_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDevicefarmTestGridProject_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DevicefarmTestGridProject) AddMoveTarget(moveTarget *string) {
