...
func (d *jsiiProxy_DataAwsDmsEndpointPostgresSettingsOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAwsDmsEndpointPostgresSettingsOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
