...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/lblistenercertificate/internal"
...
func (j *jsiiProxy_LbListenerCertificate) Connection() interface{} {
...
func (j *jsiiProxy_LbListenerCertificate) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_LbListenerCertificate) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_LbListenerCertificate) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/lb_listener_certificate aws_lb_listener_certificate} Resource.
func NewLbListenerCertificate(scope constructs.Construct, id *string, config *LbListenerCertificateConfig) LbListenerCertificate {
	...
	if err := validateNewLbListenerCertificateParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_LbListenerCertificate)SetConnection(val interface{}) {
...
func (j *jsiiProxy_LbListenerCertificate)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_LbListenerCertificate)SetId(val *string) {
...
func (j *jsiiProxy_LbListenerCertificate)SetProvisioners(val *[]interface{}) {
...
func LbListenerCertificate_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateLbListenerCertificate_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func LbListenerCertificate_IsConstruct(x interface{}) *bool {
	...
	if err := validateLbListenerCertificate_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func LbListenerCertificate_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateLbListenerCertificate_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func LbListenerCertificate_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateLbListenerCertificate_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (l *jsiiProxy_LbListenerCertificate) AddMoveTarget(moveTarget *string) {
...
func (l *jsiiProxy_LbListenerCertificate) GetAnyMapAttribute(terraformAttribute *string) *map[string]interface{} {
...
func (l *jsiiProxy_LbListenerCertificate) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (l *jsiiProxy_LbListenerCertificate) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (l *jsiiProxy_LbListenerCertificate) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (l *jsiiProxy_LbListenerCertificate) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (l *jsiiProxy_LbListenerCertificate) HasResourceMove() interface{} {
	var returns interface{}
...
func (l *jsiiProxy_LbListenerCertificate) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (l *jsiiProxy_LbListenerCertificate) MoveFromId(id *string) {
...
func (l *jsiiProxy_LbListenerCertificate) MoveTo(moveTarget *string, index interface{}) {
...
func (l *jsiiProxy_LbListenerCertificate) MoveToId(id *string) {
...
func (l *jsiiProxy_LbListenerCertificate) ResetId() {
	_jsii_.InvokeVoid(
		l,
		"resetId",
		nil, // no parameters
...
func (l *jsiiProxy_LbListenerCertificate) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (l *jsiiProxy_LbListenerCertificate) ToHclTerraform() interface{} {
	var returns interface{}
