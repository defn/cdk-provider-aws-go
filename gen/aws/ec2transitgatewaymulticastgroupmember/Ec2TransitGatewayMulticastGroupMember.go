...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/ec2transitgatewaymulticastgroupmember/internal"
...
func (j *jsiiProxy_Ec2TransitGatewayMulticastGroupMember) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_Ec2TransitGatewayMulticastGroupMember) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_Ec2TransitGatewayMulticastGroupMember) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_Ec2TransitGatewayMulticastGroupMember) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_Ec2TransitGatewayMulticastGroupMember) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/ec2_transit_gateway_multicast_group_member aws_ec2_transit_gateway_multicast_group_member} Resource.
...
func (j *jsiiProxy_Ec2TransitGatewayMulticastGroupMember)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_Ec2TransitGatewayMulticastGroupMember)SetLifecycle(val *cdktf.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_Ec2TransitGatewayMulticastGroupMember)SetProvider(val cdktf.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func Ec2TransitGatewayMulticastGroupMember_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (e *jsiiProxy_Ec2TransitGatewayMulticastGroupMember) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (e *jsiiProxy_Ec2TransitGatewayMulticastGroupMember) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (e *jsiiProxy_Ec2TransitGatewayMulticastGroupMember) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
