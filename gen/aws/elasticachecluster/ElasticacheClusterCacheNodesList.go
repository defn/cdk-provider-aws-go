...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/elasticachecluster/internal"
...
func NewElasticacheClusterCacheNodesList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ElasticacheClusterCacheNodesList {
	...
	if err := validateNewElasticacheClusterCacheNodesListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (e *jsiiProxy_ElasticacheClusterCacheNodesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
