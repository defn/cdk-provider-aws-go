...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/quicksightfolder/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/quicksight_folder aws_quicksight_folder}.
type QuicksightFolder interface {
	...
	PutTimeouts(value *QuicksightFolderTimeouts)
	ResetAwsAccountId()
	ResetFolderType()
	ResetId()
	ResetName()
...
func (j *jsiiProxy_QuicksightFolder) FolderPath() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"folderPath",
...
func (j *jsiiProxy_QuicksightFolder) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_QuicksightFolder) Tags() *map[string]*string {
...
func (j *jsiiProxy_QuicksightFolder) TagsAll() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAll",
...
func (j *jsiiProxy_QuicksightFolder) TagsAllInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAllInput",
...
func (j *jsiiProxy_QuicksightFolder) TagsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsInput",
...
func (j *jsiiProxy_QuicksightFolder) Timeouts() QuicksightFolderTimeoutsOutputReference {
	var returns QuicksightFolderTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func (j *jsiiProxy_QuicksightFolder) TimeoutsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"timeoutsInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/quicksight_folder aws_quicksight_folder} Resource.
func NewQuicksightFolder(scope constructs.Construct, id *string, config *QuicksightFolderConfig) QuicksightFolder {
	...
	_jsii_.Create(
		"aws.quicksightFolder.QuicksightFolder",
...
func (j *jsiiProxy_QuicksightFolder)SetId(val *string) {
...
func (j *jsiiProxy_QuicksightFolder)SetTags(val *map[string]*string) {
...
func (j *jsiiProxy_QuicksightFolder)SetTagsAll(val *map[string]*string) {
...
func (q *jsiiProxy_QuicksightFolder) PutTimeouts(value *QuicksightFolderTimeouts) {
...
func (q *jsiiProxy_QuicksightFolder) ResetId() {
	_jsii_.InvokeVoid(
		q,
		"resetId",
		nil, // no parameters
...
func (q *jsiiProxy_QuicksightFolder) ResetTagsAll() {
	_jsii_.InvokeVoid(
		q,
		"resetTagsAll",
		nil, // no parameters
...
func (q *jsiiProxy_QuicksightFolder) ResetTimeouts() {
	_jsii_.InvokeVoid(
		q,
		"resetTimeouts",
		nil, // no parameters
