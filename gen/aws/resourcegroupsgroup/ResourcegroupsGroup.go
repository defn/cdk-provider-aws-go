...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/resourcegroupsgroup/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/resourcegroups_group aws_resourcegroups_group}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/resourcegroups_group aws_resourcegroups_group} Resource.
func NewResourcegroupsGroup(scope constructs.Construct, id *string, config *ResourcegroupsGroupConfig) ResourcegroupsGroup {
	_init_.Initialize()

	if err := validateNewResourcegroupsGroupParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func ResourcegroupsGroup_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateResourcegroupsGroup_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (r *jsiiProxy_ResourcegroupsGroup) AddMoveTarget(moveTarget *string) {
...
func (r *jsiiProxy_ResourcegroupsGroup) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (r *jsiiProxy_ResourcegroupsGroup) MoveFromId(id *string) {
...
func (r *jsiiProxy_ResourcegroupsGroup) MoveToId(id *string) {
