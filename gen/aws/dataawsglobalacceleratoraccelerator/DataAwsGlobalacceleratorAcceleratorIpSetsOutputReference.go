...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/dataawsglobalacceleratoraccelerator/internal"
...
func NewDataAwsGlobalacceleratorAcceleratorIpSetsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DataAwsGlobalacceleratorAcceleratorIpSetsOutputReference {
	...
	if err := validateNewDataAwsGlobalacceleratorAcceleratorIpSetsOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
