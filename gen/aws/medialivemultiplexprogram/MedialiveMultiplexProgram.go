...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/medialive_multiplex_program aws_medialive_multiplex_program}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/medialive_multiplex_program aws_medialive_multiplex_program} Resource.
func NewMedialiveMultiplexProgram(scope constructs.Construct, id *string, config *MedialiveMultiplexProgramConfig) MedialiveMultiplexProgram {
	...
	_jsii_.Create(
		"aws.medialiveMultiplexProgram.MedialiveMultiplexProgram",
...
func (m *jsiiProxy_MedialiveMultiplexProgram) HasResourceMove() interface{} {
	var returns interface{}
...
func (m *jsiiProxy_MedialiveMultiplexProgram) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (m *jsiiProxy_MedialiveMultiplexProgram) ToHclTerraform() interface{} {
	var returns interface{}
