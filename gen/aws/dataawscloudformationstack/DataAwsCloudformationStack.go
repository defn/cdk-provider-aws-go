...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/dataawscloudformationstack/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/data-sources/cloudformation_stack aws_cloudformation_stack} Data Source.
...
func DataAwsCloudformationStack_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsCloudformationStack_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
