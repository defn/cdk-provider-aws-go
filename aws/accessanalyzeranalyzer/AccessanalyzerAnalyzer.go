...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/accessanalyzeranalyzer/internal"
...
func (a *jsiiProxy_AccessanalyzerAnalyzer) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (a *jsiiProxy_AccessanalyzerAnalyzer) ToHclTerraform() interface{} {
	var returns interface{}
