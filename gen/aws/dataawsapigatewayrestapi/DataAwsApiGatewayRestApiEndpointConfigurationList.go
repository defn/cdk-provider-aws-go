...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/dataawsapigatewayrestapi/internal"
...
func NewDataAwsApiGatewayRestApiEndpointConfigurationList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsApiGatewayRestApiEndpointConfigurationList {
	...
	if err := validateNewDataAwsApiGatewayRestApiEndpointConfigurationListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsApiGatewayRestApiEndpointConfigurationList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
