...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/efsaccesspoint/internal"
...
func (j *jsiiProxy_EfsAccessPointRootDirectoryOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_EfsAccessPointRootDirectoryOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_EfsAccessPointRootDirectoryOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_EfsAccessPointRootDirectoryOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_EfsAccessPointRootDirectoryOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (e *jsiiProxy_EfsAccessPointRootDirectoryOutputReference) ComputeFqn() *string {
	var returns *string
...
func (e *jsiiProxy_EfsAccessPointRootDirectoryOutputReference) PutCreationInfo(value *EfsAccessPointRootDirectoryCreationInfo) {
	if err := e.validatePutCreationInfoParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		e,
...
func (e *jsiiProxy_EfsAccessPointRootDirectoryOutputReference) ToString() *string {
	var returns *string
