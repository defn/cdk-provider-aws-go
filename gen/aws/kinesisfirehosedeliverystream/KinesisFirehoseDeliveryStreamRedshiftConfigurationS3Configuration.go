...
type KinesisFirehoseDeliveryStreamRedshiftConfigurationS3Configuration struct {
	...
	CloudwatchLoggingOptions *KinesisFirehoseDeliveryStreamRedshiftConfigurationS3ConfigurationCloudwatchLoggingOptions `field:"optional" json:"cloudwatchLoggingOptions" yaml:"cloudwatchLoggingOptions"`
