...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/dataawscloudwatcheventbus/internal"
...
func (j *jsiiProxy_DataAwsCloudwatchEventBus) Count() interface{} {
...
func (j *jsiiProxy_DataAwsCloudwatchEventBus)SetCount(val interface{}) {
...
func DataAwsCloudwatchEventBus_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsCloudwatchEventBus_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
// Experimental.
func DataAwsCloudwatchEventBus_IsTerraformDataSource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsCloudwatchEventBus_IsTerraformDataSourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAwsCloudwatchEventBus_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsCloudwatchEventBus_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataAwsCloudwatchEventBus) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataAwsCloudwatchEventBus) ToHclTerraform() interface{} {
	var returns interface{}
