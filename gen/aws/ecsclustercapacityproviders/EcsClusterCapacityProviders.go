...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/ecsclustercapacityproviders/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/ecs_cluster_capacity_providers aws_ecs_cluster_capacity_providers}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/ecs_cluster_capacity_providers aws_ecs_cluster_capacity_providers} Resource.
func NewEcsClusterCapacityProviders(scope constructs.Construct, id *string, config *EcsClusterCapacityProvidersConfig) EcsClusterCapacityProviders {
	...
	if err := validateNewEcsClusterCapacityProvidersParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func EcsClusterCapacityProviders_IsConstruct(x interface{}) *bool {
	...
	if err := validateEcsClusterCapacityProviders_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func EcsClusterCapacityProviders_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateEcsClusterCapacityProviders_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func EcsClusterCapacityProviders_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateEcsClusterCapacityProviders_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (e *jsiiProxy_EcsClusterCapacityProviders) AddMoveTarget(moveTarget *string) {
...
func (e *jsiiProxy_EcsClusterCapacityProviders) HasResourceMove() interface{} {
	var returns interface{}
...
func (e *jsiiProxy_EcsClusterCapacityProviders) MoveFromId(id *string) {
...
func (e *jsiiProxy_EcsClusterCapacityProviders) MoveTo(moveTarget *string, index interface{}) {
...
func (e *jsiiProxy_EcsClusterCapacityProviders) MoveToId(id *string) {
...
func (e *jsiiProxy_EcsClusterCapacityProviders) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (e *jsiiProxy_EcsClusterCapacityProviders) ToHclTerraform() interface{} {
	var returns interface{}
