...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/athenaworkgroup/internal"
...
func (j *jsiiProxy_AthenaWorkgroupConfigurationEngineVersionOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AthenaWorkgroupConfigurationEngineVersionOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_AthenaWorkgroupConfigurationEngineVersionOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func NewAthenaWorkgroupConfigurationEngineVersionOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) AthenaWorkgroupConfigurationEngineVersionOutputReference {
	...
	if err := validateNewAthenaWorkgroupConfigurationEngineVersionOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_AthenaWorkgroupConfigurationEngineVersionOutputReference) ComputeFqn() *string {
	var returns *string
...
func (a *jsiiProxy_AthenaWorkgroupConfigurationEngineVersionOutputReference) ToString() *string {
	var returns *string
