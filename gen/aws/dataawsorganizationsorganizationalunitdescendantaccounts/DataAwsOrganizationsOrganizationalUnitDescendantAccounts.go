...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/dataawsorganizationsorganizationalunitdescendantaccounts/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/data-sources/organizations_organizational_unit_descendant_accounts aws_organizations_organizational_unit_descendant_accounts} Data Source.
func NewDataAwsOrganizationsOrganizationalUnitDescendantAccounts(scope constructs.Construct, id *string, config *DataAwsOrganizationsOrganizationalUnitDescendantAccountsConfig) DataAwsOrganizationsOrganizationalUnitDescendantAccounts {
	...
	_jsii_.Create(
		"aws.dataAwsOrganizationsOrganizationalUnitDescendantAccounts.DataAwsOrganizationsOrganizationalUnitDescendantAccounts",
...
func DataAwsOrganizationsOrganizationalUnitDescendantAccounts_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsOrganizationsOrganizationalUnitDescendantAccounts_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsOrganizationsOrganizationalUnitDescendantAccounts) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataAwsOrganizationsOrganizationalUnitDescendantAccounts) ToHclTerraform() interface{} {
	var returns interface{}
