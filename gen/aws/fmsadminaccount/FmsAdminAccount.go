...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/fms_admin_account aws_fms_admin_account} Resource.
...
func FmsAdminAccount_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateFmsAdminAccount_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (f *jsiiProxy_FmsAdminAccount) AddMoveTarget(moveTarget *string) {
...
func (f *jsiiProxy_FmsAdminAccount) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (f *jsiiProxy_FmsAdminAccount) MoveFromId(id *string) {
...
func (f *jsiiProxy_FmsAdminAccount) MoveToId(id *string) {
