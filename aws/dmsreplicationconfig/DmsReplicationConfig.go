...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/dms_replication_config aws_dms_replication_config} Resource.
func NewDmsReplicationConfig(scope constructs.Construct, id *string, config *DmsReplicationConfigConfig) DmsReplicationConfig {
	...
	_jsii_.Create(
		"aws.dmsReplicationConfig.DmsReplicationConfig",
