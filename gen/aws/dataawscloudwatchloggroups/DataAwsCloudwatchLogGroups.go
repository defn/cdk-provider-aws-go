...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/dataawscloudwatchloggroups/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/data-sources/cloudwatch_log_groups aws_cloudwatch_log_groups} Data Source.
...
// Experimental.
func DataAwsCloudwatchLogGroups_IsTerraformDataSource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsCloudwatchLogGroups_IsTerraformDataSourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAwsCloudwatchLogGroups_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsCloudwatchLogGroups_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
