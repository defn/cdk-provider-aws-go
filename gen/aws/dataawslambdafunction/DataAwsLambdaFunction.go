...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/dataawslambdafunction/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/data-sources/lambda_function aws_lambda_function}.
type DataAwsLambdaFunction interface {
	...
	LoggingConfig() DataAwsLambdaFunctionLoggingConfigList
	MemorySize() *float64
	// The tree node.
...
func (j *jsiiProxy_DataAwsLambdaFunction) LoggingConfig() DataAwsLambdaFunctionLoggingConfigList {
	var returns DataAwsLambdaFunctionLoggingConfigList
	_jsii_.Get(
		j,
		"loggingConfig",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/data-sources/lambda_function aws_lambda_function} Data Source.
func NewDataAwsLambdaFunction(scope constructs.Construct, id *string, config *DataAwsLambdaFunctionConfig) DataAwsLambdaFunction {
	...
	if err := validateNewDataAwsLambdaFunctionParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataAwsLambdaFunction_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsLambdaFunction_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
