...
func (d *jsiiProxy_DataAwsQuicksightDataSetLogicalTableMapDataTransformsFilterOperationList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
