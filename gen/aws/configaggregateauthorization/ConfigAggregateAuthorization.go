...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/configaggregateauthorization/internal"
...
func NewConfigAggregateAuthorization(scope constructs.Construct, id *string, config *ConfigAggregateAuthorizationConfig) ConfigAggregateAuthorization {
	...
	if err := validateNewConfigAggregateAuthorizationParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func ConfigAggregateAuthorization_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateConfigAggregateAuthorization_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func ConfigAggregateAuthorization_IsConstruct(x interface{}) *bool {
	...
	if err := validateConfigAggregateAuthorization_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func ConfigAggregateAuthorization_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateConfigAggregateAuthorization_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func ConfigAggregateAuthorization_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateConfigAggregateAuthorization_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_ConfigAggregateAuthorization) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_ConfigAggregateAuthorization) HasResourceMove() interface{} {
	var returns interface{}
...
func (c *jsiiProxy_ConfigAggregateAuthorization) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (c *jsiiProxy_ConfigAggregateAuthorization) MoveFromId(id *string) {
...
func (c *jsiiProxy_ConfigAggregateAuthorization) MoveTo(moveTarget *string, index interface{}) {
...
func (c *jsiiProxy_ConfigAggregateAuthorization) MoveToId(id *string) {
...
func (c *jsiiProxy_ConfigAggregateAuthorization) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (c *jsiiProxy_ConfigAggregateAuthorization) ToHclTerraform() interface{} {
	var returns interface{}
