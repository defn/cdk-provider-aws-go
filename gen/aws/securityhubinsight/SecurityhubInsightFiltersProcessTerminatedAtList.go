...
func (j *jsiiProxy_SecurityhubInsightFiltersProcessTerminatedAtList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_SecurityhubInsightFiltersProcessTerminatedAtList) InternalValue() interface{} {
...
func (j *jsiiProxy_SecurityhubInsightFiltersProcessTerminatedAtList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_SecurityhubInsightFiltersProcessTerminatedAtList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (j *jsiiProxy_SecurityhubInsightFiltersProcessTerminatedAtList)SetInternalValue(val interface{}) {
...
func (j *jsiiProxy_SecurityhubInsightFiltersProcessTerminatedAtList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_SecurityhubInsightFiltersProcessTerminatedAtList)SetWrapsSet(val *bool) {
...
func (s *jsiiProxy_SecurityhubInsightFiltersProcessTerminatedAtList) ComputeFqn() *string {
	var returns *string
...
func (s *jsiiProxy_SecurityhubInsightFiltersProcessTerminatedAtList) Get(index *float64) SecurityhubInsightFiltersProcessTerminatedAtOutputReference {
	if err := s.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns SecurityhubInsightFiltersProcessTerminatedAtOutputReference
...
func (s *jsiiProxy_SecurityhubInsightFiltersProcessTerminatedAtList) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (s *jsiiProxy_SecurityhubInsightFiltersProcessTerminatedAtList) ToString() *string {
	var returns *string
