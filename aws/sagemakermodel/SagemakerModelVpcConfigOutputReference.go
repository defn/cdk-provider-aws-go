...
func (j *jsiiProxy_SagemakerModelVpcConfigOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_SagemakerModelVpcConfigOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SagemakerModelVpcConfigOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_SagemakerModelVpcConfigOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func NewSagemakerModelVpcConfigOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) SagemakerModelVpcConfigOutputReference {
	...
	if err := validateNewSagemakerModelVpcConfigOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_SagemakerModelVpcConfigOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_SagemakerModelVpcConfigOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (s *jsiiProxy_SagemakerModelVpcConfigOutputReference) ComputeFqn() *string {
	var returns *string
...
func (s *jsiiProxy_SagemakerModelVpcConfigOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (s *jsiiProxy_SagemakerModelVpcConfigOutputReference) ToString() *string {
	var returns *string
