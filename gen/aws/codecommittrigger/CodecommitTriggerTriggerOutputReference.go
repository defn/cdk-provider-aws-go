...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/codecommittrigger/internal"
...
func (j *jsiiProxy_CodecommitTriggerTriggerOutputReference) BranchesInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"branchesInput",
...
func (j *jsiiProxy_CodecommitTriggerTriggerOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CodecommitTriggerTriggerOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CodecommitTriggerTriggerOutputReference) CustomData() *string {
	var returns *string
	_jsii_.Get(
		j,
		"customData",
...
func (j *jsiiProxy_CodecommitTriggerTriggerOutputReference) CustomDataInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"customDataInput",
...
func (j *jsiiProxy_CodecommitTriggerTriggerOutputReference) DestinationArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"destinationArn",
...
func (j *jsiiProxy_CodecommitTriggerTriggerOutputReference) DestinationArnInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"destinationArnInput",
...
func (j *jsiiProxy_CodecommitTriggerTriggerOutputReference) Events() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"events",
...
func (j *jsiiProxy_CodecommitTriggerTriggerOutputReference) EventsInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"eventsInput",
...
func (j *jsiiProxy_CodecommitTriggerTriggerOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_CodecommitTriggerTriggerOutputReference) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_CodecommitTriggerTriggerOutputReference) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_CodecommitTriggerTriggerOutputReference) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (c *jsiiProxy_CodecommitTriggerTriggerOutputReference) ComputeFqn() *string {
	var returns *string
...
func (c *jsiiProxy_CodecommitTriggerTriggerOutputReference) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (c *jsiiProxy_CodecommitTriggerTriggerOutputReference) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (c *jsiiProxy_CodecommitTriggerTriggerOutputReference) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (c *jsiiProxy_CodecommitTriggerTriggerOutputReference) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (c *jsiiProxy_CodecommitTriggerTriggerOutputReference) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (c *jsiiProxy_CodecommitTriggerTriggerOutputReference) GetStringAttribute(terraformAttribute *string) *string {
...
func (c *jsiiProxy_CodecommitTriggerTriggerOutputReference) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (c *jsiiProxy_CodecommitTriggerTriggerOutputReference) ResetBranches() {
	_jsii_.InvokeVoid(
		c,
		"resetBranches",
		nil, // no parameters
...
func (c *jsiiProxy_CodecommitTriggerTriggerOutputReference) ResetCustomData() {
	_jsii_.InvokeVoid(
		c,
		"resetCustomData",
		nil, // no parameters
...
func (c *jsiiProxy_CodecommitTriggerTriggerOutputReference) ToString() *string {
	var returns *string
