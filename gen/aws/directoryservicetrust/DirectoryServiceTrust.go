...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/directoryservicetrust/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/directory_service_trust aws_directory_service_trust} Resource.
func NewDirectoryServiceTrust(scope constructs.Construct, id *string, config *DirectoryServiceTrustConfig) DirectoryServiceTrust {
	...
	_jsii_.Create(
		"aws.directoryServiceTrust.DirectoryServiceTrust",
