...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/macie2account/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/macie2_account aws_macie2_account} Resource.
func NewMacie2Account(scope constructs.Construct, id *string, config *Macie2AccountConfig) Macie2Account {
	_init_.Initialize()

	if err := validateNewMacie2AccountParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func Macie2Account_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateMacie2Account_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (m *jsiiProxy_Macie2Account) AddMoveTarget(moveTarget *string) {
...
func (m *jsiiProxy_Macie2Account) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (m *jsiiProxy_Macie2Account) MoveFromId(id *string) {
...
func (m *jsiiProxy_Macie2Account) MoveToId(id *string) {
