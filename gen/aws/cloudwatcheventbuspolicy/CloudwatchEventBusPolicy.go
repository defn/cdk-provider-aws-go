...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/cloudwatcheventbuspolicy/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/cloudwatch_event_bus_policy aws_cloudwatch_event_bus_policy} Resource.
func NewCloudwatchEventBusPolicy(scope constructs.Construct, id *string, config *CloudwatchEventBusPolicyConfig) CloudwatchEventBusPolicy {
	...
	if err := validateNewCloudwatchEventBusPolicyParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func CloudwatchEventBusPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateCloudwatchEventBusPolicy_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func CloudwatchEventBusPolicy_IsConstruct(x interface{}) *bool {
	...
	if err := validateCloudwatchEventBusPolicy_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func CloudwatchEventBusPolicy_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCloudwatchEventBusPolicy_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func CloudwatchEventBusPolicy_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCloudwatchEventBusPolicy_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CloudwatchEventBusPolicy) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_CloudwatchEventBusPolicy) HasResourceMove() interface{} {
	var returns interface{}
...
func (c *jsiiProxy_CloudwatchEventBusPolicy) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (c *jsiiProxy_CloudwatchEventBusPolicy) MoveFromId(id *string) {
...
func (c *jsiiProxy_CloudwatchEventBusPolicy) MoveTo(moveTarget *string, index interface{}) {
...
func (c *jsiiProxy_CloudwatchEventBusPolicy) MoveToId(id *string) {
...
func (c *jsiiProxy_CloudwatchEventBusPolicy) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (c *jsiiProxy_CloudwatchEventBusPolicy) ToHclTerraform() interface{} {
	var returns interface{}
