...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "fipsDnsName", GoGetter: "FipsDnsName"},
	...
	_jsii_.RegisterStruct(
		"aws.ec2InstanceConnectEndpoint.Ec2InstanceConnectEndpointConfig",
		reflect.TypeOf((*Ec2InstanceConnectEndpointConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws.ec2InstanceConnectEndpoint.Ec2InstanceConnectEndpointTimeouts",
