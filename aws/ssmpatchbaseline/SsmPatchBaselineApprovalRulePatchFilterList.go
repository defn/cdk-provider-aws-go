...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/ssmpatchbaseline/internal"
...
func NewSsmPatchBaselineApprovalRulePatchFilterList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) SsmPatchBaselineApprovalRulePatchFilterList {
	...
	if err := validateNewSsmPatchBaselineApprovalRulePatchFilterListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_SsmPatchBaselineApprovalRulePatchFilterList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
