...
func (j *jsiiProxy_WafWebAclRulesActionOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_WafWebAclRulesActionOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_WafWebAclRulesActionOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_WafWebAclRulesActionOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_WafWebAclRulesActionOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (w *jsiiProxy_WafWebAclRulesActionOutputReference) ComputeFqn() *string {
	var returns *string
...
func (w *jsiiProxy_WafWebAclRulesActionOutputReference) ToString() *string {
	var returns *string
