...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/data-sources/ssmincidents_replication_set aws_ssmincidents_replication_set} Data Source.
...
func DataAwsSsmincidentsReplicationSet_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsSsmincidentsReplicationSet_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsSsmincidentsReplicationSet) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataAwsSsmincidentsReplicationSet) ToHclTerraform() interface{} {
	var returns interface{}
