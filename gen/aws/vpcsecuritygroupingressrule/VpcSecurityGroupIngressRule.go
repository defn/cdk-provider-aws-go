...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/vpcsecuritygroupingressrule/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/vpc_security_group_ingress_rule aws_vpc_security_group_ingress_rule}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/vpc_security_group_ingress_rule aws_vpc_security_group_ingress_rule} Resource.
func NewVpcSecurityGroupIngressRule(scope constructs.Construct, id *string, config *VpcSecurityGroupIngressRuleConfig) VpcSecurityGroupIngressRule {
	...
	_jsii_.Create(
		"aws.vpcSecurityGroupIngressRule.VpcSecurityGroupIngressRule",
