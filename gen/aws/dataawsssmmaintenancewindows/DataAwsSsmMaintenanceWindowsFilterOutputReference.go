...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/dataawsssmmaintenancewindows/internal"
...
func NewDataAwsSsmMaintenanceWindowsFilterOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DataAwsSsmMaintenanceWindowsFilterOutputReference {
	...
	if err := validateNewDataAwsSsmMaintenanceWindowsFilterOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
