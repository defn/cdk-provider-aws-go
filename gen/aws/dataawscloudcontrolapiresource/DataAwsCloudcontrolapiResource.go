...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/dataawscloudcontrolapiresource/internal"
...
func NewDataAwsCloudcontrolapiResource(scope constructs.Construct, id *string, config *DataAwsCloudcontrolapiResourceConfig) DataAwsCloudcontrolapiResource {
	...
	_jsii_.Create(
		"aws.dataAwsCloudcontrolapiResource.DataAwsCloudcontrolapiResource",
