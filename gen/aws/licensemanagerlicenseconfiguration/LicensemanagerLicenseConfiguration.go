...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/licensemanagerlicenseconfiguration/internal"
...
func (l *jsiiProxy_LicensemanagerLicenseConfiguration) AddMoveTarget(moveTarget *string) {
...
func (l *jsiiProxy_LicensemanagerLicenseConfiguration) MoveFromId(id *string) {
...
func (l *jsiiProxy_LicensemanagerLicenseConfiguration) MoveToId(id *string) {
