...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/glueuserdefinedfunction/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/glue_user_defined_function aws_glue_user_defined_function} Resource.
...
func (g *jsiiProxy_GlueUserDefinedFunction) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GlueUserDefinedFunction) MoveFromId(id *string) {
...
func (g *jsiiProxy_GlueUserDefinedFunction) MoveToId(id *string) {
