...
func init() {
	...
	_jsii_.RegisterStruct(
		"aws.s3BucketLifecycleConfiguration.S3BucketLifecycleConfigurationTimeouts",
		reflect.TypeOf((*S3BucketLifecycleConfigurationTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"aws.s3BucketLifecycleConfiguration.S3BucketLifecycleConfigurationTimeoutsOutputReference",
		reflect.TypeOf((*S3BucketLifecycleConfigurationTimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
