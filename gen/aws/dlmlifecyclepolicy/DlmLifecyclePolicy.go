...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/dlm_lifecycle_policy aws_dlm_lifecycle_policy}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/dlm_lifecycle_policy aws_dlm_lifecycle_policy} Resource.
...
func DlmLifecyclePolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDlmLifecyclePolicy_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DlmLifecyclePolicy) AddMoveTarget(moveTarget *string) {
