...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/workspacesipgroup/internal"
...
func NewWorkspacesIpGroupRulesList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) WorkspacesIpGroupRulesList {
	...
	if err := validateNewWorkspacesIpGroupRulesListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (w *jsiiProxy_WorkspacesIpGroupRulesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
