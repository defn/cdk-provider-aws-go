...
func init() {
	_jsii_.RegisterClass(
		"aws.eksAccessPolicyAssociation.EksAccessPolicyAssociation",
		reflect.TypeOf((*EksAccessPolicyAssociation)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "accessScope", GoGetter: "AccessScope"},
			_jsii_.MemberProperty{JsiiProperty: "accessScopeInput", GoGetter: "AccessScopeInput"},
			_jsii_.MemberMethod{JsiiMethod: "addMoveTarget", GoMethod: "AddMoveTarget"},
			_jsii_.MemberMethod{JsiiMethod: "addOverride", GoMethod: "AddOverride"},
			_jsii_.MemberProperty{JsiiProperty: "associatedAt", GoGetter: "AssociatedAt"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putAccessScope", GoMethod: "PutAccessScope"},
	...
	_jsii_.RegisterStruct(
		"aws.eksAccessPolicyAssociation.EksAccessPolicyAssociationAccessScope",
	...
	_jsii_.RegisterStruct(
		"aws.eksAccessPolicyAssociation.EksAccessPolicyAssociationTimeouts",
