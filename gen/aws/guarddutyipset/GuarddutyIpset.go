...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/guarddutyipset/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/guardduty_ipset aws_guardduty_ipset}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/guardduty_ipset aws_guardduty_ipset} Resource.
...
func GuarddutyIpset_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateGuarddutyIpset_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (g *jsiiProxy_GuarddutyIpset) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GuarddutyIpset) HasResourceMove() interface{} {
	var returns interface{}
...
func (g *jsiiProxy_GuarddutyIpset) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (g *jsiiProxy_GuarddutyIpset) MoveFromId(id *string) {
...
func (g *jsiiProxy_GuarddutyIpset) MoveTo(moveTarget *string, index interface{}) {
...
func (g *jsiiProxy_GuarddutyIpset) MoveToId(id *string) {
...
func (g *jsiiProxy_GuarddutyIpset) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (g *jsiiProxy_GuarddutyIpset) ToHclTerraform() interface{} {
	var returns interface{}
