...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/dataawsbatchjobqueue/internal"
...
func NewDataAwsBatchJobQueueComputeEnvironmentOrderOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DataAwsBatchJobQueueComputeEnvironmentOrderOutputReference {
	...
	if err := validateNewDataAwsBatchJobQueueComputeEnvironmentOrderOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
