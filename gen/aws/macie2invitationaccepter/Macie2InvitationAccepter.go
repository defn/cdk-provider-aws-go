...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/macie2invitationaccepter/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/macie2_invitation_accepter aws_macie2_invitation_accepter} Resource.
...
func Macie2InvitationAccepter_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateMacie2InvitationAccepter_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (m *jsiiProxy_Macie2InvitationAccepter) AddMoveTarget(moveTarget *string) {
...
func (m *jsiiProxy_Macie2InvitationAccepter) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (m *jsiiProxy_Macie2InvitationAccepter) MoveFromId(id *string) {
...
func (m *jsiiProxy_Macie2InvitationAccepter) MoveToId(id *string) {
