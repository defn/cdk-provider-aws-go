...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/networkfirewallloggingconfiguration/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/networkfirewall_logging_configuration aws_networkfirewall_logging_configuration} Resource.
...
func NetworkfirewallLoggingConfiguration_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateNetworkfirewallLoggingConfiguration_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (n *jsiiProxy_NetworkfirewallLoggingConfiguration) AddMoveTarget(moveTarget *string) {
...
func (n *jsiiProxy_NetworkfirewallLoggingConfiguration) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (n *jsiiProxy_NetworkfirewallLoggingConfiguration) MoveFromId(id *string) {
...
func (n *jsiiProxy_NetworkfirewallLoggingConfiguration) MoveToId(id *string) {
