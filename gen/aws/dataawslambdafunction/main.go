...
func init() {
	...
	_jsii_.RegisterStruct(
		"aws.dataAwsLambdaFunction.DataAwsLambdaFunctionLoggingConfig",
		reflect.TypeOf((*DataAwsLambdaFunctionLoggingConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"aws.dataAwsLambdaFunction.DataAwsLambdaFunctionLoggingConfigList",
		reflect.TypeOf((*DataAwsLambdaFunctionLoggingConfigList)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "allWithMapKey", GoMethod: "AllWithMapKey"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
	...
	_jsii_.RegisterClass(
		"aws.dataAwsLambdaFunction.DataAwsLambdaFunctionLoggingConfigOutputReference",
		reflect.TypeOf((*DataAwsLambdaFunctionLoggingConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
