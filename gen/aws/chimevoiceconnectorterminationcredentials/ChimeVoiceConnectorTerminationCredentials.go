...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/chimevoiceconnectorterminationcredentials/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/chime_voice_connector_termination_credentials aws_chime_voice_connector_termination_credentials}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/chime_voice_connector_termination_credentials aws_chime_voice_connector_termination_credentials} Resource.
...
func ChimeVoiceConnectorTerminationCredentials_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateChimeVoiceConnectorTerminationCredentials_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_ChimeVoiceConnectorTerminationCredentials) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_ChimeVoiceConnectorTerminationCredentials) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (c *jsiiProxy_ChimeVoiceConnectorTerminationCredentials) MoveFromId(id *string) {
...
func (c *jsiiProxy_ChimeVoiceConnectorTerminationCredentials) MoveToId(id *string) {
