...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/ecstaskdefinition/internal"
...
func NewEcsTaskDefinitionPlacementConstraintsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) EcsTaskDefinitionPlacementConstraintsList {
	...
	if err := validateNewEcsTaskDefinitionPlacementConstraintsListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (e *jsiiProxy_EcsTaskDefinitionPlacementConstraintsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
