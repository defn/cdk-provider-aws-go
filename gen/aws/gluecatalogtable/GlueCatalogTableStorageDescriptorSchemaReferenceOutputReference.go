...
func (j *jsiiProxy_GlueCatalogTableStorageDescriptorSchemaReferenceOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_GlueCatalogTableStorageDescriptorSchemaReferenceOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_GlueCatalogTableStorageDescriptorSchemaReferenceOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_GlueCatalogTableStorageDescriptorSchemaReferenceOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func NewGlueCatalogTableStorageDescriptorSchemaReferenceOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) GlueCatalogTableStorageDescriptorSchemaReferenceOutputReference {
	...
	if err := validateNewGlueCatalogTableStorageDescriptorSchemaReferenceOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_GlueCatalogTableStorageDescriptorSchemaReferenceOutputReference{}

	_jsii_.Create(
		"aws.glueCatalogTable.GlueCatalogTableStorageDescriptorSchemaReferenceOutputReference",
...
func (j *jsiiProxy_GlueCatalogTableStorageDescriptorSchemaReferenceOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_GlueCatalogTableStorageDescriptorSchemaReferenceOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (g *jsiiProxy_GlueCatalogTableStorageDescriptorSchemaReferenceOutputReference) ComputeFqn() *string {
	var returns *string
...
func (g *jsiiProxy_GlueCatalogTableStorageDescriptorSchemaReferenceOutputReference) ToString() *string {
	var returns *string
