...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/ec2transitgatewayroutetable/internal"
...
func (j *jsiiProxy_Ec2TransitGatewayRouteTable) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_Ec2TransitGatewayRouteTable) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_Ec2TransitGatewayRouteTable) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_Ec2TransitGatewayRouteTable) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_Ec2TransitGatewayRouteTable) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_Ec2TransitGatewayRouteTable) Node() constructs.Node {
...
func (j *jsiiProxy_Ec2TransitGatewayRouteTable) Tags() *map[string]*string {
...
func (j *jsiiProxy_Ec2TransitGatewayRouteTable) TagsAll() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAll",
...
func (j *jsiiProxy_Ec2TransitGatewayRouteTable) TagsAllInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAllInput",
...
func (j *jsiiProxy_Ec2TransitGatewayRouteTable) TagsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsInput",
...
func (j *jsiiProxy_Ec2TransitGatewayRouteTable) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_Ec2TransitGatewayRouteTable) TransitGatewayId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"transitGatewayId",
...
func (j *jsiiProxy_Ec2TransitGatewayRouteTable) TransitGatewayIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/ec2_transit_gateway_route_table aws_ec2_transit_gateway_route_table} Resource.
func NewEc2TransitGatewayRouteTable(scope constructs.Construct, id *string, config *Ec2TransitGatewayRouteTableConfig) Ec2TransitGatewayRouteTable {
	...
	if err := validateNewEc2TransitGatewayRouteTableParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func Ec2TransitGatewayRouteTable_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws.ec2TransitGatewayRouteTable.Ec2TransitGatewayRouteTable",
...
func (e *jsiiProxy_Ec2TransitGatewayRouteTable) AddMoveTarget(moveTarget *string) {
...
func (e *jsiiProxy_Ec2TransitGatewayRouteTable) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (e *jsiiProxy_Ec2TransitGatewayRouteTable) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (e *jsiiProxy_Ec2TransitGatewayRouteTable) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (e *jsiiProxy_Ec2TransitGatewayRouteTable) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (e *jsiiProxy_Ec2TransitGatewayRouteTable) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (e *jsiiProxy_Ec2TransitGatewayRouteTable) GetStringAttribute(terraformAttribute *string) *string {
...
func (e *jsiiProxy_Ec2TransitGatewayRouteTable) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (e *jsiiProxy_Ec2TransitGatewayRouteTable) OverrideLogicalId(newLogicalId *string) {
...
func (e *jsiiProxy_Ec2TransitGatewayRouteTable) ResetId() {
	_jsii_.InvokeVoid(
		e,
		"resetId",
		nil, // no parameters
...
func (e *jsiiProxy_Ec2TransitGatewayRouteTable) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		e,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (e *jsiiProxy_Ec2TransitGatewayRouteTable) ResetTags() {
	_jsii_.InvokeVoid(
		e,
		"resetTags",
		nil, // no parameters
...
func (e *jsiiProxy_Ec2TransitGatewayRouteTable) ResetTagsAll() {
	_jsii_.InvokeVoid(
		e,
		"resetTagsAll",
		nil, // no parameters
...
func (e *jsiiProxy_Ec2TransitGatewayRouteTable) ToString() *string {
	var returns *string
