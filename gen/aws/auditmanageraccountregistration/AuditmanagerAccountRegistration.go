...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/auditmanageraccountregistration/internal"
...
type jsiiProxy_AuditmanagerAccountRegistration struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_AuditmanagerAccountRegistration) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_AuditmanagerAccountRegistration) DelegatedAdminAccount() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AuditmanagerAccountRegistration) DelegatedAdminAccountInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"delegatedAdminAccountInput",
		&returns,
	)
	return returns
}

func (j *jsiiProxy_AuditmanagerAccountRegistration) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_AuditmanagerAccountRegistration) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_AuditmanagerAccountRegistration) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_AuditmanagerAccountRegistration) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_AuditmanagerAccountRegistration) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_AuditmanagerAccountRegistration) KmsKey() *string {
	var returns *string
	_jsii_.Get(
		j,
		"kmsKey",
...
func (j *jsiiProxy_AuditmanagerAccountRegistration) KmsKeyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"kmsKeyInput",
...
func (j *jsiiProxy_AuditmanagerAccountRegistration) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_AuditmanagerAccountRegistration) Node() constructs.Node {
...
func (j *jsiiProxy_AuditmanagerAccountRegistration) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_AuditmanagerAccountRegistration) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_AuditmanagerAccountRegistration) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/auditmanager_account_registration aws_auditmanager_account_registration} Resource.
func NewAuditmanagerAccountRegistration(scope constructs.Construct, id *string, config *AuditmanagerAccountRegistrationConfig) AuditmanagerAccountRegistration {
	...
	if err := validateNewAuditmanagerAccountRegistrationParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func AuditmanagerAccountRegistration_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateAuditmanagerAccountRegistration_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func AuditmanagerAccountRegistration_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws.auditmanagerAccountRegistration.AuditmanagerAccountRegistration",
...
func (a *jsiiProxy_AuditmanagerAccountRegistration) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_AuditmanagerAccountRegistration) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AuditmanagerAccountRegistration) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (a *jsiiProxy_AuditmanagerAccountRegistration) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (a *jsiiProxy_AuditmanagerAccountRegistration) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (a *jsiiProxy_AuditmanagerAccountRegistration) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (a *jsiiProxy_AuditmanagerAccountRegistration) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (a *jsiiProxy_AuditmanagerAccountRegistration) GetStringAttribute(terraformAttribute *string) *string {
...
func (a *jsiiProxy_AuditmanagerAccountRegistration) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (a *jsiiProxy_AuditmanagerAccountRegistration) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AuditmanagerAccountRegistration) OverrideLogicalId(newLogicalId *string) {
...
func (a *jsiiProxy_AuditmanagerAccountRegistration) ResetDelegatedAdminAccount() {
	_jsii_.InvokeVoid(
		a,
		"resetDelegatedAdminAccount",
		nil, // no parameters
...
func (a *jsiiProxy_AuditmanagerAccountRegistration) ResetDeregisterOnDestroy() {
	_jsii_.InvokeVoid(
		a,
		"resetDeregisterOnDestroy",
		nil, // no parameters
...
func (a *jsiiProxy_AuditmanagerAccountRegistration) ResetKmsKey() {
	_jsii_.InvokeVoid(
		a,
		"resetKmsKey",
		nil, // no parameters
...
func (a *jsiiProxy_AuditmanagerAccountRegistration) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		a,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (a *jsiiProxy_AuditmanagerAccountRegistration) ToString() *string {
	var returns *string
