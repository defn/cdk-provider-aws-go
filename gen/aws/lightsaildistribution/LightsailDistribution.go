...
type LightsailDistribution interface {
	...
	CacheBehavior() LightsailDistributionCacheBehaviorList
	CacheBehaviorInput() interface{}
	CacheBehaviorSettings() LightsailDistributionCacheBehaviorSettingsOutputReference
	CacheBehaviorSettingsInput() *LightsailDistributionCacheBehaviorSettings
	// Experimental.
	...
	OriginInput() *LightsailDistributionOrigin
	...
	PutTimeouts(value *LightsailDistributionTimeouts)
	ResetCacheBehavior()
...
func (j *jsiiProxy_LightsailDistribution) AlternativeDomainNames() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_LightsailDistribution) Arn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"arn",
...
func (j *jsiiProxy_LightsailDistribution) CacheBehavior() LightsailDistributionCacheBehaviorList {
	var returns LightsailDistributionCacheBehaviorList
	_jsii_.Get(
		j,
		"cacheBehavior",
		&returns,
...
func (j *jsiiProxy_LightsailDistribution) CacheBehaviorInput() interface{} {
...
func (j *jsiiProxy_LightsailDistribution) CacheBehaviorSettingsInput() *LightsailDistributionCacheBehaviorSettings {
...
func (j *jsiiProxy_LightsailDistribution) CreatedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"createdAt",
...
func (j *jsiiProxy_LightsailDistribution) DefaultCacheBehaviorInput() *LightsailDistributionDefaultCacheBehavior {
...
func (j *jsiiProxy_LightsailDistribution) DomainName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"domainName",
...
func (j *jsiiProxy_LightsailDistribution) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_LightsailDistribution) Location() LightsailDistributionLocationList {
	var returns LightsailDistributionLocationList
	_jsii_.Get(
		j,
		"location",
		&returns,
...
func (j *jsiiProxy_LightsailDistribution) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_LightsailDistribution) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_LightsailDistribution) OriginInput() *LightsailDistributionOrigin {
...
func (j *jsiiProxy_LightsailDistribution) OriginPublicDns() *string {
	var returns *string
	_jsii_.Get(
		j,
		"originPublicDns",
...
func (j *jsiiProxy_LightsailDistribution) ResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"resourceType",
...
func (j *jsiiProxy_LightsailDistribution) SupportCode() *string {
	var returns *string
	_jsii_.Get(
		j,
		"supportCode",
...
func (j *jsiiProxy_LightsailDistribution) Tags() *map[string]*string {
...
func (j *jsiiProxy_LightsailDistribution) TagsAll() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAll",
...
func (j *jsiiProxy_LightsailDistribution) TagsAllInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAllInput",
...
func (j *jsiiProxy_LightsailDistribution) TagsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsInput",
...
func (j *jsiiProxy_LightsailDistribution) Timeouts() LightsailDistributionTimeoutsOutputReference {
	var returns LightsailDistributionTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func (j *jsiiProxy_LightsailDistribution) TimeoutsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"timeoutsInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/lightsail_distribution aws_lightsail_distribution} Resource.
func NewLightsailDistribution(scope constructs.Construct, id *string, config *LightsailDistributionConfig) LightsailDistribution {
	...
	_jsii_.Create(
		"aws.lightsailDistribution.LightsailDistribution",
...
func (j *jsiiProxy_LightsailDistribution)SetId(val *string) {
...
func (j *jsiiProxy_LightsailDistribution)SetName(val *string) {
...
func (j *jsiiProxy_LightsailDistribution)SetTags(val *map[string]*string) {
...
func (j *jsiiProxy_LightsailDistribution)SetTagsAll(val *map[string]*string) {
...
func (l *jsiiProxy_LightsailDistribution) PutCacheBehavior(value interface{}) {
	if err := l.validatePutCacheBehaviorParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		l,
...
func (l *jsiiProxy_LightsailDistribution) PutTimeouts(value *LightsailDistributionTimeouts) {
...
func (l *jsiiProxy_LightsailDistribution) ResetCacheBehavior() {
	_jsii_.InvokeVoid(
		l,
		"resetCacheBehavior",
		nil, // no parameters
...
func (l *jsiiProxy_LightsailDistribution) ResetId() {
	_jsii_.InvokeVoid(
		l,
		"resetId",
		nil, // no parameters
...
func (l *jsiiProxy_LightsailDistribution) ResetTagsAll() {
	_jsii_.InvokeVoid(
		l,
		"resetTagsAll",
		nil, // no parameters
...
func (l *jsiiProxy_LightsailDistribution) ResetTimeouts() {
	_jsii_.InvokeVoid(
		l,
		"resetTimeouts",
		nil, // no parameters
