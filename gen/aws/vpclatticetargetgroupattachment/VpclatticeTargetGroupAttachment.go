...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/vpclattice_target_group_attachment aws_vpclattice_target_group_attachment} Resource.
func NewVpclatticeTargetGroupAttachment(scope constructs.Construct, id *string, config *VpclatticeTargetGroupAttachmentConfig) VpclatticeTargetGroupAttachment {
	...
	_jsii_.Create(
		"aws.vpclatticeTargetGroupAttachment.VpclatticeTargetGroupAttachment",
...
func VpclatticeTargetGroupAttachment_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateVpclatticeTargetGroupAttachment_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (v *jsiiProxy_VpclatticeTargetGroupAttachment) AddMoveTarget(moveTarget *string) {
...
func (v *jsiiProxy_VpclatticeTargetGroupAttachment) HasResourceMove() interface{} {
	var returns interface{}
...
func (v *jsiiProxy_VpclatticeTargetGroupAttachment) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (v *jsiiProxy_VpclatticeTargetGroupAttachment) MoveFromId(id *string) {
...
func (v *jsiiProxy_VpclatticeTargetGroupAttachment) MoveTo(moveTarget *string, index interface{}) {
...
func (v *jsiiProxy_VpclatticeTargetGroupAttachment) MoveToId(id *string) {
...
func (v *jsiiProxy_VpclatticeTargetGroupAttachment) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (v *jsiiProxy_VpclatticeTargetGroupAttachment) ToHclTerraform() interface{} {
	var returns interface{}
