...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/iotcertificate/internal"
...
func (j *jsiiProxy_IotCertificate) CaCertificateId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"caCertificateId",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/iot_certificate aws_iot_certificate} Resource.
...
func IotCertificate_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateIotCertificate_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (i *jsiiProxy_IotCertificate) AddMoveTarget(moveTarget *string) {
