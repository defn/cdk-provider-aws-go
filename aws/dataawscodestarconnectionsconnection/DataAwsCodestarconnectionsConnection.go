...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/dataawscodestarconnectionsconnection/internal"
...
func DataAwsCodestarconnectionsConnection_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsCodestarconnectionsConnection_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
