...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/dataawsbatchcomputeenvironment/internal"
...
type DataAwsBatchComputeEnvironment interface {
	...
	Type() *string
	UpdatePolicy() DataAwsBatchComputeEnvironmentUpdatePolicyList
	// Experimental.
...
func (j *jsiiProxy_DataAwsBatchComputeEnvironment) UpdatePolicy() DataAwsBatchComputeEnvironmentUpdatePolicyList {
	var returns DataAwsBatchComputeEnvironmentUpdatePolicyList
	_jsii_.Get(
		j,
		"updatePolicy",
		&returns,
...
func DataAwsBatchComputeEnvironment_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsBatchComputeEnvironment_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
