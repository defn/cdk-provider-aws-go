...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/s3controlobjectlambdaaccesspointpolicy/internal"
...
func S3ControlObjectLambdaAccessPointPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateS3ControlObjectLambdaAccessPointPolicy_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
// Experimental.
func S3ControlObjectLambdaAccessPointPolicy_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateS3ControlObjectLambdaAccessPointPolicy_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func S3ControlObjectLambdaAccessPointPolicy_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateS3ControlObjectLambdaAccessPointPolicy_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (s *jsiiProxy_S3ControlObjectLambdaAccessPointPolicy) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_S3ControlObjectLambdaAccessPointPolicy) HasResourceMove() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_S3ControlObjectLambdaAccessPointPolicy) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (s *jsiiProxy_S3ControlObjectLambdaAccessPointPolicy) MoveFromId(id *string) {
...
func (s *jsiiProxy_S3ControlObjectLambdaAccessPointPolicy) MoveTo(moveTarget *string, index interface{}) {
...
func (s *jsiiProxy_S3ControlObjectLambdaAccessPointPolicy) MoveToId(id *string) {
...
func (s *jsiiProxy_S3ControlObjectLambdaAccessPointPolicy) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (s *jsiiProxy_S3ControlObjectLambdaAccessPointPolicy) ToHclTerraform() interface{} {
	var returns interface{}
