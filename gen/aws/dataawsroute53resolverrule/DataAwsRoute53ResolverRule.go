...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/dataawsroute53resolverrule/internal"
...
func (j *jsiiProxy_DataAwsRoute53ResolverRule) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsRoute53ResolverRule) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/data-sources/route53_resolver_rule aws_route53_resolver_rule} Data Source.
func NewDataAwsRoute53ResolverRule(scope constructs.Construct, id *string, config *DataAwsRoute53ResolverRuleConfig) DataAwsRoute53ResolverRule {
	...
	if err := validateNewDataAwsRoute53ResolverRuleParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataAwsRoute53ResolverRule_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsRoute53ResolverRule_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsRoute53ResolverRule) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
