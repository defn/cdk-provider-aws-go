...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/ecsservice/internal"
...
func (j *jsiiProxy_EcsServiceServiceConnectConfigurationOutputReference) Service() EcsServiceServiceConnectConfigurationServiceList {
	var returns EcsServiceServiceConnectConfigurationServiceList
	_jsii_.Get(
		j,
		"service",
		&returns,
...
func (j *jsiiProxy_EcsServiceServiceConnectConfigurationOutputReference) ServiceInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"serviceInput",
...
func (e *jsiiProxy_EcsServiceServiceConnectConfigurationOutputReference) PutService(value interface{}) {
