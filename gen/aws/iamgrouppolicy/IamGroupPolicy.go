...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/iamgrouppolicy/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/iam_group_policy aws_iam_group_policy} Resource.
...
func IamGroupPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateIamGroupPolicy_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
// Experimental.
func IamGroupPolicy_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateIamGroupPolicy_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func IamGroupPolicy_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateIamGroupPolicy_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (i *jsiiProxy_IamGroupPolicy) AddMoveTarget(moveTarget *string) {
