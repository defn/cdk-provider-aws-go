...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/ssmmaintenancewindowtask/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/ssm_maintenance_window_task aws_ssm_maintenance_window_task} Resource.
...
func SsmMaintenanceWindowTask_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateSsmMaintenanceWindowTask_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_SsmMaintenanceWindowTask) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_SsmMaintenanceWindowTask) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (s *jsiiProxy_SsmMaintenanceWindowTask) MoveFromId(id *string) {
...
func (s *jsiiProxy_SsmMaintenanceWindowTask) MoveToId(id *string) {
