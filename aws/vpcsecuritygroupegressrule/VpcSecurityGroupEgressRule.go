...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/vpcsecuritygroupegressrule/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/vpc_security_group_egress_rule aws_vpc_security_group_egress_rule} Resource.
func NewVpcSecurityGroupEgressRule(scope constructs.Construct, id *string, config *VpcSecurityGroupEgressRuleConfig) VpcSecurityGroupEgressRule {
	...
	_jsii_.Create(
		"aws.vpcSecurityGroupEgressRule.VpcSecurityGroupEgressRule",
...
func (v *jsiiProxy_VpcSecurityGroupEgressRule) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (v *jsiiProxy_VpcSecurityGroupEgressRule) ToHclTerraform() interface{} {
	var returns interface{}
