...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/worklinkwebsitecertificateauthorityassociation/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/worklink_website_certificate_authority_association aws_worklink_website_certificate_authority_association} Resource.
func NewWorklinkWebsiteCertificateAuthorityAssociation(scope constructs.Construct, id *string, config *WorklinkWebsiteCertificateAuthorityAssociationConfig) WorklinkWebsiteCertificateAuthorityAssociation {
	...
	if err := validateNewWorklinkWebsiteCertificateAuthorityAssociationParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_WorklinkWebsiteCertificateAuthorityAssociation{}

	_jsii_.Create(
		"aws.worklinkWebsiteCertificateAuthorityAssociation.WorklinkWebsiteCertificateAuthorityAssociation",
...
func WorklinkWebsiteCertificateAuthorityAssociation_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateWorklinkWebsiteCertificateAuthorityAssociation_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (w *jsiiProxy_WorklinkWebsiteCertificateAuthorityAssociation) AddMoveTarget(moveTarget *string) {
...
func (w *jsiiProxy_WorklinkWebsiteCertificateAuthorityAssociation) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (w *jsiiProxy_WorklinkWebsiteCertificateAuthorityAssociation) MoveFromId(id *string) {
...
func (w *jsiiProxy_WorklinkWebsiteCertificateAuthorityAssociation) MoveToId(id *string) {
