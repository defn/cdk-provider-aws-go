...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/cloudwatcheventpermission/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/cloudwatch_event_permission aws_cloudwatch_event_permission}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/cloudwatch_event_permission aws_cloudwatch_event_permission} Resource.
...
func CloudwatchEventPermission_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateCloudwatchEventPermission_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_CloudwatchEventPermission) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_CloudwatchEventPermission) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (c *jsiiProxy_CloudwatchEventPermission) MoveFromId(id *string) {
...
func (c *jsiiProxy_CloudwatchEventPermission) MoveToId(id *string) {
