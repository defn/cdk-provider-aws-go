...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/dataawsssmpatchbaseline/internal"
...
func NewDataAwsSsmPatchBaselineGlobalFilterList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsSsmPatchBaselineGlobalFilterList {
	...
	if err := validateNewDataAwsSsmPatchBaselineGlobalFilterListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsSsmPatchBaselineGlobalFilterList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
