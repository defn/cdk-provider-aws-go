...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/rdsclusterendpoint/internal"
...
func RdsClusterEndpoint_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateRdsClusterEndpoint_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (r *jsiiProxy_RdsClusterEndpoint) AddMoveTarget(moveTarget *string) {
...
func (r *jsiiProxy_RdsClusterEndpoint) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (r *jsiiProxy_RdsClusterEndpoint) MoveFromId(id *string) {
...
func (r *jsiiProxy_RdsClusterEndpoint) MoveToId(id *string) {
