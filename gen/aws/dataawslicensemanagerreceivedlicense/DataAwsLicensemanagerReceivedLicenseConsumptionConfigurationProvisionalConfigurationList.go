...
func (j *jsiiProxy_DataAwsLicensemanagerReceivedLicenseConsumptionConfigurationProvisionalConfigurationList) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_DataAwsLicensemanagerReceivedLicenseConsumptionConfigurationProvisionalConfigurationList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsLicensemanagerReceivedLicenseConsumptionConfigurationProvisionalConfigurationList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsLicensemanagerReceivedLicenseConsumptionConfigurationProvisionalConfigurationList) Resolve(_context cdktf.IResolveContext) interface{} {
