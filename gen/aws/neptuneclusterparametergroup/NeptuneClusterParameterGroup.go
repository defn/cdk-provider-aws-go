...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/neptuneclusterparametergroup/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/neptune_cluster_parameter_group aws_neptune_cluster_parameter_group}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/neptune_cluster_parameter_group aws_neptune_cluster_parameter_group} Resource.
...
func (n *jsiiProxy_NeptuneClusterParameterGroup) AddMoveTarget(moveTarget *string) {
...
func (n *jsiiProxy_NeptuneClusterParameterGroup) MoveFromId(id *string) {
...
func (n *jsiiProxy_NeptuneClusterParameterGroup) MoveToId(id *string) {
