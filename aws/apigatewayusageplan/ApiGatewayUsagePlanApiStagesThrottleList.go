...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/apigatewayusageplan/internal"
...
func (a *jsiiProxy_ApiGatewayUsagePlanApiStagesThrottleList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
