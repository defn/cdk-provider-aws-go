...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/networkmanagercorenetworkpolicyattachment/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/networkmanager_core_network_policy_attachment aws_networkmanager_core_network_policy_attachment} Resource.
...
func NetworkmanagerCoreNetworkPolicyAttachment_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateNetworkmanagerCoreNetworkPolicyAttachment_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (n *jsiiProxy_NetworkmanagerCoreNetworkPolicyAttachment) AddMoveTarget(moveTarget *string) {
...
func (n *jsiiProxy_NetworkmanagerCoreNetworkPolicyAttachment) HasResourceMove() interface{} {
	var returns interface{}
...
func (n *jsiiProxy_NetworkmanagerCoreNetworkPolicyAttachment) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (n *jsiiProxy_NetworkmanagerCoreNetworkPolicyAttachment) MoveFromId(id *string) {
...
func (n *jsiiProxy_NetworkmanagerCoreNetworkPolicyAttachment) MoveTo(moveTarget *string, index interface{}) {
...
func (n *jsiiProxy_NetworkmanagerCoreNetworkPolicyAttachment) MoveToId(id *string) {
...
func (n *jsiiProxy_NetworkmanagerCoreNetworkPolicyAttachment) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (n *jsiiProxy_NetworkmanagerCoreNetworkPolicyAttachment) ToHclTerraform() interface{} {
	var returns interface{}
