...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/wafregionalwebaclassociation/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/wafregional_web_acl_association aws_wafregional_web_acl_association}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/wafregional_web_acl_association aws_wafregional_web_acl_association} Resource.
...
func WafregionalWebAclAssociation_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateWafregionalWebAclAssociation_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (w *jsiiProxy_WafregionalWebAclAssociation) AddMoveTarget(moveTarget *string) {
...
func (w *jsiiProxy_WafregionalWebAclAssociation) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (w *jsiiProxy_WafregionalWebAclAssociation) MoveFromId(id *string) {
...
func (w *jsiiProxy_WafregionalWebAclAssociation) MoveToId(id *string) {
