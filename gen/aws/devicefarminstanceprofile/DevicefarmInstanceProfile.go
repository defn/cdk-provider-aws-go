...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/devicefarminstanceprofile/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/devicefarm_instance_profile aws_devicefarm_instance_profile}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/devicefarm_instance_profile aws_devicefarm_instance_profile} Resource.
func NewDevicefarmInstanceProfile(scope constructs.Construct, id *string, config *DevicefarmInstanceProfileConfig) DevicefarmInstanceProfile {
	...
	if err := validateNewDevicefarmInstanceProfileParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DevicefarmInstanceProfile_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDevicefarmInstanceProfile_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DevicefarmInstanceProfile) AddMoveTarget(moveTarget *string) {
