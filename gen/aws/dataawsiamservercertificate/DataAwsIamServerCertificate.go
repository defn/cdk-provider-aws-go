...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/dataawsiamservercertificate/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/data-sources/iam_server_certificate aws_iam_server_certificate} Data Source.
...
func DataAwsIamServerCertificate_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsIamServerCertificate_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
// Experimental.
func DataAwsIamServerCertificate_IsTerraformDataSource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsIamServerCertificate_IsTerraformDataSourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAwsIamServerCertificate_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsIamServerCertificate_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataAwsIamServerCertificate) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataAwsIamServerCertificate) ToHclTerraform() interface{} {
	var returns interface{}
