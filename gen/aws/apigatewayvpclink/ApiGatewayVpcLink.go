...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/apigatewayvpclink/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/api_gateway_vpc_link aws_api_gateway_vpc_link}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/api_gateway_vpc_link aws_api_gateway_vpc_link} Resource.
func NewApiGatewayVpcLink(scope constructs.Construct, id *string, config *ApiGatewayVpcLinkConfig) ApiGatewayVpcLink {
	_init_.Initialize()

	if err := validateNewApiGatewayVpcLinkParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func ApiGatewayVpcLink_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateApiGatewayVpcLink_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func ApiGatewayVpcLink_IsConstruct(x interface{}) *bool {
	...
	if err := validateApiGatewayVpcLink_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func ApiGatewayVpcLink_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateApiGatewayVpcLink_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func ApiGatewayVpcLink_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateApiGatewayVpcLink_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (a *jsiiProxy_ApiGatewayVpcLink) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_ApiGatewayVpcLink) HasResourceMove() interface{} {
	var returns interface{}
...
func (a *jsiiProxy_ApiGatewayVpcLink) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (a *jsiiProxy_ApiGatewayVpcLink) MoveFromId(id *string) {
...
func (a *jsiiProxy_ApiGatewayVpcLink) MoveTo(moveTarget *string, index interface{}) {
...
func (a *jsiiProxy_ApiGatewayVpcLink) MoveToId(id *string) {
...
func (a *jsiiProxy_ApiGatewayVpcLink) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (a *jsiiProxy_ApiGatewayVpcLink) ToHclTerraform() interface{} {
	var returns interface{}
