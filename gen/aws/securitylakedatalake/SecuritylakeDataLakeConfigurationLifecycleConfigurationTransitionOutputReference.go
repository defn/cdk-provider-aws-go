...
func (s *jsiiProxy_SecuritylakeDataLakeConfigurationLifecycleConfigurationTransitionOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SecuritylakeDataLakeConfigurationLifecycleConfigurationTransitionOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
