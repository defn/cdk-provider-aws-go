...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/finspacekxenvironment/internal"
...
func (f *jsiiProxy_FinspaceKxEnvironmentTransitGatewayConfigurationAttachmentNetworkAclConfigurationPortRangeOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (f *jsiiProxy_FinspaceKxEnvironmentTransitGatewayConfigurationAttachmentNetworkAclConfigurationPortRangeOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
