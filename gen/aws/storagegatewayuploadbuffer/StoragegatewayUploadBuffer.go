...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/storagegatewayuploadbuffer/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/storagegateway_upload_buffer aws_storagegateway_upload_buffer} Resource.
...
func StoragegatewayUploadBuffer_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateStoragegatewayUploadBuffer_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
// Experimental.
func StoragegatewayUploadBuffer_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateStoragegatewayUploadBuffer_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func StoragegatewayUploadBuffer_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateStoragegatewayUploadBuffer_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (s *jsiiProxy_StoragegatewayUploadBuffer) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_StoragegatewayUploadBuffer) HasResourceMove() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_StoragegatewayUploadBuffer) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (s *jsiiProxy_StoragegatewayUploadBuffer) MoveFromId(id *string) {
...
func (s *jsiiProxy_StoragegatewayUploadBuffer) MoveTo(moveTarget *string, index interface{}) {
...
func (s *jsiiProxy_StoragegatewayUploadBuffer) MoveToId(id *string) {
...
func (s *jsiiProxy_StoragegatewayUploadBuffer) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (s *jsiiProxy_StoragegatewayUploadBuffer) ToHclTerraform() interface{} {
	var returns interface{}
