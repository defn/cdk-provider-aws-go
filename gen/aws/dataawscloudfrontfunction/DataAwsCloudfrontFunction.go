...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/dataawscloudfrontfunction/internal"
...
func NewDataAwsCloudfrontFunction(scope constructs.Construct, id *string, config *DataAwsCloudfrontFunctionConfig) DataAwsCloudfrontFunction {
	...
	_jsii_.Create(
		"aws.dataAwsCloudfrontFunction.DataAwsCloudfrontFunction",
...
func DataAwsCloudfrontFunction_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsCloudfrontFunction_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
