...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/servicediscoveryinstance/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/service_discovery_instance aws_service_discovery_instance}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/service_discovery_instance aws_service_discovery_instance} Resource.
...
func ServiceDiscoveryInstance_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateServiceDiscoveryInstance_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
// Experimental.
func ServiceDiscoveryInstance_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateServiceDiscoveryInstance_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func ServiceDiscoveryInstance_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateServiceDiscoveryInstance_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (s *jsiiProxy_ServiceDiscoveryInstance) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_ServiceDiscoveryInstance) HasResourceMove() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_ServiceDiscoveryInstance) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (s *jsiiProxy_ServiceDiscoveryInstance) MoveFromId(id *string) {
...
func (s *jsiiProxy_ServiceDiscoveryInstance) MoveTo(moveTarget *string, index interface{}) {
...
func (s *jsiiProxy_ServiceDiscoveryInstance) MoveToId(id *string) {
...
func (s *jsiiProxy_ServiceDiscoveryInstance) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (s *jsiiProxy_ServiceDiscoveryInstance) ToHclTerraform() interface{} {
	var returns interface{}
