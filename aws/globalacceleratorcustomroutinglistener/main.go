...
func init() {
	...
	_jsii_.RegisterStruct(
		"aws.globalacceleratorCustomRoutingListener.GlobalacceleratorCustomRoutingListenerConfig",
		reflect.TypeOf((*GlobalacceleratorCustomRoutingListenerConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws.globalacceleratorCustomRoutingListener.GlobalacceleratorCustomRoutingListenerPortRange",
		reflect.TypeOf((*GlobalacceleratorCustomRoutingListenerPortRange)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"aws.globalacceleratorCustomRoutingListener.GlobalacceleratorCustomRoutingListenerPortRangeList",
