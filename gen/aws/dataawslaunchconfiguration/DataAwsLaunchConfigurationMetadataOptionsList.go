...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/dataawslaunchconfiguration/internal"
...
func NewDataAwsLaunchConfigurationMetadataOptionsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsLaunchConfigurationMetadataOptionsList {
	...
	if err := validateNewDataAwsLaunchConfigurationMetadataOptionsListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsLaunchConfigurationMetadataOptionsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
