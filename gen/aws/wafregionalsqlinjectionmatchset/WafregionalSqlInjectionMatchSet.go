...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/wafregionalsqlinjectionmatchset/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/wafregional_sql_injection_match_set aws_wafregional_sql_injection_match_set} Resource.
func NewWafregionalSqlInjectionMatchSet(scope constructs.Construct, id *string, config *WafregionalSqlInjectionMatchSetConfig) WafregionalSqlInjectionMatchSet {
	...
	if err := validateNewWafregionalSqlInjectionMatchSetParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func WafregionalSqlInjectionMatchSet_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateWafregionalSqlInjectionMatchSet_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func WafregionalSqlInjectionMatchSet_IsConstruct(x interface{}) *bool {
	...
	if err := validateWafregionalSqlInjectionMatchSet_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func WafregionalSqlInjectionMatchSet_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateWafregionalSqlInjectionMatchSet_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func WafregionalSqlInjectionMatchSet_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateWafregionalSqlInjectionMatchSet_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (w *jsiiProxy_WafregionalSqlInjectionMatchSet) AddMoveTarget(moveTarget *string) {
...
func (w *jsiiProxy_WafregionalSqlInjectionMatchSet) HasResourceMove() interface{} {
	var returns interface{}
...
func (w *jsiiProxy_WafregionalSqlInjectionMatchSet) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (w *jsiiProxy_WafregionalSqlInjectionMatchSet) MoveFromId(id *string) {
...
func (w *jsiiProxy_WafregionalSqlInjectionMatchSet) MoveTo(moveTarget *string, index interface{}) {
...
func (w *jsiiProxy_WafregionalSqlInjectionMatchSet) MoveToId(id *string) {
...
func (w *jsiiProxy_WafregionalSqlInjectionMatchSet) PutSqlInjectionMatchTuple(value interface{}) {
	if err := w.validatePutSqlInjectionMatchTupleParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		w,
...
func (w *jsiiProxy_WafregionalSqlInjectionMatchSet) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (w *jsiiProxy_WafregionalSqlInjectionMatchSet) ToHclTerraform() interface{} {
	var returns interface{}
