...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/macie2member/internal"
...
func NewMacie2MemberTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) Macie2MemberTimeoutsOutputReference {
	...
	if err := validateNewMacie2MemberTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
