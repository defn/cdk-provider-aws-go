...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/apigatewayusageplankey/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/api_gateway_usage_plan_key aws_api_gateway_usage_plan_key}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/api_gateway_usage_plan_key aws_api_gateway_usage_plan_key} Resource.
...
func ApiGatewayUsagePlanKey_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateApiGatewayUsagePlanKey_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_ApiGatewayUsagePlanKey) AddMoveTarget(moveTarget *string) {
