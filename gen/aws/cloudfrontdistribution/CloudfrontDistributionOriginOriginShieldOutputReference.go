...
func (j *jsiiProxy_CloudfrontDistributionOriginOriginShieldOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CloudfrontDistributionOriginOriginShieldOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CloudfrontDistributionOriginOriginShieldOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_CloudfrontDistributionOriginOriginShieldOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_CloudfrontDistributionOriginOriginShieldOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (j *jsiiProxy_CloudfrontDistributionOriginOriginShieldOutputReference)SetOriginShieldRegion(val *string) {
	if err := j.validateSetOriginShieldRegionParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (c *jsiiProxy_CloudfrontDistributionOriginOriginShieldOutputReference) ComputeFqn() *string {
	var returns *string
...
func (c *jsiiProxy_CloudfrontDistributionOriginOriginShieldOutputReference) ToString() *string {
	var returns *string
