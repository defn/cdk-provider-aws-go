...
func NewLbListenerMutualAuthenticationOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) LbListenerMutualAuthenticationOutputReference {
	...
	_jsii_.Create(
		"aws.lbListener.LbListenerMutualAuthenticationOutputReference",
...
func (l *jsiiProxy_LbListenerMutualAuthenticationOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LbListenerMutualAuthenticationOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
