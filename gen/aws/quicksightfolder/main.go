...
func init() {
	...
	_jsii_.RegisterStruct(
		"aws.quicksightFolder.QuicksightFolderPermissions",
		reflect.TypeOf((*QuicksightFolderPermissions)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"aws.quicksightFolder.QuicksightFolderPermissionsList",
	...
	_jsii_.RegisterClass(
		"aws.quicksightFolder.QuicksightFolderPermissionsOutputReference",
	...
	_jsii_.RegisterStruct(
		"aws.quicksightFolder.QuicksightFolderTimeouts",
