...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/codecommit_trigger aws_codecommit_trigger}.
...
func (j *jsiiProxy_CodecommitTrigger) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_CodecommitTrigger) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_CodecommitTrigger) Trigger() CodecommitTriggerTriggerList {
	var returns CodecommitTriggerTriggerList
	_jsii_.Get(
		j,
		"trigger",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/codecommit_trigger aws_codecommit_trigger} Resource.
func NewCodecommitTrigger(scope constructs.Construct, id *string, config *CodecommitTriggerConfig) CodecommitTrigger {
	_init_.Initialize()

	if err := validateNewCodecommitTriggerParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func CodecommitTrigger_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateCodecommitTrigger_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_CodecommitTrigger) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_CodecommitTrigger) ResetId() {
	_jsii_.InvokeVoid(
		c,
		"resetId",
		nil, // no parameters
