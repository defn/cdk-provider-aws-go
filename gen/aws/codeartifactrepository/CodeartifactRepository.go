...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/codeartifactrepository/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/codeartifact_repository aws_codeartifact_repository} Resource.
...
func (c *jsiiProxy_CodeartifactRepository) MoveFromId(id *string) {
...
func (c *jsiiProxy_CodeartifactRepository) MoveToId(id *string) {
