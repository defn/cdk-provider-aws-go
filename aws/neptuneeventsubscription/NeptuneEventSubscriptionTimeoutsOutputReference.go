...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/neptuneeventsubscription/internal"
...
func NewNeptuneEventSubscriptionTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) NeptuneEventSubscriptionTimeoutsOutputReference {
	...
	if err := validateNewNeptuneEventSubscriptionTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
