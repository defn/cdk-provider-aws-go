...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "appMonitorName", GoGetter: "AppMonitorName"},
			_jsii_.MemberProperty{JsiiProperty: "appMonitorNameInput", GoGetter: "AppMonitorNameInput"},
