...
func (a *jsiiProxy_AmplifyDomainAssociation) validatePutSubDomainParameters(value interface{}) error {
	...
	case *[]*AmplifyDomainAssociationSubDomain:
		value := value.(*[]*AmplifyDomainAssociationSubDomain)
	...
	case []*AmplifyDomainAssociationSubDomain:
		value_ := value.([]*AmplifyDomainAssociationSubDomain)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*AmplifyDomainAssociationSubDomain; received %#v (a %T)", value, value)
		}
	}
