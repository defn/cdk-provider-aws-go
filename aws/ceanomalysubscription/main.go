...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetThresholdExpression", GoMethod: "ResetThresholdExpression"},
			...
			_jsii_.MemberProperty{JsiiProperty: "thresholdExpressionInput", GoGetter: "ThresholdExpressionInput"},
