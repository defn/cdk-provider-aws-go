...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/iamusersshkey/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/iam_user_ssh_key aws_iam_user_ssh_key} Resource.
...
func IamUserSshKey_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateIamUserSshKey_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (i *jsiiProxy_IamUserSshKey) AddMoveTarget(moveTarget *string) {
