...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/cloudfrontkeygroup/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/cloudfront_key_group aws_cloudfront_key_group}.
...
func (j *jsiiProxy_CloudfrontKeyGroup) Connection() interface{} {
...
func (j *jsiiProxy_CloudfrontKeyGroup) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_CloudfrontKeyGroup) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_CloudfrontKeyGroup) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/cloudfront_key_group aws_cloudfront_key_group} Resource.
func NewCloudfrontKeyGroup(scope constructs.Construct, id *string, config *CloudfrontKeyGroupConfig) CloudfrontKeyGroup {
	_init_.Initialize()

	if err := validateNewCloudfrontKeyGroupParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CloudfrontKeyGroup)SetConnection(val interface{}) {
...
func (j *jsiiProxy_CloudfrontKeyGroup)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_CloudfrontKeyGroup)SetId(val *string) {
...
func (j *jsiiProxy_CloudfrontKeyGroup)SetProvisioners(val *[]interface{}) {
...
func CloudfrontKeyGroup_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateCloudfrontKeyGroup_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func CloudfrontKeyGroup_IsConstruct(x interface{}) *bool {
	...
	if err := validateCloudfrontKeyGroup_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func CloudfrontKeyGroup_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCloudfrontKeyGroup_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func CloudfrontKeyGroup_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCloudfrontKeyGroup_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CloudfrontKeyGroup) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_CloudfrontKeyGroup) HasResourceMove() interface{} {
	var returns interface{}
...
func (c *jsiiProxy_CloudfrontKeyGroup) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (c *jsiiProxy_CloudfrontKeyGroup) MoveFromId(id *string) {
...
func (c *jsiiProxy_CloudfrontKeyGroup) MoveTo(moveTarget *string, index interface{}) {
...
func (c *jsiiProxy_CloudfrontKeyGroup) MoveToId(id *string) {
...
func (c *jsiiProxy_CloudfrontKeyGroup) ResetId() {
	_jsii_.InvokeVoid(
		c,
		"resetId",
		nil, // no parameters
...
func (c *jsiiProxy_CloudfrontKeyGroup) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (c *jsiiProxy_CloudfrontKeyGroup) ToHclTerraform() interface{} {
	var returns interface{}
