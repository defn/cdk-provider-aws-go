...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/dxtransitvirtualinterface/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/dx_transit_virtual_interface aws_dx_transit_virtual_interface} Resource.
...
func (d *jsiiProxy_DxTransitVirtualInterface) MoveFromId(id *string) {
...
func (d *jsiiProxy_DxTransitVirtualInterface) MoveToId(id *string) {
