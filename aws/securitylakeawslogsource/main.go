...
func init() {
	_jsii_.RegisterClass(
		"aws.securitylakeAwsLogSource.SecuritylakeAwsLogSource",
	...
	_jsii_.RegisterStruct(
		"aws.securitylakeAwsLogSource.SecuritylakeAwsLogSourceConfig",
		reflect.TypeOf((*SecuritylakeAwsLogSourceConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws.securitylakeAwsLogSource.SecuritylakeAwsLogSourceSource",
