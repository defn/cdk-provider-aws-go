...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/cloudtrail/internal"
...
func NewCloudtrailEventSelectorDataResourceList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CloudtrailEventSelectorDataResourceList {
	...
	if err := validateNewCloudtrailEventSelectorDataResourceListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_CloudtrailEventSelectorDataResourceList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
