...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/iamservicelinkedrole/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/iam_service_linked_role aws_iam_service_linked_role}.
...
func (j *jsiiProxy_IamServiceLinkedRole) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_IamServiceLinkedRole) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/iam_service_linked_role aws_iam_service_linked_role} Resource.
func NewIamServiceLinkedRole(scope constructs.Construct, id *string, config *IamServiceLinkedRoleConfig) IamServiceLinkedRole {
	_init_.Initialize()

	if err := validateNewIamServiceLinkedRoleParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func IamServiceLinkedRole_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateIamServiceLinkedRole_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (i *jsiiProxy_IamServiceLinkedRole) AddMoveTarget(moveTarget *string) {
...
func (i *jsiiProxy_IamServiceLinkedRole) ResetId() {
	_jsii_.InvokeVoid(
		i,
		"resetId",
		nil, // no parameters
