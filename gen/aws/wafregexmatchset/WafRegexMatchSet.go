...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/wafregexmatchset/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/waf_regex_match_set aws_waf_regex_match_set}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/waf_regex_match_set aws_waf_regex_match_set} Resource.
...
func WafRegexMatchSet_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateWafRegexMatchSet_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (w *jsiiProxy_WafRegexMatchSet) AddMoveTarget(moveTarget *string) {
...
func (w *jsiiProxy_WafRegexMatchSet) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (w *jsiiProxy_WafRegexMatchSet) MoveFromId(id *string) {
...
func (w *jsiiProxy_WafRegexMatchSet) MoveToId(id *string) {
