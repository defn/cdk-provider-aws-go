...
func init() {
	...
	_jsii_.RegisterStruct(
		"aws.sagemakerEndpoint.SagemakerEndpointDeploymentConfigRollingUpdatePolicy",
		reflect.TypeOf((*SagemakerEndpointDeploymentConfigRollingUpdatePolicy)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws.sagemakerEndpoint.SagemakerEndpointDeploymentConfigRollingUpdatePolicyMaximumBatchSize",
	...
	_jsii_.RegisterStruct(
		"aws.sagemakerEndpoint.SagemakerEndpointDeploymentConfigRollingUpdatePolicyRollbackMaximumBatchSize",
