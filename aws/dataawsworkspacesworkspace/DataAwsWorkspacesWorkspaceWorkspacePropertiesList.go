...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/dataawsworkspacesworkspace/internal"
...
func NewDataAwsWorkspacesWorkspaceWorkspacePropertiesList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsWorkspacesWorkspaceWorkspacePropertiesList {
	...
	if err := validateNewDataAwsWorkspacesWorkspaceWorkspacePropertiesListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsWorkspacesWorkspaceWorkspacePropertiesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
