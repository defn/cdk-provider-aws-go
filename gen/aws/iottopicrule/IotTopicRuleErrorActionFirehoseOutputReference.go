...
func (j *jsiiProxy_IotTopicRuleErrorActionFirehoseOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_IotTopicRuleErrorActionFirehoseOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_IotTopicRuleErrorActionFirehoseOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func NewIotTopicRuleErrorActionFirehoseOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) IotTopicRuleErrorActionFirehoseOutputReference {
	_init_.Initialize()

	if err := validateNewIotTopicRuleErrorActionFirehoseOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewIotTopicRuleErrorActionFirehoseOutputReference_Override(i IotTopicRuleErrorActionFirehoseOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_IotTopicRuleErrorActionFirehoseOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_IotTopicRuleErrorActionFirehoseOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (i *jsiiProxy_IotTopicRuleErrorActionFirehoseOutputReference) ComputeFqn() *string {
	var returns *string
...
func (i *jsiiProxy_IotTopicRuleErrorActionFirehoseOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (i *jsiiProxy_IotTopicRuleErrorActionFirehoseOutputReference) ToString() *string {
	var returns *string
