...
func (j *jsiiProxy_DataAwsAppmeshVirtualNodeSpecListenerTimeoutHttp2PerRequestList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataAwsAppmeshVirtualNodeSpecListenerTimeoutHttp2PerRequestList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsAppmeshVirtualNodeSpecListenerTimeoutHttp2PerRequestList {
	_init_.Initialize()
...
func NewDataAwsAppmeshVirtualNodeSpecListenerTimeoutHttp2PerRequestList_Override(d DataAwsAppmeshVirtualNodeSpecListenerTimeoutHttp2PerRequestList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsAppmeshVirtualNodeSpecListenerTimeoutHttp2PerRequestList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsAppmeshVirtualNodeSpecListenerTimeoutHttp2PerRequestList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsAppmeshVirtualNodeSpecListenerTimeoutHttp2PerRequestList) Resolve(_context cdktf.IResolveContext) interface{} {
