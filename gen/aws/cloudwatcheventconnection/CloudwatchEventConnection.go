...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/cloudwatcheventconnection/internal"
...
func CloudwatchEventConnection_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	...
	if err := validateCloudwatchEventConnection_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_CloudwatchEventConnection) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_CloudwatchEventConnection) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (c *jsiiProxy_CloudwatchEventConnection) MoveFromId(id *string) {
...
func (c *jsiiProxy_CloudwatchEventConnection) MoveToId(id *string) {
