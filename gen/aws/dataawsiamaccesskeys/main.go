...
func init() {
	...
	_jsii_.RegisterStruct(
		"aws.dataAwsIamAccessKeys.DataAwsIamAccessKeysAccessKeys",
		reflect.TypeOf((*DataAwsIamAccessKeysAccessKeys)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"aws.dataAwsIamAccessKeys.DataAwsIamAccessKeysAccessKeysList",
	...
	_jsii_.RegisterStruct(
		"aws.dataAwsIamAccessKeys.DataAwsIamAccessKeysConfig",
