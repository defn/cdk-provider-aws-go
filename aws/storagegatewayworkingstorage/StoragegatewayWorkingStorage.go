...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/storagegatewayworkingstorage/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/storagegateway_working_storage aws_storagegateway_working_storage} Resource.
func NewStoragegatewayWorkingStorage(scope constructs.Construct, id *string, config *StoragegatewayWorkingStorageConfig) StoragegatewayWorkingStorage {
	...
	if err := validateNewStoragegatewayWorkingStorageParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_StoragegatewayWorkingStorage{}

	_jsii_.Create(
		"aws.storagegatewayWorkingStorage.StoragegatewayWorkingStorage",
...
func StoragegatewayWorkingStorage_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateStoragegatewayWorkingStorage_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func StoragegatewayWorkingStorage_IsConstruct(x interface{}) *bool {
	...
	if err := validateStoragegatewayWorkingStorage_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (s *jsiiProxy_StoragegatewayWorkingStorage) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_StoragegatewayWorkingStorage) HasResourceMove() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_StoragegatewayWorkingStorage) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (s *jsiiProxy_StoragegatewayWorkingStorage) MoveFromId(id *string) {
...
func (s *jsiiProxy_StoragegatewayWorkingStorage) MoveTo(moveTarget *string, index interface{}) {
...
func (s *jsiiProxy_StoragegatewayWorkingStorage) MoveToId(id *string) {
...
func (s *jsiiProxy_StoragegatewayWorkingStorage) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (s *jsiiProxy_StoragegatewayWorkingStorage) ToHclTerraform() interface{} {
	var returns interface{}
