...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/dbinstanceautomatedbackupsreplication/internal"
...
func (d *jsiiProxy_DbInstanceAutomatedBackupsReplication) MoveFromId(id *string) {
...
func (d *jsiiProxy_DbInstanceAutomatedBackupsReplication) MoveToId(id *string) {
