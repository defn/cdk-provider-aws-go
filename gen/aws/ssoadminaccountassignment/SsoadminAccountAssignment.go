...
type SsoadminAccountAssignment interface {
	...
	PutTimeouts(value *SsoadminAccountAssignmentTimeouts)
	ResetId()
...
func (j *jsiiProxy_SsoadminAccountAssignment) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_SsoadminAccountAssignment) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_SsoadminAccountAssignment) Timeouts() SsoadminAccountAssignmentTimeoutsOutputReference {
	var returns SsoadminAccountAssignmentTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func (j *jsiiProxy_SsoadminAccountAssignment) TimeoutsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"timeoutsInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/ssoadmin_account_assignment aws_ssoadmin_account_assignment} Resource.
func NewSsoadminAccountAssignment(scope constructs.Construct, id *string, config *SsoadminAccountAssignmentConfig) SsoadminAccountAssignment {
	...
	if err := validateNewSsoadminAccountAssignmentParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func SsoadminAccountAssignment_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateSsoadminAccountAssignment_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_SsoadminAccountAssignment) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_SsoadminAccountAssignment) PutTimeouts(value *SsoadminAccountAssignmentTimeouts) {
...
func (s *jsiiProxy_SsoadminAccountAssignment) ResetId() {
	_jsii_.InvokeVoid(
		s,
		"resetId",
		nil, // no parameters
...
func (s *jsiiProxy_SsoadminAccountAssignment) ResetTimeouts() {
	_jsii_.InvokeVoid(
		s,
		"resetTimeouts",
		nil, // no parameters
