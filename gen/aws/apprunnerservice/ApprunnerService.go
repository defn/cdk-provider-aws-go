...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/apprunnerservice/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/apprunner_service aws_apprunner_service}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/apprunner_service aws_apprunner_service} Resource.
...
func ApprunnerService_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateApprunnerService_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_ApprunnerService) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_ApprunnerService) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (a *jsiiProxy_ApprunnerService) MoveFromId(id *string) {
...
func (a *jsiiProxy_ApprunnerService) MoveToId(id *string) {
