...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/rdscustomdbengineversion/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/rds_custom_db_engine_version aws_rds_custom_db_engine_version}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/rds_custom_db_engine_version aws_rds_custom_db_engine_version} Resource.
func NewRdsCustomDbEngineVersion(scope constructs.Construct, id *string, config *RdsCustomDbEngineVersionConfig) RdsCustomDbEngineVersion {
	...
	_jsii_.Create(
		"aws.rdsCustomDbEngineVersion.RdsCustomDbEngineVersion",
