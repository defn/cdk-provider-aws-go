...
func (j *jsiiProxy_OpsworksInstanceTimeoutsOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_OpsworksInstanceTimeoutsOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_OpsworksInstanceTimeoutsOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_OpsworksInstanceTimeoutsOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_OpsworksInstanceTimeoutsOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func NewOpsworksInstanceTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) OpsworksInstanceTimeoutsOutputReference {
	...
	if err := validateNewOpsworksInstanceTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_OpsworksInstanceTimeoutsOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_OpsworksInstanceTimeoutsOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (j *jsiiProxy_OpsworksInstanceTimeoutsOutputReference)SetInternalValue(val interface{}) {
...
func (o *jsiiProxy_OpsworksInstanceTimeoutsOutputReference) ComputeFqn() *string {
	var returns *string
...
func (o *jsiiProxy_OpsworksInstanceTimeoutsOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (o *jsiiProxy_OpsworksInstanceTimeoutsOutputReference) ToString() *string {
	var returns *string
