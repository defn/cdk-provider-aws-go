...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/dataawsmqbrokerinstancetypeofferings/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/data-sources/mq_broker_instance_type_offerings aws_mq_broker_instance_type_offerings} Data Source.
...
func (d *jsiiProxy_DataAwsMqBrokerInstanceTypeOfferings) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataAwsMqBrokerInstanceTypeOfferings) ToHclTerraform() interface{} {
	var returns interface{}
