...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/codecommitapprovalruletemplateassociation/internal"
...
func CodecommitApprovalRuleTemplateAssociation_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateCodecommitApprovalRuleTemplateAssociation_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_CodecommitApprovalRuleTemplateAssociation) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_CodecommitApprovalRuleTemplateAssociation) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (c *jsiiProxy_CodecommitApprovalRuleTemplateAssociation) MoveFromId(id *string) {
...
func (c *jsiiProxy_CodecommitApprovalRuleTemplateAssociation) MoveToId(id *string) {
