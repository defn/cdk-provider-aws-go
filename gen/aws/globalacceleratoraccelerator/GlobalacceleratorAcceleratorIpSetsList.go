...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/globalacceleratoraccelerator/internal"
...
func NewGlobalacceleratorAcceleratorIpSetsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) GlobalacceleratorAcceleratorIpSetsList {
	...
	if err := validateNewGlobalacceleratorAcceleratorIpSetsListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (g *jsiiProxy_GlobalacceleratorAcceleratorIpSetsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
