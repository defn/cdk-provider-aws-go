...
func (j *jsiiProxy_PipesPipeTargetParametersBatchJobParametersContainerOverridesResourceRequirementList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_PipesPipeTargetParametersBatchJobParametersContainerOverridesResourceRequirementList) InternalValue() interface{} {
...
func (j *jsiiProxy_PipesPipeTargetParametersBatchJobParametersContainerOverridesResourceRequirementList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_PipesPipeTargetParametersBatchJobParametersContainerOverridesResourceRequirementList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (j *jsiiProxy_PipesPipeTargetParametersBatchJobParametersContainerOverridesResourceRequirementList)SetInternalValue(val interface{}) {
...
func (j *jsiiProxy_PipesPipeTargetParametersBatchJobParametersContainerOverridesResourceRequirementList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_PipesPipeTargetParametersBatchJobParametersContainerOverridesResourceRequirementList)SetWrapsSet(val *bool) {
...
func (p *jsiiProxy_PipesPipeTargetParametersBatchJobParametersContainerOverridesResourceRequirementList) ComputeFqn() *string {
	var returns *string
...
func (p *jsiiProxy_PipesPipeTargetParametersBatchJobParametersContainerOverridesResourceRequirementList) Get(index *float64) PipesPipeTargetParametersBatchJobParametersContainerOverridesResourceRequirementOutputReference {
	if err := p.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns PipesPipeTargetParametersBatchJobParametersContainerOverridesResourceRequirementOutputReference
...
func (p *jsiiProxy_PipesPipeTargetParametersBatchJobParametersContainerOverridesResourceRequirementList) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (p *jsiiProxy_PipesPipeTargetParametersBatchJobParametersContainerOverridesResourceRequirementList) ToString() *string {
	var returns *string
