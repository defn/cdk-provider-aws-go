...
func (j *jsiiProxy_CloudfrontDistributionOriginS3OriginConfigOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_CloudfrontDistributionOriginS3OriginConfigOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CloudfrontDistributionOriginS3OriginConfigOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CloudfrontDistributionOriginS3OriginConfigOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func NewCloudfrontDistributionOriginS3OriginConfigOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) CloudfrontDistributionOriginS3OriginConfigOutputReference {
	...
	if err := validateNewCloudfrontDistributionOriginS3OriginConfigOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CloudfrontDistributionOriginS3OriginConfigOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_CloudfrontDistributionOriginS3OriginConfigOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (j *jsiiProxy_CloudfrontDistributionOriginS3OriginConfigOutputReference)SetOriginAccessIdentity(val *string) {
	if err := j.validateSetOriginAccessIdentityParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (c *jsiiProxy_CloudfrontDistributionOriginS3OriginConfigOutputReference) ComputeFqn() *string {
	var returns *string
...
func (c *jsiiProxy_CloudfrontDistributionOriginS3OriginConfigOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (c *jsiiProxy_CloudfrontDistributionOriginS3OriginConfigOutputReference) ToString() *string {
	var returns *string
