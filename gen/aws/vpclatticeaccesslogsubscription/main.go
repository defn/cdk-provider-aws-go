...
func init() {
	_jsii_.RegisterClass(
		"aws.vpclatticeAccessLogSubscription.VpclatticeAccessLogSubscription",
		reflect.TypeOf((*VpclatticeAccessLogSubscription)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"aws.vpclatticeAccessLogSubscription.VpclatticeAccessLogSubscriptionConfig",
		reflect.TypeOf((*VpclatticeAccessLogSubscriptionConfig)(nil)).Elem(),
	)
}
