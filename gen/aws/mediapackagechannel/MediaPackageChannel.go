...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/mediapackagechannel/internal"
...
type MediaPackageChannel interface {
	...
	HlsIngest() MediaPackageChannelHlsIngestList
	Id() *string
	SetId(val *string)
	IdInput() *string
	// Experimental.
...
func (j *jsiiProxy_MediaPackageChannel) Connection() interface{} {
...
func (j *jsiiProxy_MediaPackageChannel) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_MediaPackageChannel) HlsIngest() MediaPackageChannelHlsIngestList {
	var returns MediaPackageChannelHlsIngestList
	_jsii_.Get(
		j,
		"hlsIngest",
		&returns,
...
func (j *jsiiProxy_MediaPackageChannel) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_MediaPackageChannel) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/media_package_channel aws_media_package_channel} Resource.
func NewMediaPackageChannel(scope constructs.Construct, id *string, config *MediaPackageChannelConfig) MediaPackageChannel {
	_init_.Initialize()

	if err := validateNewMediaPackageChannelParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_MediaPackageChannel)SetConnection(val interface{}) {
...
func (j *jsiiProxy_MediaPackageChannel)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_MediaPackageChannel)SetId(val *string) {
...
func (j *jsiiProxy_MediaPackageChannel)SetProvisioners(val *[]interface{}) {
...
func MediaPackageChannel_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateMediaPackageChannel_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func MediaPackageChannel_IsConstruct(x interface{}) *bool {
	...
	if err := validateMediaPackageChannel_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func MediaPackageChannel_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateMediaPackageChannel_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func MediaPackageChannel_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateMediaPackageChannel_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (m *jsiiProxy_MediaPackageChannel) AddMoveTarget(moveTarget *string) {
...
func (m *jsiiProxy_MediaPackageChannel) HasResourceMove() interface{} {
	var returns interface{}
...
func (m *jsiiProxy_MediaPackageChannel) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (m *jsiiProxy_MediaPackageChannel) MoveFromId(id *string) {
...
func (m *jsiiProxy_MediaPackageChannel) MoveTo(moveTarget *string, index interface{}) {
...
func (m *jsiiProxy_MediaPackageChannel) MoveToId(id *string) {
...
func (m *jsiiProxy_MediaPackageChannel) ResetId() {
	_jsii_.InvokeVoid(
		m,
		"resetId",
		nil, // no parameters
...
func (m *jsiiProxy_MediaPackageChannel) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (m *jsiiProxy_MediaPackageChannel) ToHclTerraform() interface{} {
	var returns interface{}
