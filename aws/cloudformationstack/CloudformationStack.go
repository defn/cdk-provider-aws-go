...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/cloudformationstack/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/cloudformation_stack aws_cloudformation_stack} Resource.
func NewCloudformationStack(scope constructs.Construct, id *string, config *CloudformationStackConfig) CloudformationStack {
	...
	_jsii_.Create(
		"aws.cloudformationStack.CloudformationStack",
