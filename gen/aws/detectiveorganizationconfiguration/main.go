...
func init() {
	_jsii_.RegisterClass(
		"aws.detectiveOrganizationConfiguration.DetectiveOrganizationConfiguration",
		reflect.TypeOf((*DetectiveOrganizationConfiguration)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"aws.detectiveOrganizationConfiguration.DetectiveOrganizationConfigurationConfig",
		reflect.TypeOf((*DetectiveOrganizationConfigurationConfig)(nil)).Elem(),
	)
}
