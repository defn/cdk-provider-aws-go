...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/lambdafunctioneventinvokeconfig/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/lambda_function_event_invoke_config aws_lambda_function_event_invoke_config}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/lambda_function_event_invoke_config aws_lambda_function_event_invoke_config} Resource.
...
func LambdaFunctionEventInvokeConfig_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateLambdaFunctionEventInvokeConfig_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (l *jsiiProxy_LambdaFunctionEventInvokeConfig) AddMoveTarget(moveTarget *string) {
...
func (l *jsiiProxy_LambdaFunctionEventInvokeConfig) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (l *jsiiProxy_LambdaFunctionEventInvokeConfig) MoveFromId(id *string) {
...
func (l *jsiiProxy_LambdaFunctionEventInvokeConfig) MoveToId(id *string) {
