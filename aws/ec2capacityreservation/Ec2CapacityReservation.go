...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/ec2capacityreservation/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/ec2_capacity_reservation aws_ec2_capacity_reservation} Resource.
...
func Ec2CapacityReservation_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
