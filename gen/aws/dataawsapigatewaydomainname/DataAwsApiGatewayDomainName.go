...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/data-sources/api_gateway_domain_name aws_api_gateway_domain_name} Data Source.
func NewDataAwsApiGatewayDomainName(scope constructs.Construct, id *string, config *DataAwsApiGatewayDomainNameConfig) DataAwsApiGatewayDomainName {
	...
	_jsii_.Create(
		"aws.dataAwsApiGatewayDomainName.DataAwsApiGatewayDomainName",
