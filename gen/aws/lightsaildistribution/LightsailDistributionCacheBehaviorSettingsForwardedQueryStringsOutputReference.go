...
type LightsailDistributionCacheBehaviorSettingsForwardedQueryStringsOutputReference interface {
	...
	// Experimental.
	Fqn() *string
	InternalValue() *LightsailDistributionCacheBehaviorSettingsForwardedQueryStrings
	SetInternalValue(val *LightsailDistributionCacheBehaviorSettingsForwardedQueryStrings)
	Option() interface{}
	SetOption(val interface{})
	OptionInput() interface{}
	QueryStringsAllowedList() *[]*string
	SetQueryStringsAllowedList(val *[]*string)
	QueryStringsAllowedListInput() *[]*string
	// Experimental.
...
func (j *jsiiProxy_LightsailDistributionCacheBehaviorSettingsForwardedQueryStringsOutputReference) InternalValue() *LightsailDistributionCacheBehaviorSettingsForwardedQueryStrings {
...
func (j *jsiiProxy_LightsailDistributionCacheBehaviorSettingsForwardedQueryStringsOutputReference) QueryStringsAllowedList() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"queryStringsAllowedList",
		&returns,
	)
	return returns
}

func (j *jsiiProxy_LightsailDistributionCacheBehaviorSettingsForwardedQueryStringsOutputReference) QueryStringsAllowedListInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"queryStringsAllowedListInput",
		&returns,
	)
	return returns
}
...
func (j *jsiiProxy_LightsailDistributionCacheBehaviorSettingsForwardedQueryStringsOutputReference)SetInternalValue(val *LightsailDistributionCacheBehaviorSettingsForwardedQueryStrings) {
...
func (j *jsiiProxy_LightsailDistributionCacheBehaviorSettingsForwardedQueryStringsOutputReference)SetQueryStringsAllowedList(val *[]*string) {
	if err := j.validateSetQueryStringsAllowedListParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (l *jsiiProxy_LightsailDistributionCacheBehaviorSettingsForwardedQueryStringsOutputReference) ResetQueryStringsAllowedList() {
	_jsii_.InvokeVoid(
		l,
		"resetQueryStringsAllowedList",
		nil, // no parameters
