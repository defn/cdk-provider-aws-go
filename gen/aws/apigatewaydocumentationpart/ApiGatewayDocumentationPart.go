...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/apigatewaydocumentationpart/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/api_gateway_documentation_part aws_api_gateway_documentation_part} Resource.
...
func ApiGatewayDocumentationPart_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateApiGatewayDocumentationPart_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_ApiGatewayDocumentationPart) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_ApiGatewayDocumentationPart) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (a *jsiiProxy_ApiGatewayDocumentationPart) MoveFromId(id *string) {
...
func (a *jsiiProxy_ApiGatewayDocumentationPart) MoveToId(id *string) {
