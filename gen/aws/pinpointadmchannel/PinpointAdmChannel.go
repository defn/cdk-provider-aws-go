...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/pinpointadmchannel/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/pinpoint_adm_channel aws_pinpoint_adm_channel} Resource.
...
func PinpointAdmChannel_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validatePinpointAdmChannel_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (p *jsiiProxy_PinpointAdmChannel) AddMoveTarget(moveTarget *string) {
...
func (p *jsiiProxy_PinpointAdmChannel) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (p *jsiiProxy_PinpointAdmChannel) MoveFromId(id *string) {
...
func (p *jsiiProxy_PinpointAdmChannel) MoveToId(id *string) {
