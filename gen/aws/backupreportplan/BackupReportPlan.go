...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/backupreportplan/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/backup_report_plan aws_backup_report_plan} Resource.
...
func (b *jsiiProxy_BackupReportPlan) HasResourceMove() interface{} {
	var returns interface{}
...
func (b *jsiiProxy_BackupReportPlan) MoveFromId(id *string) {
...
func (b *jsiiProxy_BackupReportPlan) MoveToId(id *string) {
...
func (b *jsiiProxy_BackupReportPlan) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (b *jsiiProxy_BackupReportPlan) ToHclTerraform() interface{} {
	var returns interface{}
