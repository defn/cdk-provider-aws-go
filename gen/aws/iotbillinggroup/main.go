...
func init() {
	...
	_jsii_.RegisterStruct(
		"aws.iotBillingGroup.IotBillingGroupConfig",
		reflect.TypeOf((*IotBillingGroupConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws.iotBillingGroup.IotBillingGroupMetadata",
		reflect.TypeOf((*IotBillingGroupMetadata)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"aws.iotBillingGroup.IotBillingGroupMetadataList",
	...
	_jsii_.RegisterClass(
		"aws.iotBillingGroup.IotBillingGroupMetadataOutputReference",
	...
	_jsii_.RegisterStruct(
		"aws.iotBillingGroup.IotBillingGroupProperties",
