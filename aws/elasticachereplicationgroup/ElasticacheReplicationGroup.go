...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/elasticachereplicationgroup/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/elasticache_replication_group aws_elasticache_replication_group}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/elasticache_replication_group aws_elasticache_replication_group} Resource.
...
func ElasticacheReplicationGroup_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (e *jsiiProxy_ElasticacheReplicationGroup) ImportFrom(id *string, provider cdktf.TerraformProvider) {
