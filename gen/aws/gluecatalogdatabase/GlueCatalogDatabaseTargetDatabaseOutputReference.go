...
func (j *jsiiProxy_GlueCatalogDatabaseTargetDatabaseOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_GlueCatalogDatabaseTargetDatabaseOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_GlueCatalogDatabaseTargetDatabaseOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (g *jsiiProxy_GlueCatalogDatabaseTargetDatabaseOutputReference) ComputeFqn() *string {
	var returns *string
...
func (g *jsiiProxy_GlueCatalogDatabaseTargetDatabaseOutputReference) ToString() *string {
	var returns *string
