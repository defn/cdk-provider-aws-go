...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/lakeformationlftag/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/lakeformation_lf_tag aws_lakeformation_lf_tag} Resource.
func NewLakeformationLfTag(scope constructs.Construct, id *string, config *LakeformationLfTagConfig) LakeformationLfTag {
	_init_.Initialize()

	if err := validateNewLakeformationLfTagParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func LakeformationLfTag_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateLakeformationLfTag_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (l *jsiiProxy_LakeformationLfTag) AddMoveTarget(moveTarget *string) {
...
func (l *jsiiProxy_LakeformationLfTag) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (l *jsiiProxy_LakeformationLfTag) MoveFromId(id *string) {
...
func (l *jsiiProxy_LakeformationLfTag) MoveToId(id *string) {
