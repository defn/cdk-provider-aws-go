...
func init() {
	...
	_jsii_.RegisterStruct(
		"aws.sagemakerAppImageConfig.SagemakerAppImageConfigJupyterLabImageConfig",
		reflect.TypeOf((*SagemakerAppImageConfigJupyterLabImageConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws.sagemakerAppImageConfig.SagemakerAppImageConfigJupyterLabImageConfigContainerConfig",
	...
	_jsii_.RegisterClass(
		"aws.sagemakerAppImageConfig.SagemakerAppImageConfigJupyterLabImageConfigOutputReference",
