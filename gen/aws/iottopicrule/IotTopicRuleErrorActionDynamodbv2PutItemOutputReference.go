...
func (j *jsiiProxy_IotTopicRuleErrorActionDynamodbv2PutItemOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_IotTopicRuleErrorActionDynamodbv2PutItemOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_IotTopicRuleErrorActionDynamodbv2PutItemOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_IotTopicRuleErrorActionDynamodbv2PutItemOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_IotTopicRuleErrorActionDynamodbv2PutItemOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (i *jsiiProxy_IotTopicRuleErrorActionDynamodbv2PutItemOutputReference) ComputeFqn() *string {
	var returns *string
...
func (i *jsiiProxy_IotTopicRuleErrorActionDynamodbv2PutItemOutputReference) ToString() *string {
	var returns *string
