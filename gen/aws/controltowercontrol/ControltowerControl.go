...
func (j *jsiiProxy_ControltowerControl) ControlIdentifier() *string {
	var returns *string
	_jsii_.Get(
		j,
		"controlIdentifier",
...
func (j *jsiiProxy_ControltowerControl) ControlIdentifierInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"controlIdentifierInput",
		&returns,
	)
	return returns
}
...
func (j *jsiiProxy_ControltowerControl) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_ControltowerControl) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_ControltowerControl) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_ControltowerControl) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_ControltowerControl) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_ControltowerControl) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_ControltowerControl) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ControltowerControl) Node() constructs.Node {
...
func (j *jsiiProxy_ControltowerControl) TargetIdentifier() *string {
	var returns *string
	_jsii_.Get(
		j,
		"targetIdentifier",
...
func (j *jsiiProxy_ControltowerControl) TargetIdentifierInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ControltowerControl) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_ControltowerControl) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ControltowerControl) Timeouts() ControltowerControlTimeoutsOutputReference {
	var returns ControltowerControlTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/controltower_control aws_controltower_control} Resource.
func NewControltowerControl(scope constructs.Construct, id *string, config *ControltowerControlConfig) ControltowerControl {
	_init_.Initialize()

	if err := validateNewControltowerControlParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func ControltowerControl_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateControltowerControl_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func ControltowerControl_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws.controltowerControl.ControltowerControl",
...
func (c *jsiiProxy_ControltowerControl) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_ControltowerControl) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ControltowerControl) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (c *jsiiProxy_ControltowerControl) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (c *jsiiProxy_ControltowerControl) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (c *jsiiProxy_ControltowerControl) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (c *jsiiProxy_ControltowerControl) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (c *jsiiProxy_ControltowerControl) GetStringAttribute(terraformAttribute *string) *string {
...
func (c *jsiiProxy_ControltowerControl) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (c *jsiiProxy_ControltowerControl) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ControltowerControl) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_ControltowerControl) ResetId() {
	_jsii_.InvokeVoid(
		c,
		"resetId",
		nil, // no parameters
...
func (c *jsiiProxy_ControltowerControl) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		c,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (c *jsiiProxy_ControltowerControl) ResetTimeouts() {
	_jsii_.InvokeVoid(
		c,
		"resetTimeouts",
		nil, // no parameters
...
func (c *jsiiProxy_ControltowerControl) ToString() *string {
	var returns *string
