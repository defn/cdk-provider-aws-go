...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/iotrolealias/internal"
...
func (j *jsiiProxy_IotRoleAlias) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_IotRoleAlias) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewIotRoleAlias(scope constructs.Construct, id *string, config *IotRoleAliasConfig) IotRoleAlias {
	...
	if err := validateNewIotRoleAliasParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func IotRoleAlias_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateIotRoleAlias_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (i *jsiiProxy_IotRoleAlias) AddMoveTarget(moveTarget *string) {
...
func (i *jsiiProxy_IotRoleAlias) ResetId() {
	_jsii_.InvokeVoid(
		i,
		"resetId",
		nil, // no parameters
