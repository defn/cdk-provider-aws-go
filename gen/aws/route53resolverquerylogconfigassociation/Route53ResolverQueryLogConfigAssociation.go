...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/route53resolverquerylogconfigassociation/internal"
...
func (j *jsiiProxy_Route53ResolverQueryLogConfigAssociation) Connection() interface{} {
...
func (j *jsiiProxy_Route53ResolverQueryLogConfigAssociation) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_Route53ResolverQueryLogConfigAssociation) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_Route53ResolverQueryLogConfigAssociation) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
func NewRoute53ResolverQueryLogConfigAssociation(scope constructs.Construct, id *string, config *Route53ResolverQueryLogConfigAssociationConfig) Route53ResolverQueryLogConfigAssociation {
	...
	if err := validateNewRoute53ResolverQueryLogConfigAssociationParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_Route53ResolverQueryLogConfigAssociation)SetConnection(val interface{}) {
...
func (j *jsiiProxy_Route53ResolverQueryLogConfigAssociation)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_Route53ResolverQueryLogConfigAssociation)SetId(val *string) {
...
func (j *jsiiProxy_Route53ResolverQueryLogConfigAssociation)SetProvisioners(val *[]interface{}) {
...
func Route53ResolverQueryLogConfigAssociation_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateRoute53ResolverQueryLogConfigAssociation_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func Route53ResolverQueryLogConfigAssociation_IsConstruct(x interface{}) *bool {
	...
	if err := validateRoute53ResolverQueryLogConfigAssociation_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (r *jsiiProxy_Route53ResolverQueryLogConfigAssociation) AddMoveTarget(moveTarget *string) {
...
func (r *jsiiProxy_Route53ResolverQueryLogConfigAssociation) HasResourceMove() interface{} {
	var returns interface{}
...
func (r *jsiiProxy_Route53ResolverQueryLogConfigAssociation) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (r *jsiiProxy_Route53ResolverQueryLogConfigAssociation) MoveFromId(id *string) {
...
func (r *jsiiProxy_Route53ResolverQueryLogConfigAssociation) MoveTo(moveTarget *string, index interface{}) {
...
func (r *jsiiProxy_Route53ResolverQueryLogConfigAssociation) MoveToId(id *string) {
...
func (r *jsiiProxy_Route53ResolverQueryLogConfigAssociation) ResetId() {
	_jsii_.InvokeVoid(
		r,
		"resetId",
		nil, // no parameters
...
func (r *jsiiProxy_Route53ResolverQueryLogConfigAssociation) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (r *jsiiProxy_Route53ResolverQueryLogConfigAssociation) ToHclTerraform() interface{} {
	var returns interface{}
