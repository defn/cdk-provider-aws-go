...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/lexintent/internal"
...
func NewLexIntentConfirmationPromptMessageList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) LexIntentConfirmationPromptMessageList {
	...
	if err := validateNewLexIntentConfirmationPromptMessageListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (l *jsiiProxy_LexIntentConfirmationPromptMessageList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
