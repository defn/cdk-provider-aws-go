...
func init() {
	...
	_jsii_.RegisterStruct(
		"aws.dataAwsSesv2EmailIdentity.DataAwsSesv2EmailIdentityConfig",
		reflect.TypeOf((*DataAwsSesv2EmailIdentityConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws.dataAwsSesv2EmailIdentity.DataAwsSesv2EmailIdentityDkimSigningAttributes",
	...
	_jsii_.RegisterClass(
		"aws.dataAwsSesv2EmailIdentity.DataAwsSesv2EmailIdentityDkimSigningAttributesOutputReference",
