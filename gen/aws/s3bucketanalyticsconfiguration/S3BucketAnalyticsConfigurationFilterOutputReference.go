...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/s3bucketanalyticsconfiguration/internal"
...
func (j *jsiiProxy_S3BucketAnalyticsConfigurationFilterOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_S3BucketAnalyticsConfigurationFilterOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_S3BucketAnalyticsConfigurationFilterOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_S3BucketAnalyticsConfigurationFilterOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func NewS3BucketAnalyticsConfigurationFilterOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) S3BucketAnalyticsConfigurationFilterOutputReference {
	_init_.Initialize()

	if err := validateNewS3BucketAnalyticsConfigurationFilterOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewS3BucketAnalyticsConfigurationFilterOutputReference_Override(s S3BucketAnalyticsConfigurationFilterOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_S3BucketAnalyticsConfigurationFilterOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_S3BucketAnalyticsConfigurationFilterOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (s *jsiiProxy_S3BucketAnalyticsConfigurationFilterOutputReference) ComputeFqn() *string {
	var returns *string
...
func (s *jsiiProxy_S3BucketAnalyticsConfigurationFilterOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (s *jsiiProxy_S3BucketAnalyticsConfigurationFilterOutputReference) ToString() *string {
	var returns *string
