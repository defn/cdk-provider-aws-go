...
func init() {
	_jsii_.RegisterClass(
		"aws.opensearchVpcEndpoint.OpensearchVpcEndpoint",
	...
	_jsii_.RegisterStruct(
		"aws.opensearchVpcEndpoint.OpensearchVpcEndpointConfig",
		reflect.TypeOf((*OpensearchVpcEndpointConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws.opensearchVpcEndpoint.OpensearchVpcEndpointTimeouts",
	...
	_jsii_.RegisterStruct(
		"aws.opensearchVpcEndpoint.OpensearchVpcEndpointVpcOptions",
