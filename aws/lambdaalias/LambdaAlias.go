...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/lambdaalias/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/lambda_alias aws_lambda_alias} Resource.
func NewLambdaAlias(scope constructs.Construct, id *string, config *LambdaAliasConfig) LambdaAlias {
	_init_.Initialize()

	if err := validateNewLambdaAliasParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func LambdaAlias_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateLambdaAlias_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (l *jsiiProxy_LambdaAlias) AddMoveTarget(moveTarget *string) {
...
func (l *jsiiProxy_LambdaAlias) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (l *jsiiProxy_LambdaAlias) MoveFromId(id *string) {
...
func (l *jsiiProxy_LambdaAlias) MoveToId(id *string) {
...
func (l *jsiiProxy_LambdaAlias) PutRoutingConfig(value *LambdaAliasRoutingConfig) {
	if err := l.validatePutRoutingConfigParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		l,
