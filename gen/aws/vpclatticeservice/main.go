...
func init() {
	...
	_jsii_.RegisterStruct(
		"aws.vpclatticeService.VpclatticeServiceConfig",
		reflect.TypeOf((*VpclatticeServiceConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws.vpclatticeService.VpclatticeServiceDnsEntry",
		reflect.TypeOf((*VpclatticeServiceDnsEntry)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"aws.vpclatticeService.VpclatticeServiceDnsEntryList",
	...
	_jsii_.RegisterClass(
		"aws.vpclatticeService.VpclatticeServiceDnsEntryOutputReference",
	...
	_jsii_.RegisterStruct(
		"aws.vpclatticeService.VpclatticeServiceTimeouts",
