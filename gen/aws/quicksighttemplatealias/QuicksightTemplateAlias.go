...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/quicksighttemplatealias/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/quicksight_template_alias aws_quicksight_template_alias} Resource.
func NewQuicksightTemplateAlias(scope constructs.Construct, id *string, config *QuicksightTemplateAliasConfig) QuicksightTemplateAlias {
	...
	_jsii_.Create(
		"aws.quicksightTemplateAlias.QuicksightTemplateAlias",
