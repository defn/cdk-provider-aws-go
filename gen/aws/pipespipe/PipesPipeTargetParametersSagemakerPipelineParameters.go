...
type PipesPipeTargetParametersSagemakerPipelineParameters struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/pipes_pipe#pipeline_parameter PipesPipe#pipeline_parameter}
