...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/redshiftcluster/internal"
...
func (r *jsiiProxy_RedshiftClusterClusterNodesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
