...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/apigatewaygatewayresponse/internal"
...
func ApiGatewayGatewayResponse_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	...
	if err := validateApiGatewayGatewayResponse_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_ApiGatewayGatewayResponse) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_ApiGatewayGatewayResponse) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (a *jsiiProxy_ApiGatewayGatewayResponse) MoveFromId(id *string) {
...
func (a *jsiiProxy_ApiGatewayGatewayResponse) MoveToId(id *string) {
