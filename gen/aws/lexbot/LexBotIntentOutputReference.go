...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/lexbot/internal"
...
func NewLexBotIntentOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) LexBotIntentOutputReference {
	...
	if err := validateNewLexBotIntentOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_LexBotIntentOutputReference)SetIntentName(val *string) {
	if err := j.validateSetIntentNameParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_LexBotIntentOutputReference)SetIntentVersion(val *string) {
	if err := j.validateSetIntentVersionParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
