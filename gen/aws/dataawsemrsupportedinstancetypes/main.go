...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "putSupportedInstanceTypes", GoMethod: "PutSupportedInstanceTypes"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetSupportedInstanceTypes", GoMethod: "ResetSupportedInstanceTypes"},
			_jsii_.MemberProperty{JsiiProperty: "supportedInstanceTypes", GoGetter: "SupportedInstanceTypes"},
			_jsii_.MemberProperty{JsiiProperty: "supportedInstanceTypesInput", GoGetter: "SupportedInstanceTypesInput"},
	...
	_jsii_.RegisterStruct(
		"aws.dataAwsEmrSupportedInstanceTypes.DataAwsEmrSupportedInstanceTypesConfig",
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsEmrSupportedInstanceTypesSupportedInstanceTypes)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"aws.dataAwsEmrSupportedInstanceTypes.DataAwsEmrSupportedInstanceTypesSupportedInstanceTypesList",
		reflect.TypeOf((*DataAwsEmrSupportedInstanceTypesSupportedInstanceTypesList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		"aws.dataAwsEmrSupportedInstanceTypes.DataAwsEmrSupportedInstanceTypesSupportedInstanceTypesOutputReference",
		reflect.TypeOf((*DataAwsEmrSupportedInstanceTypesSupportedInstanceTypesOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
