...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/s3controlbucket/internal"
...
func (j *jsiiProxy_S3ControlBucket) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_S3ControlBucket) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewS3ControlBucket(scope constructs.Construct, id *string, config *S3ControlBucketConfig) S3ControlBucket {
	...
	if err := validateNewS3ControlBucketParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func S3ControlBucket_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateS3ControlBucket_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_S3ControlBucket) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_S3ControlBucket) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (s *jsiiProxy_S3ControlBucket) MoveFromId(id *string) {
...
func (s *jsiiProxy_S3ControlBucket) MoveToId(id *string) {
...
func (s *jsiiProxy_S3ControlBucket) ResetId() {
	_jsii_.InvokeVoid(
		s,
		"resetId",
		nil, // no parameters
