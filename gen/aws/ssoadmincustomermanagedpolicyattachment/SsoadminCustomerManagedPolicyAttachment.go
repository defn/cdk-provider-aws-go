...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/ssoadmin_customer_managed_policy_attachment aws_ssoadmin_customer_managed_policy_attachment}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/ssoadmin_customer_managed_policy_attachment aws_ssoadmin_customer_managed_policy_attachment} Resource.
...
func SsoadminCustomerManagedPolicyAttachment_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateSsoadminCustomerManagedPolicyAttachment_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_SsoadminCustomerManagedPolicyAttachment) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_SsoadminCustomerManagedPolicyAttachment) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (s *jsiiProxy_SsoadminCustomerManagedPolicyAttachment) MoveFromId(id *string) {
...
func (s *jsiiProxy_SsoadminCustomerManagedPolicyAttachment) MoveToId(id *string) {
