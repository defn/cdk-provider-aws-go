...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/chimevoiceconnector/internal"
...
func ChimeVoiceConnector_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateChimeVoiceConnector_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_ChimeVoiceConnector) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_ChimeVoiceConnector) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (c *jsiiProxy_ChimeVoiceConnector) MoveFromId(id *string) {
...
func (c *jsiiProxy_ChimeVoiceConnector) MoveToId(id *string) {
