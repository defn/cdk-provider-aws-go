...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/codestarconnectionshost/internal"
...
type CodestarconnectionsHost interface {
	...
	PutTimeouts(value *CodestarconnectionsHostTimeouts)
...
func (j *jsiiProxy_CodestarconnectionsHost) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_CodestarconnectionsHost) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_CodestarconnectionsHost) Timeouts() CodestarconnectionsHostTimeoutsOutputReference {
	var returns CodestarconnectionsHostTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func NewCodestarconnectionsHost(scope constructs.Construct, id *string, config *CodestarconnectionsHostConfig) CodestarconnectionsHost {
	...
	if err := validateNewCodestarconnectionsHostParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func CodestarconnectionsHost_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateCodestarconnectionsHost_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_CodestarconnectionsHost) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_CodestarconnectionsHost) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (c *jsiiProxy_CodestarconnectionsHost) MoveFromId(id *string) {
...
func (c *jsiiProxy_CodestarconnectionsHost) MoveToId(id *string) {
...
func (c *jsiiProxy_CodestarconnectionsHost) PutTimeouts(value *CodestarconnectionsHostTimeouts) {
...
func (c *jsiiProxy_CodestarconnectionsHost) PutVpcConfiguration(value *CodestarconnectionsHostVpcConfiguration) {
	if err := c.validatePutVpcConfigurationParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		c,
...
func (c *jsiiProxy_CodestarconnectionsHost) ResetId() {
	_jsii_.InvokeVoid(
		c,
		"resetId",
		nil, // no parameters
...
func (c *jsiiProxy_CodestarconnectionsHost) ResetTimeouts() {
	_jsii_.InvokeVoid(
		c,
		"resetTimeouts",
		nil, // no parameters
