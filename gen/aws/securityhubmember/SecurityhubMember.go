...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/securityhubmember/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/securityhub_member aws_securityhub_member}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/securityhub_member aws_securityhub_member} Resource.
...
func SecurityhubMember_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateSecurityhubMember_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_SecurityhubMember) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_SecurityhubMember) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (s *jsiiProxy_SecurityhubMember) MoveFromId(id *string) {
...
func (s *jsiiProxy_SecurityhubMember) MoveToId(id *string) {
