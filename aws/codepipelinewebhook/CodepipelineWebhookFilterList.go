...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/codepipelinewebhook/internal"
...
func (c *jsiiProxy_CodepipelineWebhookFilterList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
