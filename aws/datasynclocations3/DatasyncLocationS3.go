...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/datasynclocations3/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/datasync_location_s3 aws_datasync_location_s3} Resource.
func NewDatasyncLocationS3(scope constructs.Construct, id *string, config *DatasyncLocationS3Config) DatasyncLocationS3 {
	...
	_jsii_.Create(
		"aws.datasyncLocationS3.DatasyncLocationS3",
