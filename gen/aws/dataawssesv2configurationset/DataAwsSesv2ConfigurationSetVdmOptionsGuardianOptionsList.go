...
func (d *jsiiProxy_DataAwsSesv2ConfigurationSetVdmOptionsGuardianOptionsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
