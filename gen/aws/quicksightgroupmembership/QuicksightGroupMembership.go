...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/quicksightgroupmembership/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/quicksight_group_membership aws_quicksight_group_membership} Resource.
func NewQuicksightGroupMembership(scope constructs.Construct, id *string, config *QuicksightGroupMembershipConfig) QuicksightGroupMembership {
	...
	if err := validateNewQuicksightGroupMembershipParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func QuicksightGroupMembership_IsConstruct(x interface{}) *bool {
	...
	if err := validateQuicksightGroupMembership_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func QuicksightGroupMembership_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateQuicksightGroupMembership_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func QuicksightGroupMembership_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateQuicksightGroupMembership_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
