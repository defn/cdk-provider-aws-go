...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/lambdalayerversion/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/lambda_layer_version aws_lambda_layer_version}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/lambda_layer_version aws_lambda_layer_version} Resource.
...
func LambdaLayerVersion_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateLambdaLayerVersion_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (l *jsiiProxy_LambdaLayerVersion) AddMoveTarget(moveTarget *string) {
...
func (l *jsiiProxy_LambdaLayerVersion) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (l *jsiiProxy_LambdaLayerVersion) MoveFromId(id *string) {
...
func (l *jsiiProxy_LambdaLayerVersion) MoveToId(id *string) {
