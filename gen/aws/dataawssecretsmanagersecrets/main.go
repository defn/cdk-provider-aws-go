...
func init() {
	...
	_jsii_.RegisterStruct(
		"aws.dataAwsSecretsmanagerSecrets.DataAwsSecretsmanagerSecretsConfig",
		reflect.TypeOf((*DataAwsSecretsmanagerSecretsConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws.dataAwsSecretsmanagerSecrets.DataAwsSecretsmanagerSecretsFilter",
	...
	_jsii_.RegisterClass(
		"aws.dataAwsSecretsmanagerSecrets.DataAwsSecretsmanagerSecretsFilterOutputReference",
