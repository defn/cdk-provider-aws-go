...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/dataawsroute53resolverfirewalldomainlist/internal"
...
func (j *jsiiProxy_DataAwsRoute53ResolverFirewallDomainList) CreationTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"creationTime",
...
func (j *jsiiProxy_DataAwsRoute53ResolverFirewallDomainList) CreatorRequestId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"creatorRequestId",
...
func (j *jsiiProxy_DataAwsRoute53ResolverFirewallDomainList) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_DataAwsRoute53ResolverFirewallDomainList) DomainCount() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"domainCount",
...
func (j *jsiiProxy_DataAwsRoute53ResolverFirewallDomainList) FirewallDomainListId() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsRoute53ResolverFirewallDomainList) FirewallDomainListIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsRoute53ResolverFirewallDomainList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataAwsRoute53ResolverFirewallDomainList) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_DataAwsRoute53ResolverFirewallDomainList) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_DataAwsRoute53ResolverFirewallDomainList) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DataAwsRoute53ResolverFirewallDomainList) ManagedOwnerName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"managedOwnerName",
...
func (j *jsiiProxy_DataAwsRoute53ResolverFirewallDomainList) ModificationTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"modificationTime",
...
func (j *jsiiProxy_DataAwsRoute53ResolverFirewallDomainList) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_DataAwsRoute53ResolverFirewallDomainList) Node() constructs.Node {
...
func (j *jsiiProxy_DataAwsRoute53ResolverFirewallDomainList) Status() *string {
	var returns *string
	_jsii_.Get(
		j,
		"status",
...
func (j *jsiiProxy_DataAwsRoute53ResolverFirewallDomainList) StatusMessage() *string {
	var returns *string
	_jsii_.Get(
		j,
		"statusMessage",
...
func (j *jsiiProxy_DataAwsRoute53ResolverFirewallDomainList) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func NewDataAwsRoute53ResolverFirewallDomainList(scope constructs.Construct, id *string, config *DataAwsRoute53ResolverFirewallDomainListConfig) DataAwsRoute53ResolverFirewallDomainList {
	...
	if err := validateNewDataAwsRoute53ResolverFirewallDomainListParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataAwsRoute53ResolverFirewallDomainList_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws.dataAwsRoute53ResolverFirewallDomainList.DataAwsRoute53ResolverFirewallDomainList",
...
func (d *jsiiProxy_DataAwsRoute53ResolverFirewallDomainList) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DataAwsRoute53ResolverFirewallDomainList) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (d *jsiiProxy_DataAwsRoute53ResolverFirewallDomainList) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (d *jsiiProxy_DataAwsRoute53ResolverFirewallDomainList) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DataAwsRoute53ResolverFirewallDomainList) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DataAwsRoute53ResolverFirewallDomainList) GetStringAttribute(terraformAttribute *string) *string {
...
func (d *jsiiProxy_DataAwsRoute53ResolverFirewallDomainList) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DataAwsRoute53ResolverFirewallDomainList) OverrideLogicalId(newLogicalId *string) {
...
func (d *jsiiProxy_DataAwsRoute53ResolverFirewallDomainList) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsRoute53ResolverFirewallDomainList) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		d,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsRoute53ResolverFirewallDomainList) ToString() *string {
	var returns *string
