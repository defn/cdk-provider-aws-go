...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/ecrreplicationconfiguration/internal"
...
func (j *jsiiProxy_EcrReplicationConfigurationReplicationConfigurationOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_EcrReplicationConfigurationReplicationConfigurationOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_EcrReplicationConfigurationReplicationConfigurationOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_EcrReplicationConfigurationReplicationConfigurationOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_EcrReplicationConfigurationReplicationConfigurationOutputReference) Rule() EcrReplicationConfigurationReplicationConfigurationRuleList {
	var returns EcrReplicationConfigurationReplicationConfigurationRuleList
	_jsii_.Get(
		j,
		"rule",
		&returns,
...
func NewEcrReplicationConfigurationReplicationConfigurationOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) EcrReplicationConfigurationReplicationConfigurationOutputReference {
	...
	if err := validateNewEcrReplicationConfigurationReplicationConfigurationOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_EcrReplicationConfigurationReplicationConfigurationOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_EcrReplicationConfigurationReplicationConfigurationOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (e *jsiiProxy_EcrReplicationConfigurationReplicationConfigurationOutputReference) ComputeFqn() *string {
	var returns *string
...
func (e *jsiiProxy_EcrReplicationConfigurationReplicationConfigurationOutputReference) PutRule(value interface{}) {
...
func (e *jsiiProxy_EcrReplicationConfigurationReplicationConfigurationOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (e *jsiiProxy_EcrReplicationConfigurationReplicationConfigurationOutputReference) ToString() *string {
	var returns *string
