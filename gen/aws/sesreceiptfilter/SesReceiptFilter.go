...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/sesreceiptfilter/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/ses_receipt_filter aws_ses_receipt_filter} Resource.
...
func SesReceiptFilter_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateSesReceiptFilter_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_SesReceiptFilter) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_SesReceiptFilter) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (s *jsiiProxy_SesReceiptFilter) ToHclTerraform() interface{} {
	var returns interface{}
