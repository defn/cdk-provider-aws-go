...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/efsfilesystempolicy/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/efs_file_system_policy aws_efs_file_system_policy} Resource.
...
func EfsFileSystemPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateEfsFileSystemPolicy_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
// Experimental.
func EfsFileSystemPolicy_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateEfsFileSystemPolicy_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func EfsFileSystemPolicy_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateEfsFileSystemPolicy_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (e *jsiiProxy_EfsFileSystemPolicy) AddMoveTarget(moveTarget *string) {
...
func (e *jsiiProxy_EfsFileSystemPolicy) HasResourceMove() interface{} {
	var returns interface{}
...
func (e *jsiiProxy_EfsFileSystemPolicy) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (e *jsiiProxy_EfsFileSystemPolicy) MoveFromId(id *string) {
...
func (e *jsiiProxy_EfsFileSystemPolicy) MoveTo(moveTarget *string, index interface{}) {
...
func (e *jsiiProxy_EfsFileSystemPolicy) MoveToId(id *string) {
...
func (e *jsiiProxy_EfsFileSystemPolicy) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (e *jsiiProxy_EfsFileSystemPolicy) ToHclTerraform() interface{} {
	var returns interface{}
