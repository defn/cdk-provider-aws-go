...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/mskserverlesscluster/internal"
...
func (j *jsiiProxy_MskServerlessCluster) ClusterUuid() *string {
	var returns *string
	_jsii_.Get(
		j,
		"clusterUuid",
...
func MskServerlessCluster_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateMskServerlessCluster_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (m *jsiiProxy_MskServerlessCluster) AddMoveTarget(moveTarget *string) {
...
func (m *jsiiProxy_MskServerlessCluster) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (m *jsiiProxy_MskServerlessCluster) MoveFromId(id *string) {
...
func (m *jsiiProxy_MskServerlessCluster) MoveToId(id *string) {
