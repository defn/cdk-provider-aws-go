...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/securityhuborganizationconfiguration/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/securityhub_organization_configuration aws_securityhub_organization_configuration} Resource.
...
func SecurityhubOrganizationConfiguration_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateSecurityhubOrganizationConfiguration_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_SecurityhubOrganizationConfiguration) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_SecurityhubOrganizationConfiguration) HasResourceMove() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_SecurityhubOrganizationConfiguration) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (s *jsiiProxy_SecurityhubOrganizationConfiguration) MoveFromId(id *string) {
...
func (s *jsiiProxy_SecurityhubOrganizationConfiguration) MoveTo(moveTarget *string, index interface{}) {
...
func (s *jsiiProxy_SecurityhubOrganizationConfiguration) MoveToId(id *string) {
...
func (s *jsiiProxy_SecurityhubOrganizationConfiguration) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (s *jsiiProxy_SecurityhubOrganizationConfiguration) ToHclTerraform() interface{} {
	var returns interface{}
