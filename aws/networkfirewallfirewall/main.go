...
func init() {
	...
	_jsii_.RegisterStruct(
		"aws.networkfirewallFirewall.NetworkfirewallFirewallTimeouts",
		reflect.TypeOf((*NetworkfirewallFirewallTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"aws.networkfirewallFirewall.NetworkfirewallFirewallTimeoutsOutputReference",
		reflect.TypeOf((*NetworkfirewallFirewallTimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
