...
type DataAwsEfsAccessPoint interface {
	...
	OwnerId() *string
	PosixUser() DataAwsEfsAccessPointPosixUserList
	// Experimental.
...
func (j *jsiiProxy_DataAwsEfsAccessPoint) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsEfsAccessPoint) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DataAwsEfsAccessPoint) PosixUser() DataAwsEfsAccessPointPosixUserList {
	var returns DataAwsEfsAccessPointPosixUserList
	_jsii_.Get(
		j,
		"posixUser",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/data-sources/efs_access_point aws_efs_access_point} Data Source.
func NewDataAwsEfsAccessPoint(scope constructs.Construct, id *string, config *DataAwsEfsAccessPointConfig) DataAwsEfsAccessPoint {
	...
	if err := validateNewDataAwsEfsAccessPointParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataAwsEfsAccessPoint_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsEfsAccessPoint_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsEfsAccessPoint) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
