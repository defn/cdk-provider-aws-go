...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/dataawsworkspacesdirectory/internal"
...
func NewDataAwsWorkspacesDirectorySelfServicePermissionsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsWorkspacesDirectorySelfServicePermissionsList {
	...
	if err := validateNewDataAwsWorkspacesDirectorySelfServicePermissionsListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsWorkspacesDirectorySelfServicePermissionsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
