...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/cloudsearchdomainserviceaccesspolicy/internal"
...
func (j *jsiiProxy_CloudsearchDomainServiceAccessPolicyTimeoutsOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CloudsearchDomainServiceAccessPolicyTimeoutsOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CloudsearchDomainServiceAccessPolicyTimeoutsOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_CloudsearchDomainServiceAccessPolicyTimeoutsOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_CloudsearchDomainServiceAccessPolicyTimeoutsOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_CloudsearchDomainServiceAccessPolicyTimeoutsOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (j *jsiiProxy_CloudsearchDomainServiceAccessPolicyTimeoutsOutputReference)SetInternalValue(val interface{}) {
...
func (c *jsiiProxy_CloudsearchDomainServiceAccessPolicyTimeoutsOutputReference) ComputeFqn() *string {
	var returns *string
...
func (c *jsiiProxy_CloudsearchDomainServiceAccessPolicyTimeoutsOutputReference) ToString() *string {
	var returns *string
