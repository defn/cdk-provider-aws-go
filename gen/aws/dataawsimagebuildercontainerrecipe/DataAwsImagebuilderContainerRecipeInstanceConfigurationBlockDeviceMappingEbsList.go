...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/dataawsimagebuildercontainerrecipe/internal"
...
func (d *jsiiProxy_DataAwsImagebuilderContainerRecipeInstanceConfigurationBlockDeviceMappingEbsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
