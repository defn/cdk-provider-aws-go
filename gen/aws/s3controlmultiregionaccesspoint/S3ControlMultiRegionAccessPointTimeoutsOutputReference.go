...
func (j *jsiiProxy_S3ControlMultiRegionAccessPointTimeoutsOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_S3ControlMultiRegionAccessPointTimeoutsOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_S3ControlMultiRegionAccessPointTimeoutsOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_S3ControlMultiRegionAccessPointTimeoutsOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_S3ControlMultiRegionAccessPointTimeoutsOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func NewS3ControlMultiRegionAccessPointTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) S3ControlMultiRegionAccessPointTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewS3ControlMultiRegionAccessPointTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewS3ControlMultiRegionAccessPointTimeoutsOutputReference_Override(s S3ControlMultiRegionAccessPointTimeoutsOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_S3ControlMultiRegionAccessPointTimeoutsOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_S3ControlMultiRegionAccessPointTimeoutsOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (j *jsiiProxy_S3ControlMultiRegionAccessPointTimeoutsOutputReference)SetInternalValue(val interface{}) {
...
func (s *jsiiProxy_S3ControlMultiRegionAccessPointTimeoutsOutputReference) ComputeFqn() *string {
	var returns *string
...
func (s *jsiiProxy_S3ControlMultiRegionAccessPointTimeoutsOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (s *jsiiProxy_S3ControlMultiRegionAccessPointTimeoutsOutputReference) ToString() *string {
	var returns *string
