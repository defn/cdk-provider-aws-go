...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/apprunnervpcconnector/internal"
...
func ApprunnerVpcConnector_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateApprunnerVpcConnector_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_ApprunnerVpcConnector) AddMoveTarget(moveTarget *string) {
