...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/guardduty_organization_configuration aws_guardduty_organization_configuration} Resource.
...
func GuarddutyOrganizationConfiguration_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	...
	if err := validateGuarddutyOrganizationConfiguration_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (g *jsiiProxy_GuarddutyOrganizationConfiguration) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GuarddutyOrganizationConfiguration) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (g *jsiiProxy_GuarddutyOrganizationConfiguration) MoveFromId(id *string) {
...
func (g *jsiiProxy_GuarddutyOrganizationConfiguration) MoveToId(id *string) {
