...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/cognitomanageduserpoolclient/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/cognito_managed_user_pool_client aws_cognito_managed_user_pool_client} Resource.
func NewCognitoManagedUserPoolClient(scope constructs.Construct, id *string, config *CognitoManagedUserPoolClientConfig) CognitoManagedUserPoolClient {
	...
	_jsii_.Create(
		"aws.cognitoManagedUserPoolClient.CognitoManagedUserPoolClient",
...
func CognitoManagedUserPoolClient_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateCognitoManagedUserPoolClient_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_CognitoManagedUserPoolClient) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_CognitoManagedUserPoolClient) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (c *jsiiProxy_CognitoManagedUserPoolClient) ToHclTerraform() interface{} {
	var returns interface{}
