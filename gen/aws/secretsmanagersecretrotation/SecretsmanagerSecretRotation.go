...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/secretsmanagersecretrotation/internal"
...
func SecretsmanagerSecretRotation_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateSecretsmanagerSecretRotation_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_SecretsmanagerSecretRotation) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_SecretsmanagerSecretRotation) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (s *jsiiProxy_SecretsmanagerSecretRotation) MoveFromId(id *string) {
...
func (s *jsiiProxy_SecretsmanagerSecretRotation) MoveToId(id *string) {
