...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/kmsexternalkey/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/kms_external_key aws_kms_external_key}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/kms_external_key aws_kms_external_key} Resource.
func NewKmsExternalKey(scope constructs.Construct, id *string, config *KmsExternalKeyConfig) KmsExternalKey {
	...
	_jsii_.Create(
		"aws.kmsExternalKey.KmsExternalKey",
...
func (k *jsiiProxy_KmsExternalKey) AddMoveTarget(moveTarget *string) {
