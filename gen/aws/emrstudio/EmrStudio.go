...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/emrstudio/internal"
...
func (j *jsiiProxy_EmrStudio) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/emr_studio aws_emr_studio} Resource.
func NewEmrStudio(scope constructs.Construct, id *string, config *EmrStudioConfig) EmrStudio {
	_init_.Initialize()

	if err := validateNewEmrStudioParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (e *jsiiProxy_EmrStudio) AddMoveTarget(moveTarget *string) {
...
func (e *jsiiProxy_EmrStudio) ResetId() {
	_jsii_.InvokeVoid(
		e,
		"resetId",
		nil, // no parameters
