...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/dataawsconnectbotassociation/internal"
...
func (j *jsiiProxy_DataAwsConnectBotAssociationLexBotOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_DataAwsConnectBotAssociationLexBotOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsConnectBotAssociationLexBotOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_DataAwsConnectBotAssociationLexBotOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func NewDataAwsConnectBotAssociationLexBotOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) DataAwsConnectBotAssociationLexBotOutputReference {
	_init_.Initialize()

	if err := validateNewDataAwsConnectBotAssociationLexBotOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewDataAwsConnectBotAssociationLexBotOutputReference_Override(d DataAwsConnectBotAssociationLexBotOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsConnectBotAssociationLexBotOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_DataAwsConnectBotAssociationLexBotOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (d *jsiiProxy_DataAwsConnectBotAssociationLexBotOutputReference) ComputeFqn() *string {
	var returns *string
...
func (d *jsiiProxy_DataAwsConnectBotAssociationLexBotOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (d *jsiiProxy_DataAwsConnectBotAssociationLexBotOutputReference) ToString() *string {
	var returns *string
