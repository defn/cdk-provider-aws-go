...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/lbsslnegotiationpolicy/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/lb_ssl_negotiation_policy aws_lb_ssl_negotiation_policy} Resource.
...
func LbSslNegotiationPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateLbSslNegotiationPolicy_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
// Experimental.
func LbSslNegotiationPolicy_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateLbSslNegotiationPolicy_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func LbSslNegotiationPolicy_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateLbSslNegotiationPolicy_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (l *jsiiProxy_LbSslNegotiationPolicy) AddMoveTarget(moveTarget *string) {
...
func (l *jsiiProxy_LbSslNegotiationPolicy) HasResourceMove() interface{} {
	var returns interface{}
...
func (l *jsiiProxy_LbSslNegotiationPolicy) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (l *jsiiProxy_LbSslNegotiationPolicy) MoveFromId(id *string) {
...
func (l *jsiiProxy_LbSslNegotiationPolicy) MoveTo(moveTarget *string, index interface{}) {
...
func (l *jsiiProxy_LbSslNegotiationPolicy) MoveToId(id *string) {
...
func (l *jsiiProxy_LbSslNegotiationPolicy) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (l *jsiiProxy_LbSslNegotiationPolicy) ToHclTerraform() interface{} {
	var returns interface{}
