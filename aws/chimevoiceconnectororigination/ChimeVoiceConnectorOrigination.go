...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/chimevoiceconnectororigination/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/chime_voice_connector_origination aws_chime_voice_connector_origination}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/chime_voice_connector_origination aws_chime_voice_connector_origination} Resource.
func NewChimeVoiceConnectorOrigination(scope constructs.Construct, id *string, config *ChimeVoiceConnectorOriginationConfig) ChimeVoiceConnectorOrigination {
	...
	if err := validateNewChimeVoiceConnectorOriginationParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func ChimeVoiceConnectorOrigination_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateChimeVoiceConnectorOrigination_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_ChimeVoiceConnectorOrigination) AddMoveTarget(moveTarget *string) {
