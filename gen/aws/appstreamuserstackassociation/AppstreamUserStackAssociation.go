...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/appstreamuserstackassociation/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/appstream_user_stack_association aws_appstream_user_stack_association} Resource.
func NewAppstreamUserStackAssociation(scope constructs.Construct, id *string, config *AppstreamUserStackAssociationConfig) AppstreamUserStackAssociation {
	...
	if err := validateNewAppstreamUserStackAssociationParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func AppstreamUserStackAssociation_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateAppstreamUserStackAssociation_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_AppstreamUserStackAssociation) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_AppstreamUserStackAssociation) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (a *jsiiProxy_AppstreamUserStackAssociation) MoveFromId(id *string) {
...
func (a *jsiiProxy_AppstreamUserStackAssociation) MoveToId(id *string) {
