...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/wafregionalwebacl/internal"
...
func NewWafregionalWebAclRuleActionOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) WafregionalWebAclRuleActionOutputReference {
	...
	if err := validateNewWafregionalWebAclRuleActionOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
