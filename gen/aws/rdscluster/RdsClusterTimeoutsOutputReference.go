...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/rdscluster/internal"
...
func (j *jsiiProxy_RdsClusterTimeoutsOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_RdsClusterTimeoutsOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_RdsClusterTimeoutsOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_RdsClusterTimeoutsOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_RdsClusterTimeoutsOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func NewRdsClusterTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) RdsClusterTimeoutsOutputReference {
	...
	if err := validateNewRdsClusterTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_RdsClusterTimeoutsOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_RdsClusterTimeoutsOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (j *jsiiProxy_RdsClusterTimeoutsOutputReference)SetInternalValue(val interface{}) {
...
func (r *jsiiProxy_RdsClusterTimeoutsOutputReference) ComputeFqn() *string {
	var returns *string
...
func (r *jsiiProxy_RdsClusterTimeoutsOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (r *jsiiProxy_RdsClusterTimeoutsOutputReference) ToString() *string {
	var returns *string
