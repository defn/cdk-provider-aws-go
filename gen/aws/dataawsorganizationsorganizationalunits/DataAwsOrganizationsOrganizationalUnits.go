...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/dataawsorganizationsorganizationalunits/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/data-sources/organizations_organizational_units aws_organizations_organizational_units} Data Source.
func NewDataAwsOrganizationsOrganizationalUnits(scope constructs.Construct, id *string, config *DataAwsOrganizationsOrganizationalUnitsConfig) DataAwsOrganizationsOrganizationalUnits {
	...
	_jsii_.Create(
		"aws.dataAwsOrganizationsOrganizationalUnits.DataAwsOrganizationsOrganizationalUnits",
...
func DataAwsOrganizationsOrganizationalUnits_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsOrganizationsOrganizationalUnits_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsOrganizationsOrganizationalUnits) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataAwsOrganizationsOrganizationalUnits) ToHclTerraform() interface{} {
	var returns interface{}
