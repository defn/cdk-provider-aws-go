...
func init() {
	...
	_jsii_.RegisterStruct(
		"aws.elasticsearchVpcEndpoint.ElasticsearchVpcEndpointConfig",
		reflect.TypeOf((*ElasticsearchVpcEndpointConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws.elasticsearchVpcEndpoint.ElasticsearchVpcEndpointTimeouts",
	...
	_jsii_.RegisterStruct(
		"aws.elasticsearchVpcEndpoint.ElasticsearchVpcEndpointVpcOptions",
