...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/auditmanagerframeworkshare/internal"
...
func AuditmanagerFrameworkShare_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	...
	if err := validateAuditmanagerFrameworkShare_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_AuditmanagerFrameworkShare) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_AuditmanagerFrameworkShare) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (a *jsiiProxy_AuditmanagerFrameworkShare) MoveFromId(id *string) {
...
func (a *jsiiProxy_AuditmanagerFrameworkShare) MoveToId(id *string) {
