...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/lblistenerrule/internal"
...
func (j *jsiiProxy_LbListenerRuleConditionPathPatternOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_LbListenerRuleConditionPathPatternOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_LbListenerRuleConditionPathPatternOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_LbListenerRuleConditionPathPatternOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_LbListenerRuleConditionPathPatternOutputReference) TerraformResource() cdktf.IInterpolatingParent {
...
func NewLbListenerRuleConditionPathPatternOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) LbListenerRuleConditionPathPatternOutputReference {
	...
	if err := validateNewLbListenerRuleConditionPathPatternOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_LbListenerRuleConditionPathPatternOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_LbListenerRuleConditionPathPatternOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (j *jsiiProxy_LbListenerRuleConditionPathPatternOutputReference)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (l *jsiiProxy_LbListenerRuleConditionPathPatternOutputReference) ComputeFqn() *string {
	var returns *string
...
func (l *jsiiProxy_LbListenerRuleConditionPathPatternOutputReference) GetAnyMapAttribute(terraformAttribute *string) *map[string]interface{} {
...
func (l *jsiiProxy_LbListenerRuleConditionPathPatternOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LbListenerRuleConditionPathPatternOutputReference) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (l *jsiiProxy_LbListenerRuleConditionPathPatternOutputReference) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (l *jsiiProxy_LbListenerRuleConditionPathPatternOutputReference) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (l *jsiiProxy_LbListenerRuleConditionPathPatternOutputReference) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (l *jsiiProxy_LbListenerRuleConditionPathPatternOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (l *jsiiProxy_LbListenerRuleConditionPathPatternOutputReference) ToString() *string {
	var returns *string
