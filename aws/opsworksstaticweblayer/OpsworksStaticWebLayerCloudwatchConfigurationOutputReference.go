...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/opsworksstaticweblayer/internal"
...
type OpsworksStaticWebLayerCloudwatchConfigurationOutputReference interface {
	...
	LogStreams() OpsworksStaticWebLayerCloudwatchConfigurationLogStreamsList
...
func (j *jsiiProxy_OpsworksStaticWebLayerCloudwatchConfigurationOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_OpsworksStaticWebLayerCloudwatchConfigurationOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_OpsworksStaticWebLayerCloudwatchConfigurationOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_OpsworksStaticWebLayerCloudwatchConfigurationOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_OpsworksStaticWebLayerCloudwatchConfigurationOutputReference) LogStreams() OpsworksStaticWebLayerCloudwatchConfigurationLogStreamsList {
	var returns OpsworksStaticWebLayerCloudwatchConfigurationLogStreamsList
	_jsii_.Get(
		j,
		"logStreams",
		&returns,
...
func NewOpsworksStaticWebLayerCloudwatchConfigurationOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) OpsworksStaticWebLayerCloudwatchConfigurationOutputReference {
	...
	if err := validateNewOpsworksStaticWebLayerCloudwatchConfigurationOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_OpsworksStaticWebLayerCloudwatchConfigurationOutputReference{}

	_jsii_.Create(
		"aws.opsworksStaticWebLayer.OpsworksStaticWebLayerCloudwatchConfigurationOutputReference",
...
func (j *jsiiProxy_OpsworksStaticWebLayerCloudwatchConfigurationOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_OpsworksStaticWebLayerCloudwatchConfigurationOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (o *jsiiProxy_OpsworksStaticWebLayerCloudwatchConfigurationOutputReference) ComputeFqn() *string {
	var returns *string
...
func (o *jsiiProxy_OpsworksStaticWebLayerCloudwatchConfigurationOutputReference) PutLogStreams(value interface{}) {
...
func (o *jsiiProxy_OpsworksStaticWebLayerCloudwatchConfigurationOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (o *jsiiProxy_OpsworksStaticWebLayerCloudwatchConfigurationOutputReference) ToString() *string {
	var returns *string
