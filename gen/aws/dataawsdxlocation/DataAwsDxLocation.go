...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/dataawsdxlocation/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/data-sources/dx_location aws_dx_location} Data Source.
func NewDataAwsDxLocation(scope constructs.Construct, id *string, config *DataAwsDxLocationConfig) DataAwsDxLocation {
	_init_.Initialize()

	if err := validateNewDataAwsDxLocationParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_DataAwsDxLocation)SetLocationCode(val *string) {
	if err := j.validateSetLocationCodeParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func DataAwsDxLocation_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsDxLocation_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func DataAwsDxLocation_IsConstruct(x interface{}) *bool {
	...
	if err := validateDataAwsDxLocation_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAwsDxLocation_IsTerraformDataSource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsDxLocation_IsTerraformDataSourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAwsDxLocation_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsDxLocation_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataAwsDxLocation) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataAwsDxLocation) ToHclTerraform() interface{} {
	var returns interface{}
