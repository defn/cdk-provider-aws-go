...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/dbproxy/internal"
...
func (j *jsiiProxy_DbProxy) Auth() DbProxyAuthList {
	var returns DbProxyAuthList
	_jsii_.Get(
		j,
		"auth",
		&returns,
...
func (j *jsiiProxy_DbProxy) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DbProxy) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewDbProxy(scope constructs.Construct, id *string, config *DbProxyConfig) DbProxy {
	...
	if err := validateNewDbProxyParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_DbProxy{}
...
func DbProxy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDbProxy_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DbProxy) AddMoveTarget(moveTarget *string) {
