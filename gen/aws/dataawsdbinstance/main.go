...
func init() {
	...
	_jsii_.RegisterStruct(
		"aws.dataAwsDbInstance.DataAwsDbInstanceMasterUserSecret",
		reflect.TypeOf((*DataAwsDbInstanceMasterUserSecret)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"aws.dataAwsDbInstance.DataAwsDbInstanceMasterUserSecretList",
	...
	_jsii_.RegisterClass(
		"aws.dataAwsDbInstance.DataAwsDbInstanceMasterUserSecretOutputReference",
