...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/waf_xss_match_set aws_waf_xss_match_set} Resource.
...
func WafXssMatchSet_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateWafXssMatchSet_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (w *jsiiProxy_WafXssMatchSet) AddMoveTarget(moveTarget *string) {
...
func (w *jsiiProxy_WafXssMatchSet) HasResourceMove() interface{} {
	var returns interface{}
...
func (w *jsiiProxy_WafXssMatchSet) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (w *jsiiProxy_WafXssMatchSet) MoveFromId(id *string) {
...
func (w *jsiiProxy_WafXssMatchSet) MoveTo(moveTarget *string, index interface{}) {
...
func (w *jsiiProxy_WafXssMatchSet) MoveToId(id *string) {
...
func (w *jsiiProxy_WafXssMatchSet) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (w *jsiiProxy_WafXssMatchSet) ToHclTerraform() interface{} {
	var returns interface{}
