...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/wafregionalregexpatternset/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/wafregional_regex_pattern_set aws_wafregional_regex_pattern_set} Resource.
...
func WafregionalRegexPatternSet_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateWafregionalRegexPatternSet_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
// Experimental.
func WafregionalRegexPatternSet_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateWafregionalRegexPatternSet_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func WafregionalRegexPatternSet_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateWafregionalRegexPatternSet_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (w *jsiiProxy_WafregionalRegexPatternSet) AddMoveTarget(moveTarget *string) {
...
func (w *jsiiProxy_WafregionalRegexPatternSet) HasResourceMove() interface{} {
	var returns interface{}
...
func (w *jsiiProxy_WafregionalRegexPatternSet) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (w *jsiiProxy_WafregionalRegexPatternSet) MoveFromId(id *string) {
...
func (w *jsiiProxy_WafregionalRegexPatternSet) MoveTo(moveTarget *string, index interface{}) {
...
func (w *jsiiProxy_WafregionalRegexPatternSet) MoveToId(id *string) {
...
func (w *jsiiProxy_WafregionalRegexPatternSet) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (w *jsiiProxy_WafregionalRegexPatternSet) ToHclTerraform() interface{} {
	var returns interface{}
