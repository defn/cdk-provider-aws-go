...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/dataawselb/internal"
...
func NewDataAwsElbAccessLogsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsElbAccessLogsList {
	...
	if err := validateNewDataAwsElbAccessLogsListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsElbAccessLogsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
