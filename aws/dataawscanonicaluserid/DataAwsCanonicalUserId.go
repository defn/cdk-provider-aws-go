...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/dataawscanonicaluserid/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/data-sources/canonical_user_id aws_canonical_user_id}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/data-sources/canonical_user_id aws_canonical_user_id} Data Source.
...
func DataAwsCanonicalUserId_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsCanonicalUserId_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
// Experimental.
func DataAwsCanonicalUserId_IsTerraformDataSource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsCanonicalUserId_IsTerraformDataSourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAwsCanonicalUserId_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsCanonicalUserId_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataAwsCanonicalUserId) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataAwsCanonicalUserId) ToHclTerraform() interface{} {
	var returns interface{}
