...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/daxcluster/internal"
...
func (j *jsiiProxy_DaxClusterTimeoutsOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_DaxClusterTimeoutsOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DaxClusterTimeoutsOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_DaxClusterTimeoutsOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DaxClusterTimeoutsOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func NewDaxClusterTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) DaxClusterTimeoutsOutputReference {
	...
	if err := validateNewDaxClusterTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_DaxClusterTimeoutsOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_DaxClusterTimeoutsOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (j *jsiiProxy_DaxClusterTimeoutsOutputReference)SetInternalValue(val interface{}) {
...
func (d *jsiiProxy_DaxClusterTimeoutsOutputReference) ComputeFqn() *string {
	var returns *string
...
func (d *jsiiProxy_DaxClusterTimeoutsOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (d *jsiiProxy_DaxClusterTimeoutsOutputReference) ToString() *string {
	var returns *string
