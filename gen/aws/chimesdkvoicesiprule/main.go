...
func init() {
	_jsii_.RegisterClass(
		"aws.chimesdkvoiceSipRule.ChimesdkvoiceSipRule",
	...
	_jsii_.RegisterStruct(
		"aws.chimesdkvoiceSipRule.ChimesdkvoiceSipRuleConfig",
		reflect.TypeOf((*ChimesdkvoiceSipRuleConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws.chimesdkvoiceSipRule.ChimesdkvoiceSipRuleTargetApplications",
