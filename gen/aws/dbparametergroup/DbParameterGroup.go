...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/dbparametergroup/internal"
...
func (j *jsiiProxy_DbParameterGroup) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DbParameterGroup) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DbParameterGroup) Parameter() DbParameterGroupParameterList {
	var returns DbParameterGroupParameterList
	_jsii_.Get(
		j,
		"parameter",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/db_parameter_group aws_db_parameter_group} Resource.
func NewDbParameterGroup(scope constructs.Construct, id *string, config *DbParameterGroupConfig) DbParameterGroup {
	_init_.Initialize()

	if err := validateNewDbParameterGroupParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DbParameterGroup_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDbParameterGroup_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DbParameterGroup) AddMoveTarget(moveTarget *string) {
...
func (d *jsiiProxy_DbParameterGroup) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (d *jsiiProxy_DbParameterGroup) MoveFromId(id *string) {
...
func (d *jsiiProxy_DbParameterGroup) MoveToId(id *string) {
...
func (d *jsiiProxy_DbParameterGroup) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
