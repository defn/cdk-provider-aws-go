...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/dataawsacmpcacertificate/internal"
...
func NewDataAwsAcmpcaCertificate(scope constructs.Construct, id *string, config *DataAwsAcmpcaCertificateConfig) DataAwsAcmpcaCertificate {
	...
	if err := validateNewDataAwsAcmpcaCertificateParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataAwsAcmpcaCertificate_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsAcmpcaCertificate_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func DataAwsAcmpcaCertificate_IsConstruct(x interface{}) *bool {
	...
	if err := validateDataAwsAcmpcaCertificate_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAwsAcmpcaCertificate_IsTerraformDataSource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsAcmpcaCertificate_IsTerraformDataSourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAwsAcmpcaCertificate_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsAcmpcaCertificate_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataAwsAcmpcaCertificate) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataAwsAcmpcaCertificate) ToHclTerraform() interface{} {
	var returns interface{}
