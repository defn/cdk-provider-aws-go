...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/gluecatalogdatabase/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/glue_catalog_database aws_glue_catalog_database}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/glue_catalog_database aws_glue_catalog_database} Resource.
...
func GlueCatalogDatabase_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateGlueCatalogDatabase_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (g *jsiiProxy_GlueCatalogDatabase) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GlueCatalogDatabase) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (g *jsiiProxy_GlueCatalogDatabase) MoveFromId(id *string) {
...
func (g *jsiiProxy_GlueCatalogDatabase) MoveToId(id *string) {
