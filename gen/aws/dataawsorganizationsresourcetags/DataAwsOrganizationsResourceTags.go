...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/dataawsorganizationsresourcetags/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/data-sources/organizations_resource_tags aws_organizations_resource_tags} Data Source.
func NewDataAwsOrganizationsResourceTags(scope constructs.Construct, id *string, config *DataAwsOrganizationsResourceTagsConfig) DataAwsOrganizationsResourceTags {
	...
	if err := validateNewDataAwsOrganizationsResourceTagsParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataAwsOrganizationsResourceTags_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsOrganizationsResourceTags_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
