...
func init() {
	...
	_jsii_.RegisterStruct(
		"aws.dataAwsCognitoIdentityPool.DataAwsCognitoIdentityPoolCognitoIdentityProviders",
		reflect.TypeOf((*DataAwsCognitoIdentityPoolCognitoIdentityProviders)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"aws.dataAwsCognitoIdentityPool.DataAwsCognitoIdentityPoolCognitoIdentityProvidersList",
	...
	_jsii_.RegisterStruct(
		"aws.dataAwsCognitoIdentityPool.DataAwsCognitoIdentityPoolConfig",
