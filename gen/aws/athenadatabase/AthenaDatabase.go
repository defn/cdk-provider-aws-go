...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/athenadatabase/internal"
...
type AthenaDatabase interface {
	...
	AclConfigurationInput() *AthenaDatabaseAclConfiguration
	Bucket() *string
	...
	PutAclConfiguration(value *AthenaDatabaseAclConfiguration)
...
func (j *jsiiProxy_AthenaDatabase) AclConfiguration() AthenaDatabaseAclConfigurationOutputReference {
	var returns AthenaDatabaseAclConfigurationOutputReference
	_jsii_.Get(
		j,
		"aclConfiguration",
		&returns,
...
func (j *jsiiProxy_AthenaDatabase) AclConfigurationInput() *AthenaDatabaseAclConfiguration {
...
func (j *jsiiProxy_AthenaDatabase) Comment() *string {
	var returns *string
	_jsii_.Get(
		j,
		"comment",
...
func (j *jsiiProxy_AthenaDatabase) CommentInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"commentInput",
...
func (j *jsiiProxy_AthenaDatabase) ExpectedBucketOwner() *string {
	var returns *string
	_jsii_.Get(
		j,
		"expectedBucketOwner",
...
func (j *jsiiProxy_AthenaDatabase) ExpectedBucketOwnerInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AthenaDatabase) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_AthenaDatabase) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_AthenaDatabase) Properties() *map[string]*string {
...
func (j *jsiiProxy_AthenaDatabase) PropertiesInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"propertiesInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/athena_database aws_athena_database} Resource.
func NewAthenaDatabase(scope constructs.Construct, id *string, config *AthenaDatabaseConfig) AthenaDatabase {
	_init_.Initialize()

	if err := validateNewAthenaDatabaseParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func AthenaDatabase_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateAthenaDatabase_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_AthenaDatabase) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_AthenaDatabase) PutAclConfiguration(value *AthenaDatabaseAclConfiguration) {
...
func (a *jsiiProxy_AthenaDatabase) ResetAclConfiguration() {
	_jsii_.InvokeVoid(
		a,
		"resetAclConfiguration",
		nil, // no parameters
...
func (a *jsiiProxy_AthenaDatabase) ResetBucket() {
	_jsii_.InvokeVoid(
		a,
		"resetBucket",
		nil, // no parameters
...
func (a *jsiiProxy_AthenaDatabase) ResetComment() {
	_jsii_.InvokeVoid(
		a,
		"resetComment",
		nil, // no parameters
...
func (a *jsiiProxy_AthenaDatabase) ResetExpectedBucketOwner() {
	_jsii_.InvokeVoid(
		a,
		"resetExpectedBucketOwner",
		nil, // no parameters
...
func (a *jsiiProxy_AthenaDatabase) ResetId() {
	_jsii_.InvokeVoid(
		a,
		"resetId",
		nil, // no parameters
...
func (a *jsiiProxy_AthenaDatabase) ResetProperties() {
	_jsii_.InvokeVoid(
		a,
		"resetProperties",
		nil, // no parameters
