...
func init() {
	_jsii_.RegisterClass(
		"aws.dataAwsVerifiedpermissionsPolicyStore.DataAwsVerifiedpermissionsPolicyStore",
	...
	_jsii_.RegisterStruct(
		"aws.dataAwsVerifiedpermissionsPolicyStore.DataAwsVerifiedpermissionsPolicyStoreValidationSettings",
