...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/securityhuborganizationadminaccount/internal"
...
func NewSecurityhubOrganizationAdminAccount(scope constructs.Construct, id *string, config *SecurityhubOrganizationAdminAccountConfig) SecurityhubOrganizationAdminAccount {
	...
	_jsii_.Create(
		"aws.securityhubOrganizationAdminAccount.SecurityhubOrganizationAdminAccount",
