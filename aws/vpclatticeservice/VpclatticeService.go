...
type VpclatticeService interface {
	...
	DnsEntry() VpclatticeServiceDnsEntryList
	// Experimental.
	...
	PutTimeouts(value *VpclatticeServiceTimeouts)
	ResetAuthType()
	ResetCertificateArn()
...
func (j *jsiiProxy_VpclatticeService) DnsEntry() VpclatticeServiceDnsEntryList {
	var returns VpclatticeServiceDnsEntryList
	_jsii_.Get(
		j,
		"dnsEntry",
		&returns,
...
func (j *jsiiProxy_VpclatticeService) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_VpclatticeService) Tags() *map[string]*string {
...
func (j *jsiiProxy_VpclatticeService) TagsAll() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAll",
...
func (j *jsiiProxy_VpclatticeService) TagsAllInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAllInput",
...
func (j *jsiiProxy_VpclatticeService) TagsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsInput",
...
func (j *jsiiProxy_VpclatticeService) Timeouts() VpclatticeServiceTimeoutsOutputReference {
	var returns VpclatticeServiceTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func (j *jsiiProxy_VpclatticeService) TimeoutsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"timeoutsInput",
...
func NewVpclatticeService(scope constructs.Construct, id *string, config *VpclatticeServiceConfig) VpclatticeService {
	...
	_jsii_.Create(
		"aws.vpclatticeService.VpclatticeService",
...
func (j *jsiiProxy_VpclatticeService)SetId(val *string) {
...
func (j *jsiiProxy_VpclatticeService)SetTags(val *map[string]*string) {
...
func (j *jsiiProxy_VpclatticeService)SetTagsAll(val *map[string]*string) {
...
func (v *jsiiProxy_VpclatticeService) PutTimeouts(value *VpclatticeServiceTimeouts) {
...
func (v *jsiiProxy_VpclatticeService) ResetId() {
	_jsii_.InvokeVoid(
		v,
		"resetId",
		nil, // no parameters
...
func (v *jsiiProxy_VpclatticeService) ResetTagsAll() {
	_jsii_.InvokeVoid(
		v,
		"resetTagsAll",
		nil, // no parameters
...
func (v *jsiiProxy_VpclatticeService) ResetTimeouts() {
	_jsii_.InvokeVoid(
		v,
		"resetTimeouts",
		nil, // no parameters
