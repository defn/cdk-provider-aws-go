...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/datasynclocationefs/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/datasync_location_efs aws_datasync_location_efs} Resource.
...
func DatasyncLocationEfs_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDatasyncLocationEfs_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DatasyncLocationEfs) AddMoveTarget(moveTarget *string) {
...
func (d *jsiiProxy_DatasyncLocationEfs) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (d *jsiiProxy_DatasyncLocationEfs) MoveFromId(id *string) {
...
func (d *jsiiProxy_DatasyncLocationEfs) MoveToId(id *string) {
