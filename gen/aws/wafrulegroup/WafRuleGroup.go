...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/wafrulegroup/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/waf_rule_group aws_waf_rule_group}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/waf_rule_group aws_waf_rule_group} Resource.
...
func WafRuleGroup_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateWafRuleGroup_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (w *jsiiProxy_WafRuleGroup) AddMoveTarget(moveTarget *string) {
...
func (w *jsiiProxy_WafRuleGroup) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (w *jsiiProxy_WafRuleGroup) MoveFromId(id *string) {
...
func (w *jsiiProxy_WafRuleGroup) MoveToId(id *string) {
