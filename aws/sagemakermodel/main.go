...
func init() {
	...
	_jsii_.RegisterStruct(
		"aws.sagemakerModel.SagemakerModelContainerModelDataSourceS3DataSource",
		reflect.TypeOf((*SagemakerModelContainerModelDataSourceS3DataSource)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"aws.sagemakerModel.SagemakerModelContainerModelDataSourceS3DataSourceList",
	...
	_jsii_.RegisterClass(
		"aws.sagemakerModel.SagemakerModelPrimaryContainerModelDataSourceS3DataSourceOutputReference",
