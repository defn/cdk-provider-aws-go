...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/sfnstatemachine/internal"
...
func (j *jsiiProxy_SfnStateMachine) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewSfnStateMachine(scope constructs.Construct, id *string, config *SfnStateMachineConfig) SfnStateMachine {
	...
	if err := validateNewSfnStateMachineParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_SfnStateMachine) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_SfnStateMachine) MoveFromId(id *string) {
...
func (s *jsiiProxy_SfnStateMachine) MoveToId(id *string) {
...
func (s *jsiiProxy_SfnStateMachine) ResetId() {
	_jsii_.InvokeVoid(
		s,
		"resetId",
		nil, // no parameters
