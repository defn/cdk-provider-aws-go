...
func NewWafRegexMatchSetRegexMatchTupleFieldToMatchOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) WafRegexMatchSetRegexMatchTupleFieldToMatchOutputReference {
	...
	_jsii_.Create(
		"aws.wafRegexMatchSet.WafRegexMatchSetRegexMatchTupleFieldToMatchOutputReference",
...
func (w *jsiiProxy_WafRegexMatchSetRegexMatchTupleFieldToMatchOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
