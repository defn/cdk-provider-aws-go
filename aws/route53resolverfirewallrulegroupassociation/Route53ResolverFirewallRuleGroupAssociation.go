...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/route53resolverfirewallrulegroupassociation/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/route53_resolver_firewall_rule_group_association aws_route53_resolver_firewall_rule_group_association}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/route53_resolver_firewall_rule_group_association aws_route53_resolver_firewall_rule_group_association} Resource.
func NewRoute53ResolverFirewallRuleGroupAssociation(scope constructs.Construct, id *string, config *Route53ResolverFirewallRuleGroupAssociationConfig) Route53ResolverFirewallRuleGroupAssociation {
	...
	_jsii_.Create(
		"aws.route53ResolverFirewallRuleGroupAssociation.Route53ResolverFirewallRuleGroupAssociation",
...
func Route53ResolverFirewallRuleGroupAssociation_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateRoute53ResolverFirewallRuleGroupAssociation_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (r *jsiiProxy_Route53ResolverFirewallRuleGroupAssociation) AddMoveTarget(moveTarget *string) {
...
func (r *jsiiProxy_Route53ResolverFirewallRuleGroupAssociation) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (r *jsiiProxy_Route53ResolverFirewallRuleGroupAssociation) MoveFromId(id *string) {
...
func (r *jsiiProxy_Route53ResolverFirewallRuleGroupAssociation) MoveToId(id *string) {
