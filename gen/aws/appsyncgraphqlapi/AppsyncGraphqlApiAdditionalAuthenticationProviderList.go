...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/appsyncgraphqlapi/internal"
...
func (a *jsiiProxy_AppsyncGraphqlApiAdditionalAuthenticationProviderList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
