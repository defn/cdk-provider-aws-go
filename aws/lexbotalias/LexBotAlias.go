...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/lexbotalias/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/lex_bot_alias aws_lex_bot_alias} Resource.
...
func (l *jsiiProxy_LexBotAlias) MoveFromId(id *string) {
...
func (l *jsiiProxy_LexBotAlias) MoveToId(id *string) {
