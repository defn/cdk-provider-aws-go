...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/pinpointapnsvoipchannel/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/pinpoint_apns_voip_channel aws_pinpoint_apns_voip_channel} Resource.
func NewPinpointApnsVoipChannel(scope constructs.Construct, id *string, config *PinpointApnsVoipChannelConfig) PinpointApnsVoipChannel {
	...
	if err := validateNewPinpointApnsVoipChannelParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func PinpointApnsVoipChannel_IsConstruct(x interface{}) *bool {
	...
	if err := validatePinpointApnsVoipChannel_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func PinpointApnsVoipChannel_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validatePinpointApnsVoipChannel_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func PinpointApnsVoipChannel_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validatePinpointApnsVoipChannel_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (p *jsiiProxy_PinpointApnsVoipChannel) AddMoveTarget(moveTarget *string) {
...
func (p *jsiiProxy_PinpointApnsVoipChannel) HasResourceMove() interface{} {
	var returns interface{}
...
func (p *jsiiProxy_PinpointApnsVoipChannel) MoveFromId(id *string) {
...
func (p *jsiiProxy_PinpointApnsVoipChannel) MoveTo(moveTarget *string, index interface{}) {
...
func (p *jsiiProxy_PinpointApnsVoipChannel) MoveToId(id *string) {
...
func (p *jsiiProxy_PinpointApnsVoipChannel) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (p *jsiiProxy_PinpointApnsVoipChannel) ToHclTerraform() interface{} {
	var returns interface{}
