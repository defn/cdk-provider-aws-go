...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/macie2findingsfilter/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/macie2_findings_filter aws_macie2_findings_filter} Resource.
...
func Macie2FindingsFilter_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateMacie2FindingsFilter_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (m *jsiiProxy_Macie2FindingsFilter) AddMoveTarget(moveTarget *string) {
...
func (m *jsiiProxy_Macie2FindingsFilter) HasResourceMove() interface{} {
	var returns interface{}
...
func (m *jsiiProxy_Macie2FindingsFilter) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (m *jsiiProxy_Macie2FindingsFilter) MoveFromId(id *string) {
...
func (m *jsiiProxy_Macie2FindingsFilter) MoveTo(moveTarget *string, index interface{}) {
...
func (m *jsiiProxy_Macie2FindingsFilter) MoveToId(id *string) {
...
func (m *jsiiProxy_Macie2FindingsFilter) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (m *jsiiProxy_Macie2FindingsFilter) ToHclTerraform() interface{} {
	var returns interface{}
