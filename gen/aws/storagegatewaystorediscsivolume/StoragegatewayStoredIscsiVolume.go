...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/storagegatewaystorediscsivolume/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/storagegateway_stored_iscsi_volume aws_storagegateway_stored_iscsi_volume} Resource.
func NewStoragegatewayStoredIscsiVolume(scope constructs.Construct, id *string, config *StoragegatewayStoredIscsiVolumeConfig) StoragegatewayStoredIscsiVolume {
	...
	_jsii_.Create(
		"aws.storagegatewayStoredIscsiVolume.StoragegatewayStoredIscsiVolume",
...
func StoragegatewayStoredIscsiVolume_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
