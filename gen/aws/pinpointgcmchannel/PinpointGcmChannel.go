...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/pinpointgcmchannel/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/pinpoint_gcm_channel aws_pinpoint_gcm_channel} Resource.
...
func PinpointGcmChannel_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validatePinpointGcmChannel_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (p *jsiiProxy_PinpointGcmChannel) AddMoveTarget(moveTarget *string) {
