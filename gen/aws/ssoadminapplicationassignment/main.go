...
func init() {
	_jsii_.RegisterClass(
		"aws.ssoadminApplicationAssignment.SsoadminApplicationAssignment",
		reflect.TypeOf((*SsoadminApplicationAssignment)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"aws.ssoadminApplicationAssignment.SsoadminApplicationAssignmentConfig",
		reflect.TypeOf((*SsoadminApplicationAssignmentConfig)(nil)).Elem(),
	)
}
