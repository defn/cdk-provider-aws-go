...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/dataawskmsciphertext/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/data-sources/kms_ciphertext aws_kms_ciphertext} Data Source.
...
func DataAwsKmsCiphertext_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsKmsCiphertext_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
// Experimental.
func DataAwsKmsCiphertext_IsTerraformDataSource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsKmsCiphertext_IsTerraformDataSourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAwsKmsCiphertext_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsKmsCiphertext_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataAwsKmsCiphertext) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataAwsKmsCiphertext) ToHclTerraform() interface{} {
	var returns interface{}
