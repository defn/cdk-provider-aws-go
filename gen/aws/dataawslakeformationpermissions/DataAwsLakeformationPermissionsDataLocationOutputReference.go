...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/dataawslakeformationpermissions/internal"
...
func NewDataAwsLakeformationPermissionsDataLocationOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) DataAwsLakeformationPermissionsDataLocationOutputReference {
	...
	if err := validateNewDataAwsLakeformationPermissionsDataLocationOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
