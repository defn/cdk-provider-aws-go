...
func NewSecuritylakeAwsLogSourceSourceOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) SecuritylakeAwsLogSourceSourceOutputReference {
	...
	_jsii_.Create(
		"aws.securitylakeAwsLogSource.SecuritylakeAwsLogSourceSourceOutputReference",
...
func (s *jsiiProxy_SecuritylakeAwsLogSourceSourceOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SecuritylakeAwsLogSourceSourceOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
