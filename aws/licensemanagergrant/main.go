...
func init() {
	_jsii_.RegisterClass(
		"aws.licensemanagerGrant.LicensemanagerGrant",
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "allowedOperationsInput", GoGetter: "AllowedOperationsInput"},
	...
	_jsii_.RegisterStruct(
		"aws.licensemanagerGrant.LicensemanagerGrantConfig",
