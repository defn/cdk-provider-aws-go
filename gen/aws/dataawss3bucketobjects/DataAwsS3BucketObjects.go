...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/dataawss3bucketobjects/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/data-sources/s3_bucket_objects aws_s3_bucket_objects}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/data-sources/s3_bucket_objects aws_s3_bucket_objects} Data Source.
func NewDataAwsS3BucketObjects(scope constructs.Construct, id *string, config *DataAwsS3BucketObjectsConfig) DataAwsS3BucketObjects {
	...
	_jsii_.Create(
		"aws.dataAwsS3BucketObjects.DataAwsS3BucketObjects",
