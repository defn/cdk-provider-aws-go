...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/dataawswafwebacl/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/data-sources/waf_web_acl aws_waf_web_acl} Data Source.
...
func DataAwsWafWebAcl_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsWafWebAcl_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
// Experimental.
func DataAwsWafWebAcl_IsTerraformDataSource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsWafWebAcl_IsTerraformDataSourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAwsWafWebAcl_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsWafWebAcl_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataAwsWafWebAcl) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataAwsWafWebAcl) ToHclTerraform() interface{} {
	var returns interface{}
