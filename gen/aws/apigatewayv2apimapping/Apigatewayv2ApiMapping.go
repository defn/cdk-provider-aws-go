...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/apigatewayv2apimapping/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/apigatewayv2_api_mapping aws_apigatewayv2_api_mapping} Resource.
func NewApigatewayv2ApiMapping(scope constructs.Construct, id *string, config *Apigatewayv2ApiMappingConfig) Apigatewayv2ApiMapping {
	...
	_jsii_.Create(
		"aws.apigatewayv2ApiMapping.Apigatewayv2ApiMapping",
