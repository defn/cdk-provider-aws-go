...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/dataawsapigatewaydomainname/internal"
...
func NewDataAwsApiGatewayDomainNameEndpointConfigurationList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsApiGatewayDomainNameEndpointConfigurationList {
	...
	if err := validateNewDataAwsApiGatewayDomainNameEndpointConfigurationListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsApiGatewayDomainNameEndpointConfigurationList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
