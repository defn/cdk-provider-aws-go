...
func init() {
	...
	_jsii_.RegisterStruct(
		"aws.dataAwsRedshiftCluster.DataAwsRedshiftClusterClusterNodes",
		reflect.TypeOf((*DataAwsRedshiftClusterClusterNodes)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"aws.dataAwsRedshiftCluster.DataAwsRedshiftClusterClusterNodesList",
	...
	_jsii_.RegisterClass(
		"aws.dataAwsRedshiftCluster.DataAwsRedshiftClusterClusterNodesOutputReference",
	...
	_jsii_.RegisterStruct(
		"aws.dataAwsRedshiftCluster.DataAwsRedshiftClusterConfig",
