...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/elasticbeanstalkenvironment/internal"
...
func NewElasticBeanstalkEnvironmentSettingList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ElasticBeanstalkEnvironmentSettingList {
	...
	if err := validateNewElasticBeanstalkEnvironmentSettingListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (e *jsiiProxy_ElasticBeanstalkEnvironmentSettingList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
