...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/lightsailbucket/internal"
...
func (j *jsiiProxy_LightsailBucket) ForceDelete() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"forceDelete",
...
func (j *jsiiProxy_LightsailBucket) ForceDeleteInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"forceDeleteInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/lightsail_bucket aws_lightsail_bucket} Resource.
func NewLightsailBucket(scope constructs.Construct, id *string, config *LightsailBucketConfig) LightsailBucket {
	...
	_jsii_.Create(
		"aws.lightsailBucket.LightsailBucket",
...
func (j *jsiiProxy_LightsailBucket)SetForceDelete(val interface{}) {
...
func (l *jsiiProxy_LightsailBucket) MoveFromId(id *string) {
...
func (l *jsiiProxy_LightsailBucket) MoveToId(id *string) {
...
func (l *jsiiProxy_LightsailBucket) ResetForceDelete() {
	_jsii_.InvokeVoid(
		l,
		"resetForceDelete",
		nil, // no parameters
