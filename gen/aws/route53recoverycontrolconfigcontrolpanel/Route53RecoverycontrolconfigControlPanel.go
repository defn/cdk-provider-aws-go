...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/route53recoverycontrolconfigcontrolpanel/internal"
...
func (j *jsiiProxy_Route53RecoverycontrolconfigControlPanel) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/route53recoverycontrolconfig_control_panel aws_route53recoverycontrolconfig_control_panel} Resource.
func NewRoute53RecoverycontrolconfigControlPanel(scope constructs.Construct, id *string, config *Route53RecoverycontrolconfigControlPanelConfig) Route53RecoverycontrolconfigControlPanel {
	...
	if err := validateNewRoute53RecoverycontrolconfigControlPanelParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (r *jsiiProxy_Route53RecoverycontrolconfigControlPanel) AddMoveTarget(moveTarget *string) {
...
func (r *jsiiProxy_Route53RecoverycontrolconfigControlPanel) ResetId() {
	_jsii_.InvokeVoid(
		r,
		"resetId",
		nil, // no parameters
