...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/customerprofilesprofile/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/customerprofiles_profile aws_customerprofiles_profile} Resource.
func NewCustomerprofilesProfile(scope constructs.Construct, id *string, config *CustomerprofilesProfileConfig) CustomerprofilesProfile {
	...
	_jsii_.Create(
		"aws.customerprofilesProfile.CustomerprofilesProfile",
