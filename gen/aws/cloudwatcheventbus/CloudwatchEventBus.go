...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/cloudwatcheventbus/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/cloudwatch_event_bus aws_cloudwatch_event_bus} Resource.
...
func CloudwatchEventBus_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateCloudwatchEventBus_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_CloudwatchEventBus) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_CloudwatchEventBus) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (c *jsiiProxy_CloudwatchEventBus) MoveFromId(id *string) {
...
func (c *jsiiProxy_CloudwatchEventBus) MoveToId(id *string) {
