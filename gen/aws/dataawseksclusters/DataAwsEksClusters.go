...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/dataawseksclusters/internal"
...
func (j *jsiiProxy_DataAwsEksClusters) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsEksClusters) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewDataAwsEksClusters(scope constructs.Construct, id *string, config *DataAwsEksClustersConfig) DataAwsEksClusters {
	...
	if err := validateNewDataAwsEksClustersParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_DataAwsEksClusters{}

	_jsii_.Create(
		"aws.dataAwsEksClusters.DataAwsEksClusters",
...
func (j *jsiiProxy_DataAwsEksClusters)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsEksClusters)SetId(val *string) {
...
func DataAwsEksClusters_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsEksClusters_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func DataAwsEksClusters_IsConstruct(x interface{}) *bool {
	...
	if err := validateDataAwsEksClusters_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAwsEksClusters_IsTerraformDataSource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsEksClusters_IsTerraformDataSourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAwsEksClusters_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsEksClusters_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataAwsEksClusters) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsEksClusters) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataAwsEksClusters) ToHclTerraform() interface{} {
	var returns interface{}
