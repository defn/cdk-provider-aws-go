...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/sagemakerworkteam/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/sagemaker_workteam aws_sagemaker_workteam}.
...
func (j *jsiiProxy_SagemakerWorkteam) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_SagemakerWorkteam) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_SagemakerWorkteam) MemberDefinition() SagemakerWorkteamMemberDefinitionList {
	var returns SagemakerWorkteamMemberDefinitionList
	_jsii_.Get(
		j,
		"memberDefinition",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/sagemaker_workteam aws_sagemaker_workteam} Resource.
func NewSagemakerWorkteam(scope constructs.Construct, id *string, config *SagemakerWorkteamConfig) SagemakerWorkteam {
	_init_.Initialize()

	if err := validateNewSagemakerWorkteamParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func SagemakerWorkteam_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateSagemakerWorkteam_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_SagemakerWorkteam) AddMoveTarget(moveTarget *string) {
