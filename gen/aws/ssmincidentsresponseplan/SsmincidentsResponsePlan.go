...
type SsmincidentsResponsePlan interface {
	...
	ActionInput() *SsmincidentsResponsePlanAction
	Arn() *string
	// Experimental.
	CdktfStack() cdktf.TerraformStack
	ChatChannel() *[]*string
	SetChatChannel(val *[]*string)
	ChatChannelInput() *[]*string
	// Experimental.
	...
	IncidentTemplateInput() *SsmincidentsResponsePlanIncidentTemplate
	Integration() SsmincidentsResponsePlanIntegrationOutputReference
	IntegrationInput() *SsmincidentsResponsePlanIntegration
	// Experimental.
	...
	PutAction(value *SsmincidentsResponsePlanAction)
	PutIncidentTemplate(value *SsmincidentsResponsePlanIncidentTemplate)
	PutIntegration(value *SsmincidentsResponsePlanIntegration)
	ResetAction()
	ResetChatChannel()
	ResetDisplayName()
	ResetEngagements()
...
func (j *jsiiProxy_SsmincidentsResponsePlan) Action() SsmincidentsResponsePlanActionOutputReference {
	var returns SsmincidentsResponsePlanActionOutputReference
	_jsii_.Get(
		j,
		"action",
		&returns,
...
func (j *jsiiProxy_SsmincidentsResponsePlan) ActionInput() *SsmincidentsResponsePlanAction {
...
func (j *jsiiProxy_SsmincidentsResponsePlan) ChatChannel() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"chatChannel",
...
func (j *jsiiProxy_SsmincidentsResponsePlan) ChatChannelInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"chatChannelInput",
...
func (j *jsiiProxy_SsmincidentsResponsePlan) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_SsmincidentsResponsePlan) IncidentTemplateInput() *SsmincidentsResponsePlanIncidentTemplate {
...
func (j *jsiiProxy_SsmincidentsResponsePlan) Integration() SsmincidentsResponsePlanIntegrationOutputReference {
	var returns SsmincidentsResponsePlanIntegrationOutputReference
	_jsii_.Get(
		j,
		"integration",
		&returns,
...
func (j *jsiiProxy_SsmincidentsResponsePlan) IntegrationInput() *SsmincidentsResponsePlanIntegration {
...
func (j *jsiiProxy_SsmincidentsResponsePlan) TagsAll() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAll",
...
func (j *jsiiProxy_SsmincidentsResponsePlan) TagsAllInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAllInput",
...
func (j *jsiiProxy_SsmincidentsResponsePlan) TagsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/ssmincidents_response_plan aws_ssmincidents_response_plan} Resource.
func NewSsmincidentsResponsePlan(scope constructs.Construct, id *string, config *SsmincidentsResponsePlanConfig) SsmincidentsResponsePlan {
	...
	_jsii_.Create(
		"aws.ssmincidentsResponsePlan.SsmincidentsResponsePlan",
...
func (j *jsiiProxy_SsmincidentsResponsePlan)SetChatChannel(val *[]*string) {
	if err := j.validateSetChatChannelParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_SsmincidentsResponsePlan)SetId(val *string) {
...
func (j *jsiiProxy_SsmincidentsResponsePlan)SetTags(val *map[string]*string) {
...
func (j *jsiiProxy_SsmincidentsResponsePlan)SetTagsAll(val *map[string]*string) {
...
func (s *jsiiProxy_SsmincidentsResponsePlan) PutAction(value *SsmincidentsResponsePlanAction) {
...
func (s *jsiiProxy_SsmincidentsResponsePlan) PutIntegration(value *SsmincidentsResponsePlanIntegration) {
	if err := s.validatePutIntegrationParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		s,
...
func (s *jsiiProxy_SsmincidentsResponsePlan) ResetAction() {
	_jsii_.InvokeVoid(
		s,
		"resetAction",
		nil, // no parameters
...
func (s *jsiiProxy_SsmincidentsResponsePlan) ResetId() {
	_jsii_.InvokeVoid(
		s,
		"resetId",
		nil, // no parameters
...
func (s *jsiiProxy_SsmincidentsResponsePlan) ResetIntegration() {
	_jsii_.InvokeVoid(
		s,
		"resetIntegration",
		nil, // no parameters
...
func (s *jsiiProxy_SsmincidentsResponsePlan) ResetTagsAll() {
	_jsii_.InvokeVoid(
		s,
		"resetTagsAll",
		nil, // no parameters
