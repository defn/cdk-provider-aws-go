...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/dataawsbackupplan/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/data-sources/backup_plan aws_backup_plan} Data Source.
func NewDataAwsBackupPlan(scope constructs.Construct, id *string, config *DataAwsBackupPlanConfig) DataAwsBackupPlan {
	...
	_jsii_.Create(
		"aws.dataAwsBackupPlan.DataAwsBackupPlan",
