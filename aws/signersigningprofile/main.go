...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "putSigningMaterial", GoMethod: "PutSigningMaterial"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetSigningMaterial", GoMethod: "ResetSigningMaterial"},
			...
			_jsii_.MemberProperty{JsiiProperty: "signingMaterial", GoGetter: "SigningMaterial"},
			_jsii_.MemberProperty{JsiiProperty: "signingMaterialInput", GoGetter: "SigningMaterialInput"},
	...
	_jsii_.RegisterClass(
		"aws.signerSigningProfile.SignerSigningProfileSigningMaterialOutputReference",
