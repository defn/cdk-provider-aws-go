...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/timestreamwritedatabase/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/timestreamwrite_database aws_timestreamwrite_database} Resource.
...
func TimestreamwriteDatabase_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateTimestreamwriteDatabase_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
// Experimental.
func TimestreamwriteDatabase_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateTimestreamwriteDatabase_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func TimestreamwriteDatabase_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateTimestreamwriteDatabase_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (t *jsiiProxy_TimestreamwriteDatabase) AddMoveTarget(moveTarget *string) {
...
func (t *jsiiProxy_TimestreamwriteDatabase) HasResourceMove() interface{} {
	var returns interface{}
...
func (t *jsiiProxy_TimestreamwriteDatabase) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (t *jsiiProxy_TimestreamwriteDatabase) MoveFromId(id *string) {
...
func (t *jsiiProxy_TimestreamwriteDatabase) MoveTo(moveTarget *string, index interface{}) {
...
func (t *jsiiProxy_TimestreamwriteDatabase) MoveToId(id *string) {
...
func (t *jsiiProxy_TimestreamwriteDatabase) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (t *jsiiProxy_TimestreamwriteDatabase) ToHclTerraform() interface{} {
	var returns interface{}
