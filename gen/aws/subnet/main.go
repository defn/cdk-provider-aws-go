...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "enableLniAtDeviceIndexInput", GoGetter: "EnableLniAtDeviceIndexInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetEnableLniAtDeviceIndex", GoMethod: "ResetEnableLniAtDeviceIndex"},
