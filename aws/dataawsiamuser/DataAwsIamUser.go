...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/dataawsiamuser/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/data-sources/iam_user aws_iam_user}.
...
func (j *jsiiProxy_DataAwsIamUser) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsIamUser) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/data-sources/iam_user aws_iam_user} Data Source.
func NewDataAwsIamUser(scope constructs.Construct, id *string, config *DataAwsIamUserConfig) DataAwsIamUser {
	_init_.Initialize()

	if err := validateNewDataAwsIamUserParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_DataAwsIamUser{}

	_jsii_.Create(
		"aws.dataAwsIamUser.DataAwsIamUser",
...
func (j *jsiiProxy_DataAwsIamUser)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsIamUser)SetId(val *string) {
...
func DataAwsIamUser_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsIamUser_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func DataAwsIamUser_IsConstruct(x interface{}) *bool {
	...
	if err := validateDataAwsIamUser_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAwsIamUser_IsTerraformDataSource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsIamUser_IsTerraformDataSourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAwsIamUser_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsIamUser_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataAwsIamUser) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsIamUser) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataAwsIamUser) ToHclTerraform() interface{} {
	var returns interface{}
