...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/neptuneglobalcluster/internal"
...
func (n *jsiiProxy_NeptuneGlobalClusterGlobalClusterMembersList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
