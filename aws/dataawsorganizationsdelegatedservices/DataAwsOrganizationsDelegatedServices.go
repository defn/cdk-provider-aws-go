...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/dataawsorganizationsdelegatedservices/internal"
...
func DataAwsOrganizationsDelegatedServices_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsOrganizationsDelegatedServices_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
// Experimental.
func DataAwsOrganizationsDelegatedServices_IsTerraformDataSource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsOrganizationsDelegatedServices_IsTerraformDataSourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAwsOrganizationsDelegatedServices_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsOrganizationsDelegatedServices_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataAwsOrganizationsDelegatedServices) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataAwsOrganizationsDelegatedServices) ToHclTerraform() interface{} {
	var returns interface{}
