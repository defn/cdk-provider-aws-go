...
func NewDataAwsVpclatticeServiceDnsEntryList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsVpclatticeServiceDnsEntryList {
	...
	_jsii_.Create(
		"aws.dataAwsVpclatticeService.DataAwsVpclatticeServiceDnsEntryList",
...
func (d *jsiiProxy_DataAwsVpclatticeServiceDnsEntryList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
