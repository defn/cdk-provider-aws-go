...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/iamgroupmembership/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/iam_group_membership aws_iam_group_membership} Resource.
...
func IamGroupMembership_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateIamGroupMembership_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (i *jsiiProxy_IamGroupMembership) AddMoveTarget(moveTarget *string) {
