...
func init() {
	...
	_jsii_.RegisterStruct(
		"aws.ssoadminCustomerManagedPolicyAttachment.SsoadminCustomerManagedPolicyAttachmentTimeouts",
		reflect.TypeOf((*SsoadminCustomerManagedPolicyAttachmentTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"aws.ssoadminCustomerManagedPolicyAttachment.SsoadminCustomerManagedPolicyAttachmentTimeoutsOutputReference",
		reflect.TypeOf((*SsoadminCustomerManagedPolicyAttachmentTimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
