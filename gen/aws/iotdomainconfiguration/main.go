...
func init() {
	_jsii_.RegisterClass(
		"aws.iotDomainConfiguration.IotDomainConfiguration",
	...
	_jsii_.RegisterStruct(
		"aws.iotDomainConfiguration.IotDomainConfigurationAuthorizerConfig",
		reflect.TypeOf((*IotDomainConfigurationAuthorizerConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"aws.iotDomainConfiguration.IotDomainConfigurationAuthorizerConfigOutputReference",
	...
	_jsii_.RegisterStruct(
		"aws.iotDomainConfiguration.IotDomainConfigurationTlsConfig",
