...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/cloudwatcheventarchive/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/cloudwatch_event_archive aws_cloudwatch_event_archive}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/cloudwatch_event_archive aws_cloudwatch_event_archive} Resource.
...
func CloudwatchEventArchive_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateCloudwatchEventArchive_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_CloudwatchEventArchive) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_CloudwatchEventArchive) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (c *jsiiProxy_CloudwatchEventArchive) MoveFromId(id *string) {
...
func (c *jsiiProxy_CloudwatchEventArchive) MoveToId(id *string) {
