...
func (a *jsiiProxy_Alb) validatePutSubnetMappingParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*AlbSubnetMapping; received %#v (a %T)", value, value)
		}
	}
