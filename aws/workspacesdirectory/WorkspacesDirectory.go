...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/workspacesdirectory/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/workspaces_directory aws_workspaces_directory} Resource.
...
func (w *jsiiProxy_WorkspacesDirectory) AddMoveTarget(moveTarget *string) {
...
func (w *jsiiProxy_WorkspacesDirectory) MoveFromId(id *string) {
...
func (w *jsiiProxy_WorkspacesDirectory) MoveToId(id *string) {
