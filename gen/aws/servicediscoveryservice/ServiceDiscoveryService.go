...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/servicediscoveryservice/internal"
...
func NewServiceDiscoveryService(scope constructs.Construct, id *string, config *ServiceDiscoveryServiceConfig) ServiceDiscoveryService {
	...
	if err := validateNewServiceDiscoveryServiceParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func ServiceDiscoveryService_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateServiceDiscoveryService_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_ServiceDiscoveryService) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_ServiceDiscoveryService) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (s *jsiiProxy_ServiceDiscoveryService) MoveFromId(id *string) {
...
func (s *jsiiProxy_ServiceDiscoveryService) MoveToId(id *string) {
...
func (s *jsiiProxy_ServiceDiscoveryService) PutHealthCheckConfig(value *ServiceDiscoveryServiceHealthCheckConfig) {
	if err := s.validatePutHealthCheckConfigParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		s,
...
func (s *jsiiProxy_ServiceDiscoveryService) PutHealthCheckCustomConfig(value *ServiceDiscoveryServiceHealthCheckCustomConfig) {
	if err := s.validatePutHealthCheckCustomConfigParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		s,
