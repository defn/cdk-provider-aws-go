...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/appsyncdomainnameapiassociation/internal"
...
func (j *jsiiProxy_AppsyncDomainNameApiAssociation) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/appsync_domain_name_api_association aws_appsync_domain_name_api_association} Resource.
...
func (j *jsiiProxy_AppsyncDomainNameApiAssociation)SetCount(val interface{}) {
...
func AppsyncDomainNameApiAssociation_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateAppsyncDomainNameApiAssociation_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
// Experimental.
func AppsyncDomainNameApiAssociation_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateAppsyncDomainNameApiAssociation_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func AppsyncDomainNameApiAssociation_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateAppsyncDomainNameApiAssociation_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (a *jsiiProxy_AppsyncDomainNameApiAssociation) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_AppsyncDomainNameApiAssociation) HasResourceMove() interface{} {
	var returns interface{}
...
func (a *jsiiProxy_AppsyncDomainNameApiAssociation) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (a *jsiiProxy_AppsyncDomainNameApiAssociation) MoveFromId(id *string) {
...
func (a *jsiiProxy_AppsyncDomainNameApiAssociation) MoveTo(moveTarget *string, index interface{}) {
...
func (a *jsiiProxy_AppsyncDomainNameApiAssociation) MoveToId(id *string) {
...
func (a *jsiiProxy_AppsyncDomainNameApiAssociation) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (a *jsiiProxy_AppsyncDomainNameApiAssociation) ToHclTerraform() interface{} {
	var returns interface{}
