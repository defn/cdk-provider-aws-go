...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/sagemakermodelpackagegroup/internal"
...
func (j *jsiiProxy_SagemakerModelPackageGroup) Connection() interface{} {
...
func (j *jsiiProxy_SagemakerModelPackageGroup) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_SagemakerModelPackageGroup) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_SagemakerModelPackageGroup) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
func NewSagemakerModelPackageGroup(scope constructs.Construct, id *string, config *SagemakerModelPackageGroupConfig) SagemakerModelPackageGroup {
	...
	if err := validateNewSagemakerModelPackageGroupParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_SagemakerModelPackageGroup)SetConnection(val interface{}) {
...
func (j *jsiiProxy_SagemakerModelPackageGroup)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SagemakerModelPackageGroup)SetId(val *string) {
...
func (j *jsiiProxy_SagemakerModelPackageGroup)SetModelPackageGroupDescription(val *string) {
	if err := j.validateSetModelPackageGroupDescriptionParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_SagemakerModelPackageGroup)SetProvisioners(val *[]interface{}) {
...
func SagemakerModelPackageGroup_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateSagemakerModelPackageGroup_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func SagemakerModelPackageGroup_IsConstruct(x interface{}) *bool {
	...
	if err := validateSagemakerModelPackageGroup_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func SagemakerModelPackageGroup_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateSagemakerModelPackageGroup_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func SagemakerModelPackageGroup_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateSagemakerModelPackageGroup_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (s *jsiiProxy_SagemakerModelPackageGroup) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_SagemakerModelPackageGroup) ResetId() {
	_jsii_.InvokeVoid(
		s,
		"resetId",
		nil, // no parameters
...
func (s *jsiiProxy_SagemakerModelPackageGroup) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (s *jsiiProxy_SagemakerModelPackageGroup) ToHclTerraform() interface{} {
	var returns interface{}
