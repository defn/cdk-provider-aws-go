...
type OpsworksCustomLayerCloudwatchConfigurationOutputReference interface {
	...
	LogStreams() OpsworksCustomLayerCloudwatchConfigurationLogStreamsList
...
func (j *jsiiProxy_OpsworksCustomLayerCloudwatchConfigurationOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_OpsworksCustomLayerCloudwatchConfigurationOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_OpsworksCustomLayerCloudwatchConfigurationOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_OpsworksCustomLayerCloudwatchConfigurationOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_OpsworksCustomLayerCloudwatchConfigurationOutputReference) LogStreams() OpsworksCustomLayerCloudwatchConfigurationLogStreamsList {
	var returns OpsworksCustomLayerCloudwatchConfigurationLogStreamsList
	_jsii_.Get(
		j,
		"logStreams",
		&returns,
...
func NewOpsworksCustomLayerCloudwatchConfigurationOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) OpsworksCustomLayerCloudwatchConfigurationOutputReference {
	...
	if err := validateNewOpsworksCustomLayerCloudwatchConfigurationOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_OpsworksCustomLayerCloudwatchConfigurationOutputReference{}

	_jsii_.Create(
		"aws.opsworksCustomLayer.OpsworksCustomLayerCloudwatchConfigurationOutputReference",
...
func (j *jsiiProxy_OpsworksCustomLayerCloudwatchConfigurationOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_OpsworksCustomLayerCloudwatchConfigurationOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (o *jsiiProxy_OpsworksCustomLayerCloudwatchConfigurationOutputReference) ComputeFqn() *string {
	var returns *string
...
func (o *jsiiProxy_OpsworksCustomLayerCloudwatchConfigurationOutputReference) PutLogStreams(value interface{}) {
...
func (o *jsiiProxy_OpsworksCustomLayerCloudwatchConfigurationOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (o *jsiiProxy_OpsworksCustomLayerCloudwatchConfigurationOutputReference) ToString() *string {
	var returns *string
