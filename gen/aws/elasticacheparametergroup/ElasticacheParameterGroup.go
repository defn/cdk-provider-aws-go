...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/elasticacheparametergroup/internal"
...
func ElasticacheParameterGroup_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateElasticacheParameterGroup_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
// Experimental.
func ElasticacheParameterGroup_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateElasticacheParameterGroup_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func ElasticacheParameterGroup_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateElasticacheParameterGroup_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (e *jsiiProxy_ElasticacheParameterGroup) AddMoveTarget(moveTarget *string) {
...
func (e *jsiiProxy_ElasticacheParameterGroup) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (e *jsiiProxy_ElasticacheParameterGroup) ToHclTerraform() interface{} {
	var returns interface{}
