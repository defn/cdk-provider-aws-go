...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/dataawsconnectcontactflow/internal"
...
func (j *jsiiProxy_DataAwsConnectContactFlow) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsConnectContactFlow) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/data-sources/connect_contact_flow aws_connect_contact_flow} Data Source.
func NewDataAwsConnectContactFlow(scope constructs.Construct, id *string, config *DataAwsConnectContactFlowConfig) DataAwsConnectContactFlow {
	...
	if err := validateNewDataAwsConnectContactFlowParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataAwsConnectContactFlow_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsConnectContactFlow_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsConnectContactFlow) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
