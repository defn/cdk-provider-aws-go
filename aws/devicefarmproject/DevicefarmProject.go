...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/devicefarmproject/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/devicefarm_project aws_devicefarm_project} Resource.
func NewDevicefarmProject(scope constructs.Construct, id *string, config *DevicefarmProjectConfig) DevicefarmProject {
	...
	_jsii_.Create(
		"aws.devicefarmProject.DevicefarmProject",
...
func DevicefarmProject_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDevicefarmProject_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DevicefarmProject) AddMoveTarget(moveTarget *string) {
