...
func (s *jsiiProxy_ServicequotasServiceQuotaUsageMetricList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (s *jsiiProxy_ServicequotasServiceQuotaUsageMetricList) validateGetParameters(index *float64) error {
	if index == nil {
...
func (j *jsiiProxy_ServicequotasServiceQuotaUsageMetricList) validateSetTerraformAttributeParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_ServicequotasServiceQuotaUsageMetricList) validateSetWrapsSetParameters(val *bool) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
