...
func init() {
	...
	_jsii_.RegisterStruct(
		"aws.elasticacheUser.ElasticacheUserAuthenticationMode",
		reflect.TypeOf((*ElasticacheUserAuthenticationMode)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"aws.elasticacheUser.ElasticacheUserAuthenticationModeOutputReference",
	...
	_jsii_.RegisterStruct(
		"aws.elasticacheUser.ElasticacheUserConfig",
		reflect.TypeOf((*ElasticacheUserConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws.elasticacheUser.ElasticacheUserTimeouts",
