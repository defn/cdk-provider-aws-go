...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/route53recoverycontrolconfigcluster/internal"
...
func (j *jsiiProxy_Route53RecoverycontrolconfigCluster) ClusterEndpoints() Route53RecoverycontrolconfigClusterClusterEndpointsList {
	var returns Route53RecoverycontrolconfigClusterClusterEndpointsList
	_jsii_.Get(
		j,
		"clusterEndpoints",
		&returns,
...
func (j *jsiiProxy_Route53RecoverycontrolconfigCluster) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_Route53RecoverycontrolconfigCluster) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/route53recoverycontrolconfig_cluster aws_route53recoverycontrolconfig_cluster} Resource.
func NewRoute53RecoverycontrolconfigCluster(scope constructs.Construct, id *string, config *Route53RecoverycontrolconfigClusterConfig) Route53RecoverycontrolconfigCluster {
	...
	if err := validateNewRoute53RecoverycontrolconfigClusterParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func Route53RecoverycontrolconfigCluster_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateRoute53RecoverycontrolconfigCluster_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (r *jsiiProxy_Route53RecoverycontrolconfigCluster) AddMoveTarget(moveTarget *string) {
...
func (r *jsiiProxy_Route53RecoverycontrolconfigCluster) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (r *jsiiProxy_Route53RecoverycontrolconfigCluster) MoveFromId(id *string) {
...
func (r *jsiiProxy_Route53RecoverycontrolconfigCluster) MoveToId(id *string) {
...
func (r *jsiiProxy_Route53RecoverycontrolconfigCluster) ResetId() {
	_jsii_.InvokeVoid(
		r,
		"resetId",
		nil, // no parameters
