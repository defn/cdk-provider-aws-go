...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/detectiveinvitationaccepter/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/detective_invitation_accepter aws_detective_invitation_accepter} Resource.
...
func DetectiveInvitationAccepter_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDetectiveInvitationAccepter_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DetectiveInvitationAccepter) AddMoveTarget(moveTarget *string) {
...
func (d *jsiiProxy_DetectiveInvitationAccepter) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DetectiveInvitationAccepter) ToHclTerraform() interface{} {
	var returns interface{}
