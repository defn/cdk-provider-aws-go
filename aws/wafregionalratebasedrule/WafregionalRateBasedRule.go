...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/wafregionalratebasedrule/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/wafregional_rate_based_rule aws_wafregional_rate_based_rule} Resource.
...
func WafregionalRateBasedRule_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateWafregionalRateBasedRule_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (w *jsiiProxy_WafregionalRateBasedRule) AddMoveTarget(moveTarget *string) {
...
func (w *jsiiProxy_WafregionalRateBasedRule) HasResourceMove() interface{} {
	var returns interface{}
...
func (w *jsiiProxy_WafregionalRateBasedRule) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (w *jsiiProxy_WafregionalRateBasedRule) MoveFromId(id *string) {
...
func (w *jsiiProxy_WafregionalRateBasedRule) MoveTo(moveTarget *string, index interface{}) {
...
func (w *jsiiProxy_WafregionalRateBasedRule) MoveToId(id *string) {
...
func (w *jsiiProxy_WafregionalRateBasedRule) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (w *jsiiProxy_WafregionalRateBasedRule) ToHclTerraform() interface{} {
	var returns interface{}
