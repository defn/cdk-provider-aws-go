...
type SsoadminManagedPolicyAttachment interface {
	...
	Timeouts() SsoadminManagedPolicyAttachmentTimeoutsOutputReference
	...
	PutTimeouts(value *SsoadminManagedPolicyAttachmentTimeouts)
	ResetId()
...
func (j *jsiiProxy_SsoadminManagedPolicyAttachment) Timeouts() SsoadminManagedPolicyAttachmentTimeoutsOutputReference {
	var returns SsoadminManagedPolicyAttachmentTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func (j *jsiiProxy_SsoadminManagedPolicyAttachment) TimeoutsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"timeoutsInput",
...
func SsoadminManagedPolicyAttachment_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateSsoadminManagedPolicyAttachment_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
// Experimental.
func SsoadminManagedPolicyAttachment_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateSsoadminManagedPolicyAttachment_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func SsoadminManagedPolicyAttachment_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateSsoadminManagedPolicyAttachment_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (s *jsiiProxy_SsoadminManagedPolicyAttachment) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_SsoadminManagedPolicyAttachment) HasResourceMove() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_SsoadminManagedPolicyAttachment) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (s *jsiiProxy_SsoadminManagedPolicyAttachment) MoveFromId(id *string) {
...
func (s *jsiiProxy_SsoadminManagedPolicyAttachment) MoveTo(moveTarget *string, index interface{}) {
...
func (s *jsiiProxy_SsoadminManagedPolicyAttachment) MoveToId(id *string) {
...
func (s *jsiiProxy_SsoadminManagedPolicyAttachment) PutTimeouts(value *SsoadminManagedPolicyAttachmentTimeouts) {
...
func (s *jsiiProxy_SsoadminManagedPolicyAttachment) ResetTimeouts() {
	_jsii_.InvokeVoid(
		s,
		"resetTimeouts",
		nil, // no parameters
...
func (s *jsiiProxy_SsoadminManagedPolicyAttachment) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (s *jsiiProxy_SsoadminManagedPolicyAttachment) ToHclTerraform() interface{} {
	var returns interface{}
