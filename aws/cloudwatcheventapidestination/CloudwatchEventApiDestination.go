...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/cloudwatcheventapidestination/internal"
...
func CloudwatchEventApiDestination_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateCloudwatchEventApiDestination_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_CloudwatchEventApiDestination) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_CloudwatchEventApiDestination) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (c *jsiiProxy_CloudwatchEventApiDestination) MoveFromId(id *string) {
...
func (c *jsiiProxy_CloudwatchEventApiDestination) MoveToId(id *string) {
