...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/acmpcacertificateauthoritycertificate/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/acmpca_certificate_authority_certificate aws_acmpca_certificate_authority_certificate} Resource.
...
func AcmpcaCertificateAuthorityCertificate_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateAcmpcaCertificateAuthorityCertificate_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_AcmpcaCertificateAuthorityCertificate) AddMoveTarget(moveTarget *string) {
