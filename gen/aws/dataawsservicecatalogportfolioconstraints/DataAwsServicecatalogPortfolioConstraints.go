...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/dataawsservicecatalogportfolioconstraints/internal"
...
func (j *jsiiProxy_DataAwsServicecatalogPortfolioConstraints) Details() DataAwsServicecatalogPortfolioConstraintsDetailsList {
	var returns DataAwsServicecatalogPortfolioConstraintsDetailsList
	_jsii_.Get(
		j,
		"details",
		&returns,
...
func (j *jsiiProxy_DataAwsServicecatalogPortfolioConstraints) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsServicecatalogPortfolioConstraints) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DataAwsServicecatalogPortfolioConstraints) Timeouts() DataAwsServicecatalogPortfolioConstraintsTimeoutsOutputReference {
	var returns DataAwsServicecatalogPortfolioConstraintsTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/data-sources/servicecatalog_portfolio_constraints aws_servicecatalog_portfolio_constraints} Data Source.
func NewDataAwsServicecatalogPortfolioConstraints(scope constructs.Construct, id *string, config *DataAwsServicecatalogPortfolioConstraintsConfig) DataAwsServicecatalogPortfolioConstraints {
	...
	if err := validateNewDataAwsServicecatalogPortfolioConstraintsParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_DataAwsServicecatalogPortfolioConstraints{}

	_jsii_.Create(
		"aws.dataAwsServicecatalogPortfolioConstraints.DataAwsServicecatalogPortfolioConstraints",
...
func DataAwsServicecatalogPortfolioConstraints_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsServicecatalogPortfolioConstraints_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsServicecatalogPortfolioConstraints) PutTimeouts(value *DataAwsServicecatalogPortfolioConstraintsTimeouts) {
...
func (d *jsiiProxy_DataAwsServicecatalogPortfolioConstraints) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsServicecatalogPortfolioConstraints) ResetTimeouts() {
	_jsii_.InvokeVoid(
		d,
		"resetTimeouts",
		nil, // no parameters
