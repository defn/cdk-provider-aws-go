...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/data-sources/lb_listener aws_lb_listener}.
...
func (j *jsiiProxy_DataAwsLbListener) ArnInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"arnInput",
...
func (j *jsiiProxy_DataAwsLbListener) DefaultAction() DataAwsLbListenerDefaultActionList {
	var returns DataAwsLbListenerDefaultActionList
	_jsii_.Get(
		j,
		"defaultAction",
		&returns,
...
func (j *jsiiProxy_DataAwsLbListener) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsLbListener) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DataAwsLbListener) Tags() *map[string]*string {
...
func (j *jsiiProxy_DataAwsLbListener) TagsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsInput",
...
func (j *jsiiProxy_DataAwsLbListener) Timeouts() DataAwsLbListenerTimeoutsOutputReference {
	var returns DataAwsLbListenerTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/data-sources/lb_listener aws_lb_listener} Data Source.
func NewDataAwsLbListener(scope constructs.Construct, id *string, config *DataAwsLbListenerConfig) DataAwsLbListener {
	_init_.Initialize()

	if err := validateNewDataAwsLbListenerParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataAwsLbListener_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsLbListener_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsLbListener) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DataAwsLbListener) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DataAwsLbListener) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DataAwsLbListener) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DataAwsLbListener) PutTimeouts(value *DataAwsLbListenerTimeouts) {
...
func (d *jsiiProxy_DataAwsLbListener) ResetArn() {
	_jsii_.InvokeVoid(
		d,
		"resetArn",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsLbListener) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsLbListener) ResetTimeouts() {
	_jsii_.InvokeVoid(
		d,
		"resetTimeouts",
		nil, // no parameters
