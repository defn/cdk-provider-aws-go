...
func init() {
	...
	_jsii_.RegisterStruct(
		"aws.signerSigningJob.SignerSigningJobConfig",
		reflect.TypeOf((*SignerSigningJobConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws.signerSigningJob.SignerSigningJobDestination",
	...
	_jsii_.RegisterStruct(
		"aws.signerSigningJob.SignerSigningJobDestinationS3",
		reflect.TypeOf((*SignerSigningJobDestinationS3)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"aws.signerSigningJob.SignerSigningJobDestinationS3OutputReference",
	...
	_jsii_.RegisterStruct(
		"aws.signerSigningJob.SignerSigningJobRevocationRecord",
	...
	_jsii_.RegisterStruct(
		"aws.signerSigningJob.SignerSigningJobSignedObject",
		reflect.TypeOf((*SignerSigningJobSignedObject)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"aws.signerSigningJob.SignerSigningJobSignedObjectList",
	...
	_jsii_.RegisterStruct(
		"aws.signerSigningJob.SignerSigningJobSignedObjectS3",
	...
	_jsii_.RegisterStruct(
		"aws.signerSigningJob.SignerSigningJobSource",
	...
	_jsii_.RegisterStruct(
		"aws.signerSigningJob.SignerSigningJobSourceS3",
		reflect.TypeOf((*SignerSigningJobSourceS3)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"aws.signerSigningJob.SignerSigningJobSourceS3OutputReference",
