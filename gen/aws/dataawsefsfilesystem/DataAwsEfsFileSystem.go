...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/data-sources/efs_file_system aws_efs_file_system}.
...
func (j *jsiiProxy_DataAwsEfsFileSystem) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/data-sources/efs_file_system aws_efs_file_system} Data Source.
...
func DataAwsEfsFileSystem_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsEfsFileSystem_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
