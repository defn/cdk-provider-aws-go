...
func (j *jsiiProxy_DataAwsEksCluster) AccessConfig() DataAwsEksClusterAccessConfigList {
	var returns DataAwsEksClusterAccessConfigList
	_jsii_.Get(
		j,
		"accessConfig",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/data-sources/eks_cluster aws_eks_cluster} Data Source.
