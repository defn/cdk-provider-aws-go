...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/gluetrigger/internal"
...
func (j *jsiiProxy_GlueTriggerActionsNotificationPropertyOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_GlueTriggerActionsNotificationPropertyOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_GlueTriggerActionsNotificationPropertyOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_GlueTriggerActionsNotificationPropertyOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func NewGlueTriggerActionsNotificationPropertyOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) GlueTriggerActionsNotificationPropertyOutputReference {
	_init_.Initialize()

	if err := validateNewGlueTriggerActionsNotificationPropertyOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewGlueTriggerActionsNotificationPropertyOutputReference_Override(g GlueTriggerActionsNotificationPropertyOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_GlueTriggerActionsNotificationPropertyOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_GlueTriggerActionsNotificationPropertyOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (g *jsiiProxy_GlueTriggerActionsNotificationPropertyOutputReference) ComputeFqn() *string {
	var returns *string
...
func (g *jsiiProxy_GlueTriggerActionsNotificationPropertyOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (g *jsiiProxy_GlueTriggerActionsNotificationPropertyOutputReference) ToString() *string {
	var returns *string
