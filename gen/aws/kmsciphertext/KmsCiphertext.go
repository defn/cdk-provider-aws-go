...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/kmsciphertext/internal"
...
func (j *jsiiProxy_KmsCiphertext) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_KmsCiphertext) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/kms_ciphertext aws_kms_ciphertext} Resource.
func NewKmsCiphertext(scope constructs.Construct, id *string, config *KmsCiphertextConfig) KmsCiphertext {
	_init_.Initialize()

	if err := validateNewKmsCiphertextParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func KmsCiphertext_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateKmsCiphertext_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (k *jsiiProxy_KmsCiphertext) AddMoveTarget(moveTarget *string) {
...
func (k *jsiiProxy_KmsCiphertext) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (k *jsiiProxy_KmsCiphertext) MoveFromId(id *string) {
...
func (k *jsiiProxy_KmsCiphertext) MoveToId(id *string) {
...
func (k *jsiiProxy_KmsCiphertext) ResetId() {
	_jsii_.InvokeVoid(
		k,
		"resetId",
		nil, // no parameters
