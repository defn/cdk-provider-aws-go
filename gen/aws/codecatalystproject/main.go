...
func init() {
	...
	_jsii_.RegisterStruct(
		"aws.codecatalystProject.CodecatalystProjectConfig",
		reflect.TypeOf((*CodecatalystProjectConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws.codecatalystProject.CodecatalystProjectTimeouts",
		reflect.TypeOf((*CodecatalystProjectTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"aws.codecatalystProject.CodecatalystProjectTimeoutsOutputReference",
