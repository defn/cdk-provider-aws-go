...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/dataawslambdafunctionurl/internal"
...
func NewDataAwsLambdaFunctionUrlCorsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsLambdaFunctionUrlCorsList {
	...
	if err := validateNewDataAwsLambdaFunctionUrlCorsListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsLambdaFunctionUrlCorsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
