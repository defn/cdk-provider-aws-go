...
func (j *jsiiProxy_OpensearchserverlessCollection) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_OpensearchserverlessCollection) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_OpensearchserverlessCollection) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_OpensearchserverlessCollection) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_OpensearchserverlessCollection) TagsAll() cdktf.StringMap {
...
func (j *jsiiProxy_OpensearchserverlessCollection) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/opensearchserverless_collection aws_opensearchserverless_collection} Resource.
func NewOpensearchserverlessCollection(scope constructs.Construct, id *string, config *OpensearchserverlessCollectionConfig) OpensearchserverlessCollection {
	...
	_jsii_.Create(
		"aws.opensearchserverlessCollection.OpensearchserverlessCollection",
...
func (j *jsiiProxy_OpensearchserverlessCollection)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_OpensearchserverlessCollection)SetLifecycle(val *cdktf.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_OpensearchserverlessCollection)SetProvider(val cdktf.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func OpensearchserverlessCollection_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (o *jsiiProxy_OpensearchserverlessCollection) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (o *jsiiProxy_OpensearchserverlessCollection) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
