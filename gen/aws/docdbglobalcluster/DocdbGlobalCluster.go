...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/docdbglobalcluster/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/resources/docdb_global_cluster aws_docdb_global_cluster} Resource.
...
func DocdbGlobalCluster_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDocdbGlobalCluster_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DocdbGlobalCluster) AddMoveTarget(moveTarget *string) {
