...
import (
	...
	"github.com/defn/cdktf-provider-aws-go/gen/aws/dataawscloudformationtype/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.33.0/docs/data-sources/cloudformation_type aws_cloudformation_type} Data Source.
...
func DataAwsCloudformationType_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsCloudformationType_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
